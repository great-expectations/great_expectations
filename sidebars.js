      ...
      items: [
        {
          ...
          items: [
            ...
            { label: 'How to use Great Expectations with AWS using S3 cloud storage and Pandas', type: 'doc', id: 'deployment_patterns/how_to_use_gx_with_aws/how_to_use_gx_with_aws_using_cloud_storage_and_pandas' }
          ]
        },
