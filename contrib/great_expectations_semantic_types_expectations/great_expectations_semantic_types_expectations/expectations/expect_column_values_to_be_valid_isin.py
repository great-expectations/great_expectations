...
def is_valid_isin(isin_num: str) -> bool:
    print(isin_num)
    try:
        isin.validate(isin_num)
...
class ColumnValuesToBeValidIsin(ColumnMapMetricProvider):
...
class ExpectColumnValuesToBeValidIsin(ColumnMapExpectation):
    ...
    map_metric = "column_values.to_be_valid_isin"
...
if __name__ == "__main__":
    ExpectColumnValuesToBeValidIsin().print_diagnostic_checklist()
