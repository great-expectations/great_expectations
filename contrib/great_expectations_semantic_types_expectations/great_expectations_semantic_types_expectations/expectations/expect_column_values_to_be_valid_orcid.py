...
ORCID_REGEX = r"^0000-000(1-[5-9]|2-[0-9]|3-[0-4])\d{3}-\d{3}[\dX]$"
...
class ColumnValuesToBeValidOrcid(ColumnMapMetricProvider):
    ...
    def _pandas(cls, column, **kwargs):
        def matches_orcid_regex(x):
            if re.match(ORCID_REGEX, str(x)):  # noqa: SIM103
                return True
            return False
...
class ExpectColumnValuesToBeValidOrcid(ColumnMapExpectation):
    ...
    map_metric = "column_values.valid_orcid"
...
if __name__ == "__main__":
    ExpectColumnValuesToBeValidOrcid().print_diagnostic_checklist()
