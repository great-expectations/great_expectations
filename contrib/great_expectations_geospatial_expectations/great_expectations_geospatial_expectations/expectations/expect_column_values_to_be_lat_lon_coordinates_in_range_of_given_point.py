    ...
    def _pandas(cls, column, **kwargs):
        ...
        if projection == "fcc":
            ...
            if unit == "kilometers":
                ...
                distances = column.apply(lambda x, y=center_point: pythagorean_projection(x, y) * 1.609344)
                range = range * 1.609344
...
class ExpectColumnValuesToBeLatLonCoordinatesInRangeOfGivenPoint(ColumnMapExpectation):
    ...
    def validate_configuration(cls, configuration: Optional[ExpectationConfiguration]) -> None:
        ...
        try:
            assert center_point is not None and range is not None, "center_point and range must be specified"
