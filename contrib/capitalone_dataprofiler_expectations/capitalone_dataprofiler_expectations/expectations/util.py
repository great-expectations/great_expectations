...
def is_value_between_bounds(
    ...
    if inclusive:
        ...
        return is_value_less_than_threshold(value, upper_bound) and is_value_greater_than_threshold(value, lower_bound)
...
def is_value_outside_bounds(value, lower_bound, upper_bound, inclusive=True):
    if inclusive:
        ...
        return is_value_less_than_threshold(value, lower_bound) and is_value_greater_than_threshold(value, upper_bound)
