...
class DataProfilerProfileNumericColumnsPercentDiffGreaterThanThreshold(DataProfilerProfileMetricProvider):
    ...
    def _get_evaluation_dependencies(
        ...
        if metric.metric_name == "data_profiler.profile_numeric_columns_percent_diff_greater_than_threshold":
...
class ExpectProfileNumericColumnsPercentDiffGreaterThanThreshold(ProfileNumericColumnsDiffExpectation):
    ...
    profile_metric = "data_profiler.profile_numeric_columns_percent_diff_greater_than_threshold"
...
if __name__ == "__main__":
    diagnostics_report = ExpectProfileNumericColumnsPercentDiffGreaterThanThreshold().run_diagnostics()
