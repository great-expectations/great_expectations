...
class DataProfilerProfileNumericColumnsPercentDiffGreaterThanOrEqualToThreshold(DataProfilerProfileMetricProvider):
...
class ExpectProfileNumericColumnsPercentDiffGreaterThanOrEqualToThreshold(ProfileNumericColumnsDiffExpectation):
