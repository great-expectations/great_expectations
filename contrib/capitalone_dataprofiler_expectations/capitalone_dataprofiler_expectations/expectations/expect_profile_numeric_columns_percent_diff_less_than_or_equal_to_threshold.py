...
class DataProfilerProfileNumericColumnsPercentDiffLessThanOrEqualToThreshold(DataProfilerProfileMetricProvider):
    ...
    def _get_evaluation_dependencies(
        ...
        if metric.metric_name == "data_profiler.profile_numeric_columns_percent_diff_less_than_or_equal_to_threshold":
...
class ExpectProfileNumericColumnsPercentDiffLessThanOrEqualToThreshold(ProfileNumericColumnsDiffExpectation):
