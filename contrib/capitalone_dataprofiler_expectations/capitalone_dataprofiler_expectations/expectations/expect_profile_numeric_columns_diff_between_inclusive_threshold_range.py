...
class DataProfilerProfileNumericColumnsDiffBetweenInclusiveThresholdRange(DataProfilerProfileMetricProvider):
    ...
    def _get_evaluation_dependencies(
        ...
        if metric.metric_name == "data_profiler.profile_numeric_columns_diff_between_inclusive_threshold_range":
...
class ExpectProfileNumericColumnsDiffBetweenInclusiveThresholdRange(ProfileNumericColumnsDiffExpectation):
