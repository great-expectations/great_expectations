...
class DataProfilerProfileNumericColumnsPercentDiffBetweenThresholdRange(DataProfilerProfileMetricProvider):
    ...
    def _get_evaluation_dependencies(
        ...
        if metric.metric_name == "data_profiler.profile_numeric_columns_percent_diff_between_threshold_range":
...
class ExpectProfileNumericColumnsPercentDiffBetweenExclusiveThresholdRange(ProfileNumericColumnsDiffExpectation):
    ...
    examples = [
        {
            ...
            "tests": [
                ...
                {
                    "title": "single_column_min_delta_witin_threshold",
                    "exact_match_out": False,
                    "include_in_gallery": True,
                    "in": {
                        "profile_path": profile_path,
