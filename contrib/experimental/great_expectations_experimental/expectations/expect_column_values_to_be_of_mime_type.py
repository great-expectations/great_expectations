         ...
         "data":{
             ...
             "tests": [
                ...
                },
                {
                    ...
                    "include_in_gallery": True,
                    "exact_match_out": False,
                    "in": {"column": "all_flac", "mime_type": "audio/flac", "mostly":1},
                    "out": {"success": True},
                },
                {
                    "title": "fail_all_flac",
                ...
                },
                {
                    ...
                    "include_in_gallery": True,
                    "exact_match_out": True,
                    "in": {"column": "mostly_png", "mime_type": "image/png", "mostly":0.5},
                    "out": {"success": True} 
                },
                {
                    ...
                    "include_in_gallery": True,
                    "exact_match_out": True,
                    "in": {"column": "mostly_png", "mime_type": "image/png", "mostly":0.8},
                    "out": {"success": False},
                },
                ]
     }
