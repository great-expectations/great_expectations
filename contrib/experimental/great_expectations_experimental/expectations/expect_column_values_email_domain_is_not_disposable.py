...
class ExpectColumnValuesEmailDomainIsNotDisposable(ColumnMapExpectation):
    ...
    map_metric = "column_values.email_domain_is_not_disposable"
    ...
    library_metadata = {
        ...
        "requirements": ["disposable_email_domains"],
    }


if __name__ == "__main__":
    ExpectColumnValuesEmailDomainIsNotDisposable().print_diagnostic_checklist()
