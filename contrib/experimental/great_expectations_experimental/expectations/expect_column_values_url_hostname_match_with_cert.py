...
def is_cert_match(host: str) -> bool:
    try:
...
class ColumnValuesUrlHostnameMatchWithCert(ColumnMapMetricProvider):

    # This is the id string that will be used to reference your metric.
    condition_metric_name = "column_values.match_cert"
...
class ExpectColumnValuesUrlHostnameMatchWithCert(ColumnMapExpectation):
    ...
    map_metric = "column_values.match_cert"
...
if __name__ == "__main__":
    ExpectColumnValuesUrlHostnameMatchWithCert().print_diagnostic_checklist()
