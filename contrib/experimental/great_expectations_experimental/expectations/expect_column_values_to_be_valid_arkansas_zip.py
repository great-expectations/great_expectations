...
class ColumnValuesToBeValidArkansasZip(ColumnMapMetricProvider):
...
class ExpectColumnValuesToBeValidArkansasZip(ColumnMapExpectation):
    ...
    examples = [
        {
            "data": {
                "valid_arkansas_zip": ["99501", "99621", "99752", "99950"],
                "invalid_arkansas_zip": ["-10000", "1234", "99999", "25487"],
            },
            "tests": [
                {
                ...
                },
                {
                    ...
                    "exact_match_out": False,
                    "include_in_gallery": True,
                    "in": {"column": "invalid_arkansas_zip"},
                    "out": {"success": False},
                },
            ],
        }
    ...
    map_metric = "column_values.valid_arkansas_zip"
...
if __name__ == "__main__":
    ExpectColumnValuesToBeValidArkansasZip().print_diagnostic_checklist()
