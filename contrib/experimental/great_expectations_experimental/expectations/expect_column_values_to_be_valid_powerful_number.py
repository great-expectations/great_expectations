...
# This method compares a string to the valid powerful number
...
class ExpectColumnValuesToBeValidPowerfulNumber(ColumnMapExpectation):
    ...
    examples = [
        {
            "data": {
                ...
                "malformed_powerful_number": [
                    "12",
                    "101",
                    "1001",
                    "48689748233309",
                    "This is not a valid powerful number",
                ],
            },
            "tests": [
                {
                    ...
                    "in": {"column": "well_formed_powerful_number"},
                    "out": {"success": True},
                },
                {
                    ...
                    "exact_match_out": False,
                    "include_in_gallery": True,
                    "in": {"column": "malformed_powerful_number"},
                    "out": {"success": False},
                },
            ],
        }
    ...
    map_metric = "column_values.valid_powerful_number"
...
if __name__ == "__main__":
    ExpectColumnValuesToBeValidPowerfulNumber().print_diagnostic_checklist()
