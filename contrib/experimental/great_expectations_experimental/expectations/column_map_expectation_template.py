...
class ColumnValuesMatchBenfordsLaw(ColumnMapMetricProvider):

    # This is the id string that will be used to reference your metric.
    # Please see {some doc} for information on how to choose an id string for your Metric.
    condition_metric_name = "column_values.match_benfords_law"
...
class ExpectColumnValuesMatchBenfordsLaw(ColumnMapExpectation):
    ...
    map_metric = "column_values.match_benfords_law"
...
if __name__ == "__main__":
    diagnostics_report = ExpectColumnValuesMatchBenfordsLaw().run_diagnostics()
