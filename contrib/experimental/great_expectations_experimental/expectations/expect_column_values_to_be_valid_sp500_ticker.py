...
class ExpectColumnValuesToBeValidSp500Ticker(ColumnMapExpectation):
    ...
    examples = [
        {
            "data": {
                "well_formed_sp500_ticker": [
                    "AAPL",
                    "aapl",
                    "FB",
                    "GooGL",
                ],
                "malformed_sp500_ticker": [
                    "",
                    "42",
                    "Apple",
            ...
            "tests": [
                {
                    ...
                    "in": {"column": "well_formed_sp500_ticker"},
                    "out": {"success": True},
                },
                {
                    ...
                    "exact_match_out": False,
                    "include_in_gallery": True,
                    "in": {"column": "malformed_sp500_ticker"},
                    "out": {"success": False},
                },
            ],
        }
    ...
    map_metric = "column_values.valid_sp500_ticker"
...
if __name__ == "__main__":
    ExpectColumnValuesToBeValidSp500Ticker().print_diagnostic_checklist()
