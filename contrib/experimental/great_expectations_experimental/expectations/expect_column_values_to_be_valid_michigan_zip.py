...
class ColumnValuesToBeValidMichiganZip(ColumnMapMetricProvider):
...
class ExpectColumnValuesToBeValidMichiganZip(ColumnMapExpectation):
    """Expect values in this column to be valid Kenucky zipcodes.
