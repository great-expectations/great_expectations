...
def is_valid_ipv4_private(addr: str) -> bool:
    try:
        return ipaddress.IPv4Address(addr).is_private
...
class ColumnValuesToBePrivateIpV4(ColumnMapMetricProvider):
...
class ExpectColumnValuesToBePrivateIpV4(ColumnMapExpectation):
    ...
    map_metric = "column_values.valid_ipv4_private"
...
if __name__ == "__main__":
    ExpectColumnValuesToBePrivateIpV4().print_diagnostic_checklist()
