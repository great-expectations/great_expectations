...
class ColumnValuesGeohash(ColumnMapMetricProvider):

    # This is the id string that will be used to reference your metric.
    condition_metric_name = "column_values.geohash"

    # This method implements the core logic for the PandasExecutionEngine
    @column_condition_partial(engine=PandasExecutionEngine)
    def _pandas(cls, column, **kwargs):
        return column.str.match(pat="^[0123456789bcdefghjkmnpqrstuvwxyz]+$")
        # search = re.compile(r'[a-z0-9]').search
        # return bool(search(column))
...
class ExpectColumnValuesToBeValidGeohash(ColumnMapExpectation):
    ...
    map_metric = "column_values.geohash"
