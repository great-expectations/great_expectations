...
class ColumnValuesGeometryNearShape(ColumnMapMetricProvider):
    ...
    condition_value_keys = ("shape", "shape_format", "column_shape_format", "distance_tol")
...
class ExpectColumnValuesGeometryToBeNearShape(ColumnMapExpectation):
    ...
    success_keys = ("mostly", "shape", "shape_format", "column_shape_format", "distance_tol")
