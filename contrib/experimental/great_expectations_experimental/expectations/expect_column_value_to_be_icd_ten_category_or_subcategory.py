...
class ExpectColumnValueToBeIcdTenCategoryOrSubcategory(ColumnMapExpectation):
    """     
...
if __name__ == "__main__":
    ExpectColumnValueToBeIcdTenCategoryOrSubcategory().print_diagnostic_checklist()
