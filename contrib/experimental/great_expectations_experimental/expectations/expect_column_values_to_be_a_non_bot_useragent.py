...
class ExpectColumnValuesEqualNonBotUserAgent(ColumnMapExpectation):
    """Expect useragents to be non bots"""

    # These examples will be shown in the public gallery, and also executed as unit tests for your Expectation
    examples = [{
        "data": {
            "user_agents": ['Mozilla/5.0 (Linux; Android 7.0; SM-G892A Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/60.0.3112.107 Mobile Safari/537.36',
