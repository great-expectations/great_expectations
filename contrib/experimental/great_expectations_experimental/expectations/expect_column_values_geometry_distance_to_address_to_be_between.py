...
class ExpectColumnValuesGeometryDistanceToAddressToBeBetween(ColumnMapExpectation):
    ...
    examples = [
        {
            "data": {
                "point_array": ['POINT(-75.682729 45.4437213)', 'POINT(-75.6987003 45.4237274)',  'POINT(-75.69660 45.428057)', 'POINT(-75.668226 45.321924)', 'POINT(-75.702662 45.420936)'],
            },
            "tests": [
                {
