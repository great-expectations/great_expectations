...
class ExpectColumnValuesGeometryToInstersectShape(ColumnMapExpectation):
    ...
    examples = [
        {
            "data": {
                "points_only": ['POINT(1 1)', 'POINT(2 2)', 'POINT(6 4)', 'POINT(3 9)',  'POINT(8 9.999)'],
                "points_and_lines": ['POINT(1 1)', 'POINT(2 2)', 'POINT(6 4)', 'POINT(3 9)', 'LINESTRING(5 5, 8 10)'],
                "points_and_lines_negative": ['POINT(1 1)', 'POINT(2 2)', 'POINT(6 4)', 'LINESTRING(5 5, 8 10)', 'LINESTRING(11 5, 10 20)'],
            },
            "tests": [
                {
    ...
    library_metadata = {
        "tags": ['geospatial',
                 'hackathon-22'],  # Tags for this Expectation in the Gallery
