...
class ExpectColumnValuesToMatchPowersOfBase(ColumnMapExpectation):
        ...
        "tests": [
            {
                ...
                "in": {"column": "mostly_powers_of_two_but_one", "base_integer": 2, "mostly": 0.8},
                "out": {
                    "success": True,
            ...
            },
            {
                ...
                "exact_match_out": False,
                "include_in_gallery": True,
                "in": {"column": "all_powers_of_2_increasing_order", "base_integer": 2, "mostly": 1},
                "out": {
                    "success": True,
                    "unexpected_index_list": [],
                    "unexpected_list": []
            ...
            },
            {
                ...
                "exact_match_out": False,
                "include_in_gallery": True,
                "in": {"column": "mostly_powers_of_two_but_one", "base_integer": 2, "mostly": 1},
                "out": {
                    "success": False,
                    "unexpected_index_list": [5],
                    "unexpected_list": [11]
    ...
    success_keys = ("base_integer", "mostly",)
