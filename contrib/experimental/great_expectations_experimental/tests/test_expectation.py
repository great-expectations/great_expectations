...
from expect_multicolumn_datetime_difference_to_be_less_than_two_months import ExpectMulticolumnDatetimeDifferenceToBeLessThanTwoMonths

# Define a sample dataset with various datetime scenarios
sample_data = {
    "start_datetime": ["2023-01-01", "2023-02-01", "2023-03-01", "2023-04-01", "2023-05-01"],
    "end_datetime": ["2023-01-15", "2023-03-02", "2023-05-01", "2023-06-01", "2023-07-01"],
}
...
def test_datetime_difference_within_threshold():
    ...
    result = expectation.validate(within_threshold_df, execution_engine=execution_engine)
    assert result["success"] is True
