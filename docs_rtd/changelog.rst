...
0.15.45
-----------------
* [FEATURE] Experimental datasources `batch.head()` ([#6765](GxURL.PULL_REQUESTS/6765))
* [FEATURE] Add Validation Result URL to Checkpoint Result ([#6908](GxURL.PULL_REQUESTS/6908)) (thanks @josectobar)
* [BUGFIX] Fix issues rendering code blocks in API docs ([#6917](GxURL.PULL_REQUESTS/6917))
* [BUGFIX] Fix list_keys method for TupleS3StoreBackend ([#6901](GxURL.PULL_REQUESTS/6901)) (thanks @enagovitsyn)
* [BUGFIX] Fix rendering issue with api docs ([#6924](GxURL.PULL_REQUESTS/6924))
* [BUGFIX] Render bar graph with boolean values ([#6910](GxURL.PULL_REQUESTS/6910)) (thanks @tmilitino)
* [BUGFIX] Capital one contrib/micdavis/import hotfix ([#6922](GxURL.PULL_REQUESTS/6922)) (thanks @micdavis)
* [DOCS] Adding docstring for `Checkpoint.self_check()` ([#6841](GxURL.PULL_REQUESTS/6841))
* [DOCS] `AbstractDataContext.add_store` docstring ([#6851](GxURL.PULL_REQUESTS/6851))
* [DOCS] Doc Strings for ExpectationSuite Display Methods ([#6856](GxURL.PULL_REQUESTS/6856))
* [DOCS] `DataAssistantResult.get_expectation_suite()` docstring ([#6862](GxURL.PULL_REQUESTS/6862))
* [DOCS] Misc docstrings around `DataAssistant` ([#6866](GxURL.PULL_REQUESTS/6866))
* [DOCS] enable running `invoke docstrings` on select modules ([#6868](GxURL.PULL_REQUESTS/6868))
* [DOCS] Adds docstring for expect_column_distinct_values_to_contain_set ([#6855](GxURL.PULL_REQUESTS/6855))
* [DOCS] Documentation Strings for Metric Domain Types and Metric Function Types ([#6872](GxURL.PULL_REQUESTS/6872))
* [DOCS] added docstrings for the public API ([#6884](GxURL.PULL_REQUESTS/6884)) (thanks @sujensen)
* [DOCS] Add public API docstring for `expect_column_values_to_be_unique` `validate_configuration` ([#6897](GxURL.PULL_REQUESTS/6897))
* [DOCS] Miscellaneous docstrings for `DataContext` and utils ([#6852](GxURL.PULL_REQUESTS/6852))
* [DOCS] Add public API docstring for `expect_column_values_to_be_of_type` `validate_configuration` ([#6896](GxURL.PULL_REQUESTS/6896))
* [DOCS] Add public API docstring for `JsonSchemaProflier.validate` ([#6900](GxURL.PULL_REQUESTS/6900))
* [DOCS] Exclude DataAssistantRunner.run() ([#6919](GxURL.PULL_REQUESTS/6919))
* [DOCS] StoreValidationResultAction, StoreEvaluationParametersAction and StoreMetricsAction api docs ([#6879](GxURL.PULL_REQUESTS/6879)) (thanks @josectobar)
* [DOCS] Add public API docstring for `expect_column_values_to_be_dateutil_parseable` `validate_configuration` ([#6864](GxURL.PULL_REQUESTS/6864))
* [DOCS] YAML docs ([#6861](GxURL.PULL_REQUESTS/6861))
* [DOCS] Add public API docstring for `expect_column_values_to_be_decreasing` `validate_configuration` ([#6865](GxURL.PULL_REQUESTS/6865))
* [DOCS] Docstrings for `Checkpoint` and related classes ([#6882](GxURL.PULL_REQUESTS/6882))
* [DOCS] Add public API docstring for expect_table_row_count_to_be_between validate_configuration ([#6883](GxURL.PULL_REQUESTS/6883)) (thanks @lockettks)
* [DOCS] `Validator.get_expectation_suite()` docstring ([#6886](GxURL.PULL_REQUESTS/6886))
* [DOCS] Fix Checkpoint docstring whitespace ([#6927](GxURL.PULL_REQUESTS/6927))
* [DOCS] `DataAssistantResult` docstring ([#6887](GxURL.PULL_REQUESTS/6887))
* [DOCS] Add public API docstring for `expect_column_values_to_be_in_set` `validate_configuration` ([#6890](GxURL.PULL_REQUESTS/6890))
* [DOCS] Add public API docstring for `expect_column_values_to_be_in_type_list` and `expect_column_values_to_be_increasing` `validate_configuration` ([#6891](GxURL.PULL_REQUESTS/6891))
* [DOCS] Deprecate `util.render_evaluation_parameter_string` function ([#6894](GxURL.PULL_REQUESTS/6894))
* [DOCS] Add public API docstring for `Profiler.validate` ([#6898](GxURL.PULL_REQUESTS/6898))
* [DOCS] Add public API docstring for `expect_column_values_to_be_between` `validate_configuration` ([#6858](GxURL.PULL_REQUESTS/6858))
* [DOCS] Add public API docstring for `expect_column_values_to_be_in_json_parseable` `validate_configuration` ([#6893](GxURL.PULL_REQUESTS/6893))
* [DOCS] Add public API docstring for `expect_column_values_to_be_null` `validate_configuration` ([#6895](GxURL.PULL_REQUESTS/6895))
* [DOCS] Update docstrings for some of actions.py ([#6853](GxURL.PULL_REQUESTS/6853))
* [DOCS] /typo correction ([#6920](GxURL.PULL_REQUESTS/6920)) (thanks @mingyyy)
* [DOCS] DOC-417 How to use GX with AWS using Athena ([#6828](GxURL.PULL_REQUESTS/6828))
* [DOCS] Adding docstrings ([#6854](GxURL.PULL_REQUESTS/6854))
* [MAINTENANCE] Update `teams.yml` ([#6839](GxURL.PULL_REQUESTS/6839))
* [MAINTENANCE] invoke 2.0 and `schema` task (for zep types) ([#6836](GxURL.PULL_REQUESTS/6836))
* [MAINTENANCE] Build hierarchy in sidebars for API docs ([#6842](GxURL.PULL_REQUESTS/6842))
* [MAINTENANCE] Change public_api task name to avoid confusion ([#6843](GxURL.PULL_REQUESTS/6843))
* [MAINTENANCE] Add the fragment back to internal references ([#6845](GxURL.PULL_REQUESTS/6845))
* [MAINTENANCE] Clean up public_api excludes ([#6846](GxURL.PULL_REQUESTS/6846))
* [MAINTENANCE] Fix the error message for invalid batch request options ([#6848](GxURL.PULL_REQUESTS/6848))
* [MAINTENANCE] Standardize Store CRUD ([#6826](GxURL.PULL_REQUESTS/6826))
* [MAINTENANCE] Fix scripts not found error in invoke ([#6867](GxURL.PULL_REQUESTS/6867))
* [MAINTENANCE] Fix argument name typo ([#6850](GxURL.PULL_REQUESTS/6850)) (thanks @KirillUlich)
* [MAINTENANCE] more clearly specifies range of supported python versions ([#6870](GxURL.PULL_REQUESTS/6870))
* [MAINTENANCE] add validate_configuration docstring ([#6857](GxURL.PULL_REQUESTS/6857))
* [MAINTENANCE] docstring for expect_column_values_to_not_be_null#validate_configuration ([#6859](GxURL.PULL_REQUESTS/6859))
* [MAINTENANCE] Standardize project config CRUD ([#6837](GxURL.PULL_REQUESTS/6837))
* [MAINTENANCE] update docstring in validator.py and checkpoint_result.py ([#6875](GxURL.PULL_REQUESTS/6875)) (thanks @allensallinger)
* [MAINTENANCE] updated docstring on validate configuration ([#6871](GxURL.PULL_REQUESTS/6871))
* [MAINTENANCE] Exclude unit tests from `comprehensive` stage of `dev` CI ([#6903](GxURL.PULL_REQUESTS/6903))
* [MAINTENANCE] Refactor `file_relative_path` util ([#6778](GxURL.PULL_REQUESTS/6778))
* [MAINTENANCE] switch to `ruff` linter ([#6888](GxURL.PULL_REQUESTS/6888))
* [MAINTENANCE] Use docusaurus style code block in api docs ([#6906](GxURL.PULL_REQUESTS/6906))
* [MAINTENANCE] metrics linting ([#6889](GxURL.PULL_REQUESTS/6889))
* [MAINTENANCE] Add exception message to `RenderedAtomicContent` failure renderer ([#6795](GxURL.PULL_REQUESTS/6795))
* [MAINTENANCE] Remove CloudNotificationAction ([#6881](GxURL.PULL_REQUESTS/6881))
* [MAINTENANCE] Use ruff linter for docstring linting ([#6913](GxURL.PULL_REQUESTS/6913))
* [MAINTENANCE] Add validate_configuration method docstrings ([#6899](GxURL.PULL_REQUESTS/6899)) (thanks @elenajdanova)
* [MAINTENANCE] docstring for expect_column_values_to_not_match_like_pattern_list's validate_configuration ([#6874](GxURL.PULL_REQUESTS/6874))
* [MAINTENANCE] docstring for expect_column_values_to_not_match_like_pattern validate_configuration ([#6876](GxURL.PULL_REQUESTS/6876))
* [MAINTENANCE] docstring for expect_compound_columns_to_be_unique validate_configuration ([#6878](GxURL.PULL_REQUESTS/6878))
* [MAINTENANCE] Add docstrings for Validator and its save_expectation_suite and validate methods ([#6885](GxURL.PULL_REQUESTS/6885)) (thanks @wookasz)
* [MAINTENANCE] Type Hints Correction in New Datasources; Additional DocStrings ([#6918](GxURL.PULL_REQUESTS/6918))
