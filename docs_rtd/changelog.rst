...
0.17.9
-----------------
* [BUGFIX] PR title checker's code should handle apostrophes ([#8513](GxURL.PULL_REQUESTS/8513))
* [BUGFIX] Patch `add_or_update_expectation_suite` with Cloud-backed contexts ([#8522](GxURL.PULL_REQUESTS/8522))
* [DOCS] Update Code Example for Viewing a Full Checkpoint Configuration ([#8492](GxURL.PULL_REQUESTS/8492))
* [DOCS] Add New Topic for Connecting to In-Memory Source Data Using Spark ([#8445](GxURL.PULL_REQUESTS/8445))
* [DOCS] Remove Unused Documentation Style Guide Topic ([#8496](GxURL.PULL_REQUESTS/8496))
* [DOCS] Update Links and Content in the Data Context Topic ([#8489](GxURL.PULL_REQUESTS/8489))
* [DOCS] Update Connect to filesystem source data ([#8483](GxURL.PULL_REQUESTS/8483))
* [DOCS] Add step to install azure-storage-blob when using azure storage blobs… ([#8156](GxURL.PULL_REQUESTS/8156))
* [DOCS] add python version badge to README ([#7040](GxURL.PULL_REQUESTS/7040))
* [DOCS] standardizes references to supported Python versions ([#8474](GxURL.PULL_REQUESTS/8474))
* [MAINTENANCE] Remove core team attributions from changelog ([#8493](GxURL.PULL_REQUESTS/8493))
* [MAINTENANCE] Remove `azure-pipeline.yml` after migrating to Github Actions ([#8494](GxURL.PULL_REQUESTS/8494))
* [MAINTENANCE] Notify on build-n-publish failure. ([#8495](GxURL.PULL_REQUESTS/8495))
* [MAINTENANCE] Send slack notification on release ([#8497](GxURL.PULL_REQUESTS/8497))
* [MAINTENANCE] Removed unused github action. ([#8499](GxURL.PULL_REQUESTS/8499))
* [MAINTENANCE] Change default testing level from WARNING to INFO ([#8506](GxURL.PULL_REQUESTS/8506))
* [MAINTENANCE] Flaky decorator added for docs-integration tests that access Cloud resources ([#8510](GxURL.PULL_REQUESTS/8510))
* [MAINTENANCE] Mob typing: update list of deprecated, never to be typed files. ([#8514](GxURL.PULL_REQUESTS/8514))
* [MAINTENANCE] Better testing for FDS quoted identifier logic ([#8509](GxURL.PULL_REQUESTS/8509))
* [MAINTENANCE] Remove Click upper bound constraint. ([#8515](GxURL.PULL_REQUESTS/8515))
* [MAINTENANCE] Docs Pipeline Clean up ([#8468](GxURL.PULL_REQUESTS/8468))
* [MAINTENANCE] Update `flaky` test ([#8527](GxURL.PULL_REQUESTS/8527))
