...
from great_expectations_v1.exceptions.exceptions import InvalidKeyError
...
if TYPE_CHECKING:
    ...
    from great_expectations_v1.data_context.store.expectations_store import ExpectationsStore
...
class ExpectationSuite(SerializableDictDot):
    ...
    def __init__(  # noqa: PLR0913
        ...
        if (
            "great_expectations_v1.__version__" not in meta
    ...
    def _submit_expectation_created_event(self, expectation: Expectation) -> None:
        if expectation.__module__.startswith("great_expectations_v1."):
