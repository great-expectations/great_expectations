...
from great_expectations_v1.exceptions import ClassInstantiationError
...
from great_expectations_v1.render.util import num_to_str
...
class ValidationResultsPageRenderer(Renderer):
    def __init__(
        ...
        module_name = "great_expectations_v1.render.renderer.column_section_renderer"
    ...
    def _render_validation_info(cls, validation_results):
        ...
        # TODO: Deprecate "great_expectations_v1.__version__"
        ge_version = validation_results.meta.get(
            "great_expectations_version"
        ) or validation_results.meta.get("great_expectations_v1.__version__")
...
class ExpectationSuitePageRenderer(Renderer):
    ...
    def _render_expectation_suite_info(cls, expectations):
        ...
        ge_version = expectations.meta.get("great_expectations_version") or expectations.meta.get(
            "great_expectations_v1.__version__"
        )
...
class ProfilingResultsPageRenderer(Renderer):
    def __init__(self, overview_section_renderer=None, column_section_renderer=None) -> None:
        ...
        module_name = (
            "great_expectations_v1.render.renderer.profiling_results_overview_section_renderer"
        )
