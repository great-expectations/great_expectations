...
from great_expectations_v1.data_context.store.html_site_store import (
    HtmlSiteStore,
...
from great_expectations_v1.render.util import resource_key_passes_run_name_filter
        ...
        **kwargs,
        ...
        for site_section_name, site_section_config in site_section_builders.items():
            ...
            module_name = (
                ...
                or "great_expectations_v1.render.renderer.site_builder"
            )
...
class DefaultSiteSectionBuilder:
    def __init__(  # noqa: PLR0913
        ...
        **kwargs,
        ...
        module_name = renderer.get("module_name") or "great_expectations_v1.render.renderer"
        ...
        module_name = "great_expectations_v1.render.view"
        if view is None:
            view = {
                "module_name": module_name,
...
class DefaultSiteIndexBuilder:
    def __init__(  # noqa: PLR0913
        ...
        **kwargs,
        ...
        if renderer is None:
            renderer = {
                "module_name": "great_expectations_v1.render.renderer",
                "class_name": "SiteIndexPageRenderer",
            }
        module_name = renderer.get("module_name") or "great_expectations_v1.render.renderer"
        self.renderer_class = instantiate_class_from_config(
