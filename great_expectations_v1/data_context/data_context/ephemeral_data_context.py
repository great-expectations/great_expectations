...
from great_expectations_v1.data_context.migrator.file_migrator import FileMigrator
...
class EphemeralDataContext(AbstractDataContext):
    ...
    def _init_datasource_store(self) -> DatasourceStore:
        from great_expectations_v1.data_context.store.datasource_store import (
            DatasourceStore,
        )
