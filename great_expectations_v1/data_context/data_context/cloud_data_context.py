...
from great_expectations_v1 import __version__
...
from great_expectations_v1.core.serializer import JsonConfigSerializer
...
from great_expectations_v1.data_context.store import DataAssetStore
...
from great_expectations_v1.data_context.store.metric_store import SuiteParameterStore
from great_expectations_v1.data_context.store.validation_results_store import ValidationResultsStore
    ...
    def get_config_with_variables_substituted(
        ...
        if missing_config_vars_and_subs:
            ...
            logger.info(
                ...
                "great_expectations_v1.conf file located at one of the above paths, in a section named "  # noqa: E501
                '"ge_cloud_config".'
            )
