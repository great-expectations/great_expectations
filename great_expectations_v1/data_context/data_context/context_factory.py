...
class ProjectManager:
    ...
    def _build_context(  # noqa: PLR0913
        ...
        from great_expectations_v1.data_context.data_context import (
            AbstractDataContext,
            CloudDataContext,
            EphemeralDataContext,
            FileDataContext,
    ...
    def _prepare_project_config(
        ...
        from great_expectations_v1.data_context.data_context import AbstractDataContext
        from great_expectations_v1.data_context.types.base import DataContextConfig
    ...
    def _get_cloud_context(  # noqa: PLR0913
        ...
        from great_expectations_v1.data_context.data_context import CloudDataContext
    ...
    def _get_file_context(
        ...
        from great_expectations_v1.data_context.data_context import FileDataContext
    ...
    def _get_ephemeral_context(
        ...
        from great_expectations_v1.data_context.data_context import EphemeralDataContext
