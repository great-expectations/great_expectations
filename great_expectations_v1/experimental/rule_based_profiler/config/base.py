...
if TYPE_CHECKING:
    ...
    from great_expectations_v1.experimental.rule_based_profiler.rule.rule import Rule
    from great_expectations_v1.experimental.rule_based_profiler.rule_based_profiler import (
        RuleBasedProfiler,
    )
...
class DomainBuilderConfigSchema(NotNullSchema):
    ...
    module_name = fields.String(
        required=False,
        allow_none=True,
        load_default="great_expectations_v1.rule_based_profiler.domain_builder",
    )
...
class ParameterBuilderConfigSchema(NotNullSchema):
    ...
    module_name = fields.String(
        required=False,
        allow_none=True,
        load_default="great_expectations_v1.rule_based_profiler.parameter_builder",
    )
    class_name = fields.String(
        required=True,
        allow_none=False,
...
class ExpectationConfigurationBuilderConfigSchema(NotNullSchema):
    ...
    module_name = fields.String(
        required=False,
        allow_none=True,
        load_default="great_expectations_v1.rule_based_profiler.expectation_configuration_builder",
    )
    class_name = fields.String(
        required=True,
        allow_none=False,
...
class RuleBasedProfilerConfig(AbstractConfig, BaseYamlConfig):
    def __init__(  # noqa: PLR0913
        ...
        self.module_name = "great_expectations_v1.rule_based_profiler"
...
class RuleBasedProfilerConfigSchema(AbstractConfigSchema):
    ...
    module_name = fields.String(
        required=False,
        allow_none=True,
        load_default="great_expectations_v1.rule_based_profiler",
    )
    class_name = fields.String(
        required=False,
        allow_none=True,
