...
from great_expectations_v1.core.batch import Batch, BatchRequestBase  # noqa: TCH001
...
from great_expectations_v1.experimental.rule_based_profiler.attributed_resolved_metrics import (
    AttributedResolvedMetrics,
)
from great_expectations_v1.experimental.rule_based_profiler.builder import Builder
...
from great_expectations_v1.validator.exception_info import ExceptionInfo  # noqa: TCH001
...
def init_parameter_builder(
    ...
    parameter_builder: ParameterBuilder = instantiate_class_from_config(
        ...
        config_defaults={
            "module_name": "great_expectations_v1.rule_based_profiler.parameter_builder"
        },
    )
