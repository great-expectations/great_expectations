...
from great_expectations_v1.experimental.rule_based_profiler import RuleBasedProfilerResult
...
from great_expectations_v1.experimental.rule_based_profiler.exceptions import (
...
from great_expectations_v1.experimental.rule_based_profiler.helpers.configuration_reconciliation import (  # noqa: E501
...
if TYPE_CHECKING:
    ...
    from great_expectations_v1.data_context.store.profiler_store import ProfilerStore
...
class BaseRuleBasedProfiler(ConfigPeer):
    ...
    def _init_rule_domain_builder(
        ...
        domain_builder: DomainBuilder = instantiate_class_from_config(
            ...
            config_defaults={
                "module_name": "great_expectations_v1.rule_based_profiler.domain_builder"
            },
        )
    ...
    def _persist_profiler(  # noqa: PLR0913
        ...
        new_profiler: RuleBasedProfiler = instantiate_class_from_config(
            ...
            config_defaults={
                "module_name": "great_expectations_v1.rule_based_profiler",
