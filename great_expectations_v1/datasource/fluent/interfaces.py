...
from great_expectations_v1.compatibility.pydantic import dataclasses as pydantic_dc
from great_expectations_v1.compatibility.typing_extensions import override
from great_expectations_v1.core.batch_definition import BatchDefinition, PartitionerT
from great_expectations_v1.core.config_substitutor import _ConfigurationSubstitutor
...
from great_expectations_v1.datasource.fluent.data_connector import (  # pydantic validates this type
    DataConnector,
)
...
if TYPE_CHECKING:
    ...
    from great_expectations_v1.validator.v1_validator import (
...
class Batch:
    ...
    def _validator(self) -> V1Validator:
        from great_expectations_v1.validator.v1_validator import Validator as V1Validator
