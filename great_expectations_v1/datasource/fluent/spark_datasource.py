...
from great_expectations_v1.compatibility.pyspark import ConnectDataFrame, DataFrame, pyspark
...
if TYPE_CHECKING:
    ...
    from great_expectations_v1.compatibility.pyspark import SparkSession
