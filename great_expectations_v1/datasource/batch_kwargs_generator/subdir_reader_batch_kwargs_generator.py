...
from great_expectations_v1.datasource.batch_kwargs_generator.batch_kwargs_generator import (
    BatchKwargsGenerator,
)
from great_expectations_v1.datasource.types import PathBatchKwargs
from great_expectations_v1.exceptions import BatchKwargsError
...
class SubdirReaderBatchKwargsGenerator(BatchKwargsGenerator):
    ...
    def _build_batch_kwargs(self, batch_parameters):  # noqa: C901 - too complex
        """
