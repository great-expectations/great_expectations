...
from great_expectations_v1.core.batch_spec import GlueDataCatalogBatchSpec
...
from great_expectations_v1.exceptions import DataConnectorError
from great_expectations_v1.execution_engine import ExecutionEngine, SparkDFExecutionEngine
...
class ConfiguredAssetAWSGlueDataCatalogDataConnector(DataConnector):
    ...
    @override
    def build_batch_spec(self, batch_definition: LegacyBatchDefinition) -> GlueDataCatalogBatchSpec:
        """
