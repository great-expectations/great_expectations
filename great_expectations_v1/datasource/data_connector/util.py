...
from great_expectations_v1.data_context.types.base import assetConfigSchema
from great_expectations_v1.data_context.util import instantiate_class_from_config
from great_expectations_v1.datasource.data_connector.asset import Asset  # noqa: TCH001
...
if TYPE_CHECKING:
    ...
    from great_expectations_v1.datasource import DataConnector
...
def _build_sorter_from_config(sorter_config: Dict[str, Any]) -> Sorter:
    ...
    sorter: Sorter = instantiate_class_from_config(
        ...
        config_defaults={"module_name": "great_expectations_v1.datasource.data_connector.sorter"},
    )
    return sorter
