...
from great_expectations_v1.core.result_format import (
...
from great_expectations_v1.validator.validator import Validator as OldValidator
from great_expectations_v1.validator.validator import calc_validation_statistics
...
if TYPE_CHECKING:
    ...
    from great_expectations_v1.core.result_format import ResultFormatUnion
