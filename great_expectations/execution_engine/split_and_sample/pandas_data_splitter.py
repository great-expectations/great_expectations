...
class PandasDataSplitter(DataSplitter):
    ...
    def split_on_year(self, df: pd.DataFrame, column_name: str, batch_identifiers: dict) -> pd.DataFrame:
        import inspect
        ...
        return self.split_on_date_parts(df=df, column_name=column_name, batch_identifiers=batch_identifiers, date_parts=[DatePart.YEAR])

    def split_on_year_and_month(self, df: pd.DataFrame, column_name: str, batch_identifiers: dict) -> pd.DataFrame:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
        ...
        return self.split_on_date_parts(df=df, column_name=column_name, batch_identifiers=batch_identifiers, date_parts=[DatePart.YEAR, DatePart.MONTH])

    def split_on_year_and_month_and_day(self, df: pd.DataFrame, column_name: str, batch_identifiers: dict) -> pd.DataFrame:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
        ...
        return self.split_on_date_parts(df=df, column_name=column_name, batch_identifiers=batch_identifiers, date_parts=[DatePart.YEAR, DatePart.MONTH, DatePart.DAY])

    def split_on_date_parts(self, df: pd.DataFrame, column_name: str, batch_identifiers: dict, date_parts: Union[(List[DatePart], List[str])]) -> pd.DataFrame:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
    ...
    @staticmethod
    def split_on_column_value(df, column_name: str, batch_identifiers: dict) -> pd.DataFrame:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
    ...
    @staticmethod
    def split_on_converted_datetime(df, column_name: str, batch_identifiers: dict, date_format_string: str='%Y-%m-%d') -> pd.DataFrame:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
    ...
    @staticmethod
    def split_on_divided_integer(df, column_name: str, divisor: int, batch_identifiers: dict) -> pd.DataFrame:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
    ...
    @staticmethod
    def split_on_mod_integer(df, column_name: str, mod: int, batch_identifiers: dict) -> pd.DataFrame:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
    ...
    @staticmethod
    def split_on_multi_column_values(df, column_names: List[str], batch_identifiers: dict) -> pd.DataFrame:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
        ...
        for column_name in column_names:
            ...
            if (not value):
                raise ValueError(f'In order for PandasExecution to `_split_on_multi_column_values`, all values in column_names must also exist in batch_identifiers. {column_name} was not found in batch_identifiers.')
            subset_df = subset_df[(subset_df[column_name] == value)]
        return subset_df

    @staticmethod
    def split_on_hashed_column(df, column_name: str, hash_digits: int, batch_identifiers: dict, hash_function_name: str='md5') -> pd.DataFrame:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
        ...
        try:
            ...
            raise ge_exceptions.ExecutionEngineError(f'''The splitting method used with SparkDFExecutionEngine has a reference to an invalid hash_function_name.
                        Reference to {hash_function_name} cannot be found.''')
        matching_rows = df[column_name].map((lambda x: (hash_method(str(x).encode()).hexdigest()[((- 1) * hash_digits):] == batch_identifiers['hash_value'])))
        return df[matching_rows]
