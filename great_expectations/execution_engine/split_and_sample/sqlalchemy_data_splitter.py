...
class SqlAlchemyDataSplitter(DataSplitter):
    ...
    def split_on_converted_datetime(
        ...
        if self._dialect == GESqlDialect.SQLITE.value:
            return (
                sa.func.strftime(
                    date_format_string,
    ...
    def split_on_divided_integer(
        ...
        if self._dialect == GESqlDialect.MYSQL.value:
            return (
                sa.cast(
                    sa.func.truncate(
        ...
        if self._dialect == GESqlDialect.MSSQL.value:
            return (
                sa.cast(
                    sa.func.round(
        ...
        if self._dialect == GESqlDialect.AWSATHENA.value:
            return (
                sa.cast(
                    sa.func.truncate(
