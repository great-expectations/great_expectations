...
from ..core.util import convert_to_json_serializable
...
class SqlAlchemyExecutionEngine(MetaSqlAlchemyExecutionEngine):
    """
...
"""
    ...
    def from_execution_engine(cls, execution_engine=None):
        ...
        if isinstance(execution_engine, SqlAlchemyExecutionEngine):
            ...
            raise ValueError(
                "from_execution_engine requires a SqlAlchemy execution_engine"
            )
        ...
        **kwargs,
        ...
        if custom_sql is not None and self.engine.dialect.name.lower() == "bigquery":
            if (
                ...
                and self.engine.dialect.execution_engine_id is None
            ):
                raise ValueError(
