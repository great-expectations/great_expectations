...
def example_airflow(ctx: click.Context) -> None:
    ...
    airflow_example_directory = repo_root / "examples" / "airflow"
    airflow_example_setup_file = airflow_example_directory / "setup_airflow_2_6_0.sh"
    subprocess.run(airflow_example_setup_file, cwd=airflow_example_directory)
