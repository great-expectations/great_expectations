...
def get_batch_request(
    ...
    additional_batch_request_args: Dict[str, Any] | None = None,
    ...
    data_connector_name: str | None = select_data_connector_name(
    ...
    batch_spec_passthrough: Dict[str, str | Dict[str, Any]] | None = batch_request.get(  # type: ignore[assignment] # can't guarantee shape of 'batch_spec_passthrough'
...
def select_data_connector_name(
    available_data_asset_names_by_data_connector_dict: Dict[str, List[str]] | None = None,
) -> str | None:
...
def _get_batch_spec_passthrough(
    ...
    batch_spec_passthrough: Dict[str, str | Dict[str, Any]] = {}
