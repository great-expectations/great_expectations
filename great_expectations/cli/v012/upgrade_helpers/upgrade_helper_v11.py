...
class UpgradeHelperV11(BaseUpgradeHelper):
    ...
    def _upgrade_store_backend(self, store_backend, store_name=None, site_name=None) -> None:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
    ...
    def _update_upgrade_log(self, store_backend, source_key=None, dest_key=None, store_name=None, site_name=None, exception_message=None) -> None:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
    ...
    def _update_validation_result_json(self, source_key, dest_key, run_name, store_backend) -> None:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
    ...
    def _get_tuple_filesystem_store_backend_run_time(self, source_key, store_backend) -> None:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
