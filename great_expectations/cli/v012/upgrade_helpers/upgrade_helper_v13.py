...
from great_expectations.cli.v012.upgrade_helpers.base_upgrade_helper import BaseUpgradeHelper
...
class UpgradeHelperV13(BaseUpgradeHelper):
    ...
    def __init__(self, data_context=None, context_root_dir=None) -> None:
        ...
        self.upgrade_log = {'skipped_upgrade': False, 'update_version': True, 'added_checkpoint_store': {}}
    ...
    def _process_checkpoint_store_for_checklist(self) -> None:
        ...
        if checkpoint_store_name:
            if stores.get(checkpoint_store_name):
                ...
                self.upgrade_checklist['stores'] = {checkpoint_store_name: DataContextConfigDefaults.DEFAULT_STORES.value[DataContextConfigDefaults.DEFAULT_CHECKPOINT_STORE_NAME.value]}
        else:
            ...
            if (not stores.get(checkpoint_store_name)):
                self.upgrade_checklist['stores'] = {checkpoint_store_name: DataContextConfigDefaults.DEFAULT_STORES.value[checkpoint_store_name]}
    ...
    def _update_upgrade_log(self) -> None:
        ...
        self.upgrade_log['added_checkpoint_store'].update({'stores': {DataContextConfigDefaults.DEFAULT_CHECKPOINT_STORE_NAME.value: data_context_config.stores[DataContextConfigDefaults.DEFAULT_CHECKPOINT_STORE_NAME.value]}, 'checkpoint_store_name': data_context_config.checkpoint_store_name})
    ...
    def get_upgrade_overview(self):
        ...
        stores_upgrade_checklist = [config_attribute for config_attribute in self.upgrade_checklist['stores'].keys()]
