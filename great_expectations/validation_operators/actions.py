...
.. code-block:: yaml
    ...
    action:
      ...
      data_docs_site_names: # optional list of DataDocs sites to display in Slack message. Defaults to showing all
      renderer:
    ...
    def __init__(
        ...
        self.data_doc_site_names = data_doc_site_names
    ...
    def _run(
        ...
        if (
            ...
            query = self.renderer.render(
                validation_result_suite, data_docs_pages, self.data_doc_site_names
            )
