...
class _FilePathDataAsset(DataAsset):
    ...
    _partitioner_implementation_map: dict[type[Partitioner], type[SparkPartitioner]] = pydantic.PrivateAttr(
        default={
    ...
    def __init__(self, **data):
        ...
        self._all_group_name_to_group_index_mapping = self._regex_parser.get_all_group_name_to_group_index_mapping()
        self._all_group_index_to_group_name_mapping = self._regex_parser.get_all_group_index_to_group_name_mapping()
    ...
    def build_batch_request(
        ...
        if options:
            for option, value in options.items():
                if option in self._all_group_name_to_group_index_mapping and value and not isinstance(value, str):
    ...
    def _validate_batch_request(self, batch_request: BatchRequest) -> None:
        ...
        if not (
            ...
            valid_options = self.get_batch_request_options_keys(partitioner=batch_request.partitioner)
    ...
    def get_batch_list_from_batch_request(self, batch_request: BatchRequest) -> List[Batch]:
        ...
        execution_engine: PandasExecutionEngine | SparkDFExecutionEngine = self.datasource.get_execution_engine()
        ...
        for batch_definition in batch_definition_list:
            ...
            batch_data, batch_markers = execution_engine.get_batch_data_and_markers(batch_spec=batch_spec)
            ...
            batch_metadata = self._get_batch_metadata_from_batch_request(batch_request=fully_specified_batch_request)
    ...
    def _batch_spec_options_from_batch_request(self, batch_request: BatchRequest) -> dict:
        ...
        if batch_request.partitioner:
            ...
            partitioner_kwargs["batch_identifiers"] = (
                spark_partitioner.batch_request_options_to_batch_spec_kwarg_identifiers(batch_request.options)
            )
