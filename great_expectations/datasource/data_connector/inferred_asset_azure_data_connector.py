...
class InferredAssetAzureDataConnector(InferredAssetFilePathDataConnector):
    ...
    def __init__(self, name: str, datasource_name: str, container: str, execution_engine: Optional[ExecutionEngine]=None, default_regex: Optional[dict]=None, sorters: Optional[list]=None, name_starts_with: str='', delimiter: str='/', azure_options: Optional[dict]=None, batch_spec_passthrough: Optional[dict]=None) -> None:
        import inspect
        ...
        try:
            ...
            raise ImportError('Unable to load Azure BlobServiceClient (it is required for InferredAssetAzureDataConnector).                 Please ensure that you have provided the appropriate keys to `azure_options` for authentication.')
    ...
    def _get_data_reference_list(self, data_asset_name: Optional[str]=None) -> List[str]:
        ...
        path_list: List[str] = list_azure_keys(azure=self._azure, query_options=query_options, recursive=True)
        return path_list
