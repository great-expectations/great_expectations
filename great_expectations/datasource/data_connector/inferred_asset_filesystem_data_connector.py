...
from great_expectations.datasource.data_connector.util import get_filesystem_one_level_directory_glob_path_list, normalize_directory_path
...
class InferredAssetFilesystemDataConnector(InferredAssetFilePathDataConnector):
    ...
    def __init__(self, name: str, datasource_name: str, base_directory: str, execution_engine: Optional[ExecutionEngine]=None, default_regex: Optional[dict]=None, glob_directive: str='*', sorters: Optional[list]=None, batch_spec_passthrough: Optional[dict]=None) -> None:
        import inspect
    ...
    def _get_data_reference_list(self, data_asset_name: Optional[str]=None) -> List[str]:
        ...
        path_list: List[str] = get_filesystem_one_level_directory_glob_path_list(base_directory_path=self.base_directory, glob_directive=self._glob_directive)
    ...
    def base_directory(self):
        ...
        return normalize_directory_path(dir_path=self._base_directory, root_directory_path=self.data_context_root_directory)
