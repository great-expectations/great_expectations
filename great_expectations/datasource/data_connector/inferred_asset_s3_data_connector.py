...
class InferredAssetS3DataConnector(InferredAssetFilePathDataConnector):
    ...
    def __init__(self, name: str, datasource_name: str, bucket: str, execution_engine: Optional[ExecutionEngine]=None, default_regex: Optional[dict]=None, sorters: Optional[list]=None, prefix: str='', delimiter: str='/', max_keys: int=1000, boto3_options: Optional[dict]=None, batch_spec_passthrough: Optional[dict]=None) -> None:
        import inspect
    ...
    def _get_data_reference_list(self, data_asset_name: Optional[str]=None) -> List[str]:
        ...
        query_options: dict = {'Bucket': self._bucket, 'Prefix': self._prefix, 'Delimiter': self._delimiter, 'MaxKeys': self._max_keys}
        path_list: List[str] = [key for key in list_s3_keys(s3=self._s3, query_options=query_options, iterator_dict={}, recursive=True)]
        return path_list
