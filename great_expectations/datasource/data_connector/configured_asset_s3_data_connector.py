...
class ConfiguredAssetS3DataConnector(ConfiguredAssetFilePathDataConnector):
    ...
    def __init__(self, name: str, datasource_name: str, bucket: str, assets: dict, execution_engine: Optional[ExecutionEngine]=None, default_regex: Optional[dict]=None, sorters: Optional[list]=None, prefix: str='', delimiter: str='/', max_keys: int=1000, boto3_options: Optional[dict]=None, batch_spec_passthrough: Optional[dict]=None) -> None:
        import inspect
    ...
    def _get_data_reference_list_for_asset(self, asset: Optional[Asset]) -> List[str]:
        ...
        path_list: List[str] = [key for key in list_s3_keys(s3=self._s3, query_options=query_options, iterator_dict={}, recursive=False)]
        return path_list
