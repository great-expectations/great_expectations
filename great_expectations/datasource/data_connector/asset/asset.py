...
class Asset():
    ...
    def __init__(self, name: str, base_directory: Optional[str]=None, glob_directive: Optional[str]=None, pattern: Optional[str]=None, group_names: Optional[List[str]]=None, batch_spec_passthrough: Optional[dict]=None, batch_identifiers: Optional[List[str]]=None, bucket: Optional[str]=None, max_keys: Optional[int]=None, container: Optional[str]=None, name_starts_with: Optional[str]=None, bucket_or_name: Optional[str]=None, max_results: Optional[int]=None, prefix: Optional[str]=None, delimiter: Optional[str]=None) -> None:
        import inspect
