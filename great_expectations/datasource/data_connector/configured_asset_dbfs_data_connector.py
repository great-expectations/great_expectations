...
from great_expectations.datasource.data_connector import ConfiguredAssetFilesystemDataConnector
...
class ConfiguredAssetDBFSDataConnector(ConfiguredAssetFilesystemDataConnector):
    ...
    def __init__(self, name: str, datasource_name: str, base_directory: str, assets: dict, execution_engine: ExecutionEngine, default_regex: Optional[dict]=None, glob_directive: str='**/*', sorters: Optional[list]=None, batch_spec_passthrough: Optional[dict]=None) -> None:
        import inspect
        ...
        super().__init__(name=name, datasource_name=datasource_name, base_directory=base_directory, assets=assets, execution_engine=execution_engine, default_regex=default_regex, glob_directive=glob_directive, sorters=sorters, batch_spec_passthrough=batch_spec_passthrough)
