...
class ConfiguredAssetSqlDataConnector(DataConnector):
    ...
    def _get_partition_definition_list_from_data_asset_config(
        ...
        if "splitter_method" in data_asset_config:
            splitter_fn: Callable = getattr(self, data_asset_config["splitter_method"])
    ...
    def _generate_batch_spec_parameters_from_batch_definition(
        ...
        if batch_definition.batch_spec_passthrough:
            batch_spec_params.update(batch_definition.batch_spec_passthrough)
        return batch_spec_params
