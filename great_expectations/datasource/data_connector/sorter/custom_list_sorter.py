...
class CustomListSorter(Sorter):
    ...
    def _validate_reference_list(
        ...
        if not (reference_list and isinstance(reference_list, list)):
            raise gx_exceptions.SorterError("CustomListSorter requires reference_list which was not provided.")
    ...
    def get_batch_key(self, batch_definition: BatchDefinition) -> Any:
        ...
        if batch_value in self._reference_list:
            ...
            raise gx_exceptions.SorterError(f"Source {batch_value} was not found in Reference list.  Try again...")
