...
from great_expectations.core.evaluation_parameters import _deduplicate_evaluation_parameter_dependencies
from great_expectations.core.expectation_configuration import ExpectationConfiguration, ExpectationConfigurationSchema, expectationConfigurationSchema
from great_expectations.core.usage_statistics.events import UsageStatsEvents
from great_expectations.core.util import convert_to_json_serializable, ensure_json_serializable, get_datetime_string_from_strftime_format, nested_update, parse_string_to_datetime
from great_expectations.exceptions import DataContextError, InvalidExpectationConfigurationError
from great_expectations.marshmallow__shade import Schema, ValidationError, fields, pre_dump
...
class ExpectationSuite(SerializableDictDot):
    ...
    def __init__(self, expectation_suite_name, data_context=None, expectations=None, evaluation_parameters=None, data_asset_type=None, execution_engine_type=None, meta=None, ge_cloud_id=None) -> None:
        import inspect
        ...
        if (expectations is None):
            expectations = []
        self.expectations = [(ExpectationConfiguration(**expectation) if isinstance(expectation, dict) else expectation) for expectation in expectations]
    ...
    def add_citation(self, comment: str, batch_request: Optional[Union[(str, Dict[(str, Union[(str, Dict[(str, Any)])])])]]=None, batch_definition: Optional[dict]=None, batch_spec: Optional[dict]=None, batch_kwargs: Optional[dict]=None, batch_markers: Optional[dict]=None, batch_parameters: Optional[dict]=None, profiler_config: Optional[dict]=None, citation_date: Optional[Union[(str, datetime.datetime)]]=None) -> None:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
        ...
        citation: Dict[(str, Any)] = {'citation_date': get_datetime_string_from_strftime_format(format_str='%Y-%m-%dT%H:%M:%S.%fZ', datetime_obj=citation_date), 'batch_request': batch_request, 'batch_definition': batch_definition, 'batch_spec': batch_spec, 'batch_kwargs': batch_kwargs, 'batch_markers': batch_markers, 'batch_parameters': batch_parameters, 'profiler_config': profiler_config, 'comment': comment}
        ge.util.filter_properties_dict(properties=citation, clean_falsy=True, inplace=True)
        ...
        if (not isinstance(other, self.__class__)):
            if isinstance(other, dict):
                try:
                    ...
                    other: ExpectationSuite = ExpectationSuite(**other_dict, data_context=self._data_context)
                ...
                return NotImplemented
        return ((len(self.expectations) == len(other.expectations)) and all([mine.isEquivalentTo(theirs) for (mine, theirs) in zip(self.expectations, other.expectations)]))
    ...
    def __eq__(self, other):
        ...
        if (not isinstance(other, self.__class__)):
            return NotImplemented
        return all(((self.expectation_suite_name == other.expectation_suite_name), (self.expectations == other.expectations), (self.evaluation_parameters == other.evaluation_parameters), (self.data_asset_type == other.data_asset_type), (self.meta == other.meta)))
    ...
    def get_citations(self, sort: bool=True, require_batch_kwargs: bool=False, require_batch_request: bool=False, require_profiler_config: bool=False) -> List[Dict[(str, Any)]]:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
    ...
    def remove_expectation(self, expectation_configuration: Optional[ExpectationConfiguration]=None, match_type: str='domain', remove_multiple_matches: bool=False, ge_cloud_id: Optional[Union[(str, uuid.UUID)]]=None) -> List[ExpectationConfiguration]:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
        ...
        found_expectation_indexes = self.find_expectation_indexes(expectation_configuration=expectation_configuration, match_type=match_type, ge_cloud_id=ge_cloud_id)
        if (len(found_expectation_indexes) < 1):
            ...
            if remove_multiple_matches:
                ...
                raise ValueError('More than one matching expectation was found. Specify more precise matching criteria,or set remove_multiple_matches=True')
        else:
            return [self.expectations.pop(found_expectation_indexes[0])]

    def remove_all_expectations_of_type(self, expectation_types: Union[(List[str], str)]) -> List[ExpectationConfiguration]:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
        ...
        removed_expectations = [expectation for expectation in self.expectations if (expectation.expectation_type in expectation_types)]
        self.expectations = [expectation for expectation in self.expectations if (expectation.expectation_type not in expectation_types)]
        return removed_expectations

    def find_expectation_indexes(self, expectation_configuration: Optional[ExpectationConfiguration]=None, match_type: str='domain', ge_cloud_id: str=None) -> List[int]:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
    ...
    def find_expectations(self, expectation_configuration: Optional[ExpectationConfiguration]=None, match_type: str='domain', ge_cloud_id: Optional[str]=None) -> List[ExpectationConfiguration]:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
        ...
        if ((expectation_configuration is None) and (ge_cloud_id is None)):
            raise TypeError('Must provide either expectation_configuration or ge_cloud_id')
        found_expectation_indexes = self.find_expectation_indexes(expectation_configuration, match_type, ge_cloud_id)
        if (len(found_expectation_indexes) > 0):
            return [self.expectations[idx] for idx in found_expectation_indexes]
        else:
            return []

    def replace_expectation(self, new_expectation_configuration: Union[(ExpectationConfiguration, dict)], existing_expectation_configuration: Optional[ExpectationConfiguration]=None, match_type: str='domain', ge_cloud_id: Optional[str]=None) -> None:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
        ...
        if ((existing_expectation_configuration is None) and (ge_cloud_id is None)):
            raise TypeError('Must provide either existing_expectation_configuration or ge_cloud_id')
        if isinstance(new_expectation_configuration, dict):
            new_expectation_configuration = expectationConfigurationSchema.load(new_expectation_configuration)
        found_expectation_indexes = self.find_expectation_indexes(existing_expectation_configuration, match_type, ge_cloud_id)
        if (len(found_expectation_indexes) > 1):
            raise ValueError('More than one matching expectation was found. Please be more specific with your search criteria')
    ...
    def _add_expectation(self, expectation_configuration: ExpectationConfiguration, send_usage_event: bool=True, match_type: str='domain', overwrite_existing: bool=True) -> ExpectationConfiguration:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
        ...
        if (len(found_expectation_indexes) > 1):
            ...
            if overwrite_existing:
                existing_expectation_ge_cloud_id = self.expectations[found_expectation_indexes[0]].ge_cloud_id
                ...
                if send_usage_event:
                    self.send_usage_event(success=False)
                raise DataContextError('A matching ExpectationConfiguration already exists. If you would like to overwrite this ExpectationConfiguration, set overwrite_existing=True')
        else:
    ...
    def send_usage_event(self, success: bool) -> None:
        ...
        if (self._data_context is not None):
            self._data_context.send_usage_message(event=UsageStatsEvents.EXPECTATION_SUITE_ADD_EXPECTATION.value, event_payload=usage_stats_event_payload, success=success)

    def add_expectation_configurations(self, expectation_configurations: List[ExpectationConfiguration], send_usage_event: bool=True, match_type: str='domain', overwrite_existing: bool=True) -> List[ExpectationConfiguration]:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
        ...
        expectation_configurations_attempted_to_be_added: List[ExpectationConfiguration] = [self.add_expectation(expectation_configuration=expectation_configuration, send_usage_event=send_usage_event, match_type=match_type, overwrite_existing=overwrite_existing) for expectation_configuration in expectation_configurations]
        return expectation_configurations_attempted_to_be_added

    def add_expectation(self, expectation_configuration: ExpectationConfiguration, send_usage_event: bool=True, match_type: str='domain', overwrite_existing: bool=True) -> ExpectationConfiguration:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
        for (k, v) in __frame.f_locals.items():
            ...
            print(f'<INTROSPECT> {__file}:{__func}:{k} - {v.__class__.__name__}')
        "\n        Args:\n            expectation_configuration: The ExpectationConfiguration to add or update\n            send_usage_event: Whether to send a usage_statistics event. When called through ExpectationSuite class'\n                public add_expectation() method, this is set to `True`.\n            match_type: The criteria used to determine whether the Suite already has an ExpectationConfiguration\n                and so whether we should add or replace.\n            overwrite_existing: If the expectation already exists, this will overwrite if True and raise an error if\n                False.\n\n        Returns:\n            The ExpectationConfiguration to add or replace.\n        Raises:\n            More than one match\n            One match if overwrite_existing = False\n        "
        return self._add_expectation(expectation_configuration=expectation_configuration, send_usage_event=send_usage_event, match_type=match_type, overwrite_existing=overwrite_existing)

    def get_grouped_and_ordered_expectations_by_column(self, expectation_type_filter: Optional[str]=None) -> Tuple[(Dict[(str, List[ExpectationConfiguration])], List[str])]:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
