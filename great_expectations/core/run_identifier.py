...
class RunIdentifier(DataContextKey):
    ...
    def __init__(self, run_name=None, run_time=None) -> None:
        ...
        assert (run_time is None) or isinstance(
            run_time, (datetime.datetime, str)
        ...
        if isinstance(run_time, str):
            try:
                ...
                warnings.warn(
                    f'Unable to parse provided run_time str ("{run_time}") to datetime. Defaulting run_time to current time.'
                )
