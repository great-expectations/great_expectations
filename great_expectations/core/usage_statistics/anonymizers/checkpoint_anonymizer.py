...
class CheckpointAnonymizer(BaseAnonymizer):
    ...
    def _anonymize_checkpoint_run(self, obj: object, **kwargs) -> dict:
        ...
        expectation_suite_id_: Optional[str] = kwargs.get("expectation_suite_id_")
        anonymized_expectation_suite_id_: Optional[str]
        if expectation_suite_id_ is None:
            anonymized_expectation_suite_id_ = None
        else:
            anonymized_expectation_suite_id_ = self._anonymize_string(
                str(expectation_suite_id_)
            )
        ...
        anonymized_checkpoint_run_properties_dict: Dict[str, List[str]] = {
            ...
            "anonymized_expectation_suite_id_": anonymized_expectation_suite_id_,
