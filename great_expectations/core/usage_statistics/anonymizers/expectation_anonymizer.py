...
class ExpectationSuiteAnonymizer(BaseAnonymizer):
    ...
    def anonymize(self, obj: Optional['ExpectationSuite']=None, **kwargs) -> dict:
        ...
        anonymized_info_dict['anonymized_name'] = self._anonymize_string(expectation_suite.expectation_suite_name)
        anonymized_info_dict['expectation_count'] = len(expectations)
        anonymized_info_dict['anonymized_expectation_counts'] = anonymized_expectation_counts
