...
class Anonymizer:
    ...
    ANONYMIZERS: List[Type[AbstractAnonymizer]] = [
        DatasourceAnonymizer,
        CheckpointRunAnonymizer,
        ProfilerRunAnonymizer,
    ]
    ...
    def anonymize(self, obj: object):
        for anonymizer_type in self.ANONYMIZERS:
            if anonymizer_type.can_handle(obj):
                anonymizer = anonymizer_type(salt=self._salt)
