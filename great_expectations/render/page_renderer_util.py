...
def render_multiple_validation_result_pages_markdown(validation_operator_result: ValidationOperatorResult, run_info_at_end: bool=True) -> str:
    import inspect
    ...
    warnings.warn('This \'render_multiple_validation_result_pages_markdown\' function is deprecated as of v0.12.1 and will be removed in v0.16.Please use ValidationResultsPageRenderer.render_validation_operator_result() instead.E.g. to replicate the functionality of rendering a ValidationOperatorResult to markdown:validation_results_page_renderer = ValidationResultsPageRenderer(    run_info_at_end=run_info_at_end)rendered_document_content_list = validation_results_page_renderer.render_validation_operator_result(   validation_operator_result=validation_operator_result)return " ".join(DefaultMarkdownPageView().render(rendered_document_content_list))', DeprecationWarning)
    validation_results_page_renderer = ValidationResultsPageRenderer(run_info_at_end=run_info_at_end)
