...
def resource_key_passes_run_name_filter(resource_key, run_name_filter):
    ...
    if run_name_filter.get("equals"):
        ...
        # deprecated-v0.11.9
        warnings.warn(
            "The 'eq' key will is deprecated as of v0.11.9 and will be removed in a future release. Please use the renamed 'equals' key.",
            DeprecationWarning,
        )
        ...
        # deprecated-v0.11.9
        warnings.warn(
            "The 'ne' key will is deprecated as of v0.11.9 and will be removed in a future release. Please use the renamed 'not_equals' key.",
            DeprecationWarning,
        )
