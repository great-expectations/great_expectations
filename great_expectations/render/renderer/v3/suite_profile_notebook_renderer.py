...
class SuiteProfileNotebookRenderer(SuiteEditNotebookRenderer):
    ...
    def render(self) -> nbformat.NotebookNode:
        ...
        # As v0.14.6, the notebook generated by `--profile` supports both the legacy UserConfigurableProfiler
        # and the productionalized RuleBasedProfiler.
        # The profiler type is determined by the existence of a profiler name from the CLI
    ...
    def _render_user_configurable_profiler_setup(self) -> None:
        self.add_header()
...
suite = profiler.build_suite()""",
    ...
    def _render_rule_based_profiler_setup(self) -> None:
        self.add_header()
        self.add_markdown_cell(
            markdown="""# Run the data profiler
