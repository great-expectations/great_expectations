    ...
    def render(  # noqa: C901
        ...
        if validation_result:
            ...
            if validation_result_suite_identifier:
                ...
                expectation_suite_name = validation_result_suite_identifier.expectation_suite_identifier.name
                ...
                query["attachments"][0]["content"]["body"][0]["items"][0]["columns"][0]["items"].append(
                    {
                        "type": "TextBlock",
                        "spacing": "none",
