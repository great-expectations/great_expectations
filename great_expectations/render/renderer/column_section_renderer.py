...
class ProfilingResultsColumnSectionRenderer(ColumnSectionRenderer):
    ...
    def render(self, evrs, section_name=None, column_type=None):  # type: ignore[explicit-override]
...
class ValidationResultsColumnSectionRenderer(ColumnSectionRenderer):
    ...
    def render(self, validation_results, suite_parameters=None):  # type: ignore[explicit-override]
...
class ExpectationSuiteColumnSectionRenderer(ColumnSectionRenderer):
    ...
    def render(self, expectations):  # type: ignore[explicit-override]
