...
#FIXME: Need to scrub references to PandasDataset.

class MetaSparkSqlDataSet(DataSet):
    """
...
#FIXME: Should this subclass from something else, too?
class SparkSqlDataSet(MetaSparkSqlDataSet):
    """
