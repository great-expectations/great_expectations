        ...
        def inner_wrapper(
            ...
            **kwargs,
            ...
            if column is not None:
                ...
                raise ValueError(
                    "The column_aggregate_expectation wrapper requires either column or both column_A and column_B as input."
                )
            if nonnull_count:
...
class Dataset(MetaDataset):
    ...
    def expect_column_to_exist(
        ...
        if column in columns:
            return {
                "success": (
                    (column_index is None) or (columns.index(column) == column_index)
                )
            }
        else:
    ...
    def expect_table_columns_to_match_set(
        ...
        if ((column_set is None) and (exact_match is not True)) or (
            dataset_columns_set == column_set
        ):
