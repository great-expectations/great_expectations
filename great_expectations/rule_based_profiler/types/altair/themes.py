...
class AltairThemes(Enum):
    DEFAULT_THEME = {'view': {'width': chart_width, 'height': chart_height, 'strokeOpacity': chart_border_opacity}, 'font': font, 'title': {'align': title_align, 'color': title_color, 'fontSize': title_font_size, 'dy': title_dy, 'subtitleFont': subtitle_font, 'subtitleFontSize': subtitle_font_size, 'subtitleColor': subtitle_color, 'subtitleFontWeight': subtitle_font_weight, 'subtitlePadding': subtitle_padding}, 'axis': {'titleFontSize': axis_title_font_size, 'titleColor': axis_title_color, 'titlePadding': axis_title_padding, 'labelFontSize': axis_label_font_size, 'labelColor': axis_label_color}, 'axisX': {'labelAngle': x_axis_label_angle, 'labelFlush': x_axis_label_flush, 'grid': x_axis_grid}, 'legend': {'titleColor': legend_title_color, 'titleFontSize': legend_title_font_size}, 'range': {'category': category_color_scheme, 'diverging': diverging_color_scheme, 'heatmap': heatmap_color_scheme, 'ordinal': ordinal_color_scheme}, 'area': {'color': fill_color, 'fillOpacity': fill_opacity}, 'line': {'color': line_color, 'strokeWidth': line_stroke_width, 'tooltip': {'content': line_tooltip_content}}, 'point': {'size': point_size, 'color': point_color, 'filled': point_filled, 'opacity': point_opacity, 'tooltip': {'content': point_tooltip_content}}}
