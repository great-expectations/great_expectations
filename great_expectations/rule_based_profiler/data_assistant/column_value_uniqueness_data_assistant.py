...
class ColumnValueUniquenessDataAssistant(DataAssistant):
    """
    ColumnValueUniquenesslDataAssistant provides dataset exploration and validation for columns with unique values.

    ColumnValueUniquenessDataAssistant.run() Args:
    ...
    ColumnValueUniquenessDataAssistant.run() Returns:
        ColumnValueUniquenessDataAssistantResult
    """

    __alias__: str = "column_value_uniqueness"
    ...
    def _build_data_assistant_result(
        ...
        return ColumnValueUniquenessDataAssistantResult(
