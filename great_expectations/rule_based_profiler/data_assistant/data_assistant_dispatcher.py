...
class DataAssistantDispatcher:
    ...
    def __getattr__(self, name: str) -> DataAssistantRunner:
        ...
        data_assistant_cls: Type[DataAssistant] | None = DataAssistantDispatcher._get_data_assistant_impl(name=name)
        ...
        data_assistant_runner: DataAssistantRunner | None = self._data_assistant_runner_cache.get(data_assistant_name)
