...
class DataAssistantRunner():
    ...
    def __init__(self, data_assistant_cls: Type['DataAssistant'], data_context: 'BaseDataContext') -> None:
        import inspect
    ...
    def run(self, batch_request: Union[(BatchRequestBase, dict)], expectation_suite: Optional[ExpectationSuite]=None, expectation_suite_name: Optional[str]=None) -> DataAssistantResult:
        import inspect
        __frame = inspect.currentframe()
        __file = __frame.f_code.co_filename
        __func = __frame.f_code.co_name
        ...
        validator: Validator = get_validator_with_expectation_suite(batch_request=batch_request, data_context=self._data_context, expectation_suite=expectation_suite, expectation_suite_name=expectation_suite_name, component_name=data_assistant_name)
        data_assistant: DataAssistant = self._data_assistant_cls(name=data_assistant_name, validator=validator)
