...
class OnboardingDataAssistant(DataAssistant):
    ...
    def _build_numeric_columns_rule() -> Rule:
        ...
        column_histogram_parameter_builder_for_metrics: ParameterBuilder = DataAssistant.commonly_used_parameter_builders.build_histogram_parameter_builder(
        ...
        parameter_builders: List[ParameterBuilder] = [
            column_histogram_parameter_builder_for_metrics,
