...
class RuleBasedProfilerResult(SerializableDictDot):
    ...
    def to_dict(self) -> dict:
        ...
        return {'fully_qualified_parameter_names_by_domain': [{'domain_id': domain.id, 'domain': domain.to_json_dict(), 'fully_qualified_parameter_names': convert_to_json_serializable(data=fully_qualified_parameter_names)} for (domain, fully_qualified_parameter_names) in self.fully_qualified_parameter_names_by_domain.items()], 'parameter_values_for_fully_qualified_parameter_names_by_domain': [{'domain_id': domain.id, 'domain': domain.to_json_dict(), 'parameter_values_for_fully_qualified_parameter_names': convert_to_json_serializable(data=parameter_values_for_fully_qualified_parameter_names)} for (domain, parameter_values_for_fully_qualified_parameter_names) in self.parameter_values_for_fully_qualified_parameter_names_by_domain.items()], 'expectation_configurations': [expectation_configuration.to_json_dict() for expectation_configuration in self.expectation_configurations], 'citation': self.citation}
