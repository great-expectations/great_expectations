...
class TupleFilesystemStoreBackend(TupleStoreBackend):
    ...
    def _set(self, key, value, **kwargs):  # type: ignore[explicit-override]
    ...
    def _move(self, source_key, dest_key, **kwargs):  # type: ignore[explicit-override]
    ...
    def get_url_for_key(self, key, protocol=None):  # type: ignore[explicit-override]
...
class TupleS3StoreBackend(TupleStoreBackend):
    ...
    def _set(  # type: ignore[explicit-override]
        self,
        key,
        value,
...
class TupleAzureBlobStoreBackend(TupleStoreBackend):
    ...
    def _set(self, key, value, content_encoding="utf-8", **kwargs):  # type: ignore[explicit-override]
