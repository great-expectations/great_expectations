...
class CheckpointStore(ConfigurationStore):
    ...
    def get_checkpoint(
        self, name: Union[str, None], ge_cloud_id: Union[str, None]
    ) -> CheckpointConfig:
        key: Union[GXCloudIdentifier, ConfigurationIdentifier] = self.determine_key(
            name=name, ge_cloud_id=ge_cloud_id
        )
    ...
    def create(
        ...
        ref: Union[bool, GXCloudResourceRef, None] = self.set(key, checkpoint_config)  # type: ignore[func-returns-value]
