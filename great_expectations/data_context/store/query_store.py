...
class SqlAlchemyQueryStore(Store):
    ...
    def __init__(self, credentials, queries=None, store_backend=None, runtime_environment=None):
        if not sqlalchemy:
            raise ge_exceptions.DataContextError("sqlalchemy module not found, but is required for "
