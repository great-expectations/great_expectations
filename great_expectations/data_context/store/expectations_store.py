...
from great_expectations.data_context.types.resource_identifiers import ExpectationSuiteIdentifier, GeCloudIdentifier
...
class ExpectationsStore(Store):
    ...
    def __init__(self, store_backend=None, runtime_environment=None, store_name=None, data_context=None) -> None:
        import inspect
    ...
    def self_check(self, pretty_print):
        ...
        test_value = ExpectationSuite(expectation_suite_name=test_key_name, data_context=self._data_context)
        if pretty_print:
