...
class BaseDataContext(EphemeralDataContext, ConfigPeer):
    ...
    def profile_data_asset(
        ...
        if isinstance(validation_ref, GeCloudIdAwareRef):
            id_ = validation_ref.id_
            validation_results.id_ = uuid.UUID(id_)
...
Generated, evaluated, and stored {total_expectations} Expectations during profiling. Please review results using data-docs."""
    ...
    def add_checkpoint(
        ...
        self.checkpoint_store.add_checkpoint(checkpoint, name, id_)
        return checkpoint
    ...
    def delete_checkpoint(
        ...
        return self.checkpoint_store.delete_checkpoint(name=name, id_=id_)
    ...
    def run_checkpoint(
        ...
        **kwargs,
        ...
        Args:
            ...
            run_time: The date/time of the run
            result_format: One of several supported formatting directives for expectation validation results
            id_: Great Expectations Cloud id for the checkpoint
            expectation_suite_id_: Great Expectations Cloud id for the expectation suite
            **kwargs: Additional kwargs to pass to the validation operator
    ...
    def run_profiler_with_dynamic_arguments(
        ...
        Args:
            ...
            id_: Identifier used to retrieve the profiler from a store (GE Cloud specific).
        ...
        Raises:
            AssertionError if both a `name` and `id_` are provided.
