    ...
    def update(
        ...
        if runtime_kwargs is not None and any(runtime_kwargs.values()):
            ...
            if runtime_kwargs.get("batch_request") is not None:
                ...
                if runtime_batch_request.get("runtime_parameters") is not None and runtime_batch_request["runtime_parameters"].get("batch_data") is not None:
                    if batch_request.get("runtime_parameters") is not None and batch_request["runtime_parameters"].get("batch_data") is not None:
                        batch_request["runtime_parameters"].pop("batch_data")
                    batch_data = runtime_batch_request["runtime_parameters"].pop("batch_data")
