...
class S3StoreBackendDefaults(BaseStoreBackendDefaults):
    ...
    def __init__(  # noqa: PLR0913
        ...
        validation_results_store_name: str = "validations_S3_store",
...
class GCSStoreBackendDefaults(BaseStoreBackendDefaults):
    ...
    def __init__(  # noqa: PLR0913
        ...
        validation_results_store_name: str = "validations_GCS_store",
        evaluation_parameter_store_name: str = "evaluation_parameter_store",
...
class DatabaseStoreBackendDefaults(BaseStoreBackendDefaults):
    ...
    def __init__(  # noqa: PLR0913
        ...
        validation_results_store_name: str = "validations_database_store",
        evaluation_parameter_store_name: str = "evaluation_parameter_store",
        ...
        # Use default credentials if separate credentials not supplied for expectations_store and validation_results_store
    ...
    def __init__(  # noqa: C901, PLR0912, PLR0913
        ...
        if store_backend_defaults is not None:
            ...
            if validation_results_store_name is None:
                validation_results_store_name = (
                    store_backend_defaults.validation_results_store_name
                )
