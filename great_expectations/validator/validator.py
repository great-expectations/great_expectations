...
"""
    ...
    def expectation_suite(self, suite: ExpectationSuite) -> None:
        # Chetan - 20220214 - We are required to expose this behavior in order to
        # enable the RuleBasedProfiler from the CLI. At the time of writing this (v0.14.6),
        # the Validator used in the `suite new` workflow has no way to access the suite
        # generated by the RBP.
