    ...
    def __new__(cls, name, bases, classdict, *args, **kwargs):
        ...
        if alias is not None:
            ...
            def new(cls, *args, **kwargs):
                ...
                if alias is not None:
                    warnings.warn(
                        f"""{cls.__name__} has been renamed to {alias} -- the alias {cls.__name__} is deprecated as of v0.13.12 and will be removed in v0.16.
""",
                        DeprecationWarning,
                        stacklevel=2,
                    )
        ...
        for b in bases:
            ...
            if alias is not None:
                warnings.warn(
                    f"""{b.__name__} has been renamed to {alias.__name__} -- the alias {b.__name__} is deprecated as of v0.13.12 and will be removed in v0.16.
""",
                    DeprecationWarning,
                    stacklevel=2,
                )
