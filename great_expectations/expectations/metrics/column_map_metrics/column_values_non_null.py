...
class ColumnValuesNonNullCount(MetricProvider):
    ...
    def _get_evaluation_dependencies(cls, metric: MetricConfiguration, configuration: Optional[ExpectationConfiguration]=None, execution_engine: Optional[ExecutionEngine]=None, runtime_configuration: Optional[dict]=None):
        ...
        dependencies['column_values.null.unexpected_count'] = MetricConfiguration(metric_name='column_values.null.unexpected_count', metric_domain_kwargs=metric.metric_domain_kwargs)
        return dependencies
