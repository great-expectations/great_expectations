...
class ColumnUniqueProportion(ColumnAggregateMetricProvider):
    ...
    def _get_evaluation_dependencies(cls, metric: MetricConfiguration, configuration: Optional[ExpectationConfiguration]=None, execution_engine: Optional[ExecutionEngine]=None, runtime_configuration: Optional[dict]=None):
        ...
        dependencies['column.distinct_values.count'] = MetricConfiguration(metric_name='column.distinct_values.count', metric_domain_kwargs=metric.metric_domain_kwargs)
