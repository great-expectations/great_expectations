...
class ExpectColumnMostCommonValueToBeInSet(ColumnExpectation):
    ...
    default_kwarg_values = {'value_set': None, 'ties_okay': None, 'result_format': 'BASIC', 'include_config': True, 'catch_exceptions': False}
    ...
    def _atomic_prescriptive_template(cls, configuration=None, result=None, language=None, runtime_configuration=None, **kwargs):
        ...
        params = substitute_none_for_missing(configuration.kwargs, ['column', 'value_set', 'ties_okay', 'row_condition', 'condition_parser'])
        params_with_json_schema = {'column': {'schema': {'type': 'string'}, 'value': params.get('column')}, 'value_set': {'schema': {'type': 'array'}, 'value': params.get('value_set')}, 'ties_okay': {'schema': {'type': 'boolean'}, 'value': params.get('ties_okay')}, 'row_condition': {'schema': {'type': 'string'}, 'value': params.get('row_condition')}, 'condition_parser': {'schema': {'type': 'string'}, 'value': params.get('condition_parser')}}
