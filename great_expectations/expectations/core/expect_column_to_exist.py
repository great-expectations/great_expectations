...
class ExpectColumnToExist(TableExpectation):
    ...
    def validate_configuration(self, configuration: Optional[ExpectationConfiguration]) -> None:
        ...
        try:
            ...
            assert isinstance(configuration.kwargs['column'], str), 'Column name must be a string'
            assert (isinstance(configuration.kwargs.get('column_index'), (int, dict)) or (configuration.kwargs.get('column_index') is None)), 'column_index must be an integer or None'
    ...
    def _atomic_prescriptive_template(cls, configuration=None, result=None, language=None, runtime_configuration=None, **kwargs):
        ...
        params = substitute_none_for_missing(configuration.kwargs, ['column', 'column_index'])
        ...
        params_with_json_schema = {'column': {'schema': {'type': 'string'}, 'value': params.get('column')}, 'column_index': {'schema': {'type': 'number'}, 'value': params.get('column_index')}}
