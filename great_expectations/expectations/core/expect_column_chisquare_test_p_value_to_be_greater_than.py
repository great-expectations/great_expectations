...
class ExpectColumnChiSquareTestPValueToBeGreaterThan(TableExpectation):
    library_metadata = {'maturity': 'production', 'tags': ['core expectation', 'column aggregate expectation', 'needs migration to modular expectations api'], 'contributors': ['@great_expectations'], 'requirements': []}
    metric_dependencies = tuple()
    success_keys = ()
    default_kwarg_values = {}
    args_keys = ('column', 'partition_object', 'p', 'tail_weight_holdout')
