...
class ExpectColumnValuesToNotMatchLikePatternList(ColumnMapExpectation):
    ...
    default_kwarg_values = {'like_pattern_list': None, 'row_condition': None, 'condition_parser': None, 'mostly': 1, 'result_format': 'BASIC', 'include_config': True, 'catch_exceptions': True}
