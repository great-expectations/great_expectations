...
class ExpectTableColumnsToMatchOrderedList(TableExpectation):
    ...
    def validate_configuration(
        ...
        try:
            ...
            assert isinstance(
                configuration.kwargs["column_list"], (list, set, dict)
            ) or (
                configuration.kwargs["column_list"] is None
    ...
    def _validate(
        ...
        if (expected_column_list is None) or (
            list(actual_column_list) == list(expected_column_list)
        ):
            return {
                "success": True,
