...
from great_expectations.render.util import handle_strict_min_max, num_to_str, parse_row_condition_string_pandas_engine, substitute_none_for_missing
...
class ExpectColumnValuesToBeBetween(ColumnMapExpectation):
    ...
    def _atomic_prescriptive_template(cls, configuration=None, result=None, language=None, runtime_configuration=None, **kwargs):
        ...
        params = substitute_none_for_missing(configuration.kwargs, ['column', 'min_value', 'max_value', 'mostly', 'row_condition', 'condition_parser', 'strict_min', 'strict_max'])
