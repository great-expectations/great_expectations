...
class ExpectColumnValuesToBeUnique(ColumnMapExpectation):
    ...
    success_keys = ('mostly',)
    default_kwarg_values = {'row_condition': None, 'condition_parser': None, 'mostly': 1, 'parse_strings_as_datetimes': False, 'result_format': 'BASIC', 'include_config': True, 'catch_exceptions': True}
    args_keys = ('column',)
