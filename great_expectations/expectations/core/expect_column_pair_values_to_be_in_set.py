...
class ExpectColumnPairValuesToBeInSet(ColumnPairMapExpectation):
    ...
    default_kwarg_values = {'mostly': 1.0, 'ignore_row_if': 'both_values_are_missing', 'row_condition': None, 'condition_parser': None, 'result_format': 'BASIC', 'include_config': True, 'catch_exceptions': False}
