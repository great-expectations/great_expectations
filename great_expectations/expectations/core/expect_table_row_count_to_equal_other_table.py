...
class ExpectTableRowCountToEqualOtherTable(TableExpectation):
    ...
    library_metadata = {'maturity': 'production', 'tags': ['core expectation', 'table expectation', 'multi-table expectation'], 'contributors': ['@great_expectations'], 'requirements': []}
    metric_dependencies = ('table.row_count',)
    success_keys = ('other_table_name',)
    default_kwarg_values = {'other_table_name': None, 'result_format': 'BASIC', 'include_config': True, 'catch_exceptions': False}
    ...
    def _atomic_prescriptive_template(cls, configuration=None, result=None, language=None, runtime_configuration=None, **kwargs):
        ...
        params_with_json_schema = {'other_table_name': {'schema': {'type': 'string'}, 'value': params.get('other_table_name')}}
    ...
    def _diagnostic_observed_value_renderer(cls, configuration=None, result=None, language=None, runtime_configuration=None, **kwargs):
        ...
        return RenderedStringTemplateContent(**{'content_block_type': 'string_template', 'string_template': {'template': 'Row Count: $self_table_row_count<br>Other Table Row Count: $other_table_row_count', 'params': {'self_table_row_count': self_table_row_count, 'other_table_row_count': other_table_row_count}, 'styling': {'classes': ['mb-2']}}})
    ...
    def _validate(self, configuration: ExpectationConfiguration, metrics: Dict, runtime_configuration: dict=None, execution_engine: ExecutionEngine=None):
        ...
        return {'success': (table_row_count_self == table_row_count_other), 'result': {'observed_value': {'self': table_row_count_self, 'other': table_row_count_other}}}
