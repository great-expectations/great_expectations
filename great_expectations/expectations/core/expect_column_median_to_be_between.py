...
class ExpectColumnMedianToBeBetween(ColumnAggregateExpectation):
    ...
    _median_range_estimator_parameter_builder_config = ParameterBuilderConfig(
    ...
    _validation_parameter_builder_configs: List[ParameterBuilderConfig] = [
        _median_range_estimator_parameter_builder_config,
    ]
                ...
                "expectation_configuration_builders": [
                    {
                        ...
                        "min_value": f"{PARAMETER_KEY}{_median_range_estimator_parameter_builder_config.name}{FULLY_QUALIFIED_PARAMETER_NAME_SEPARATOR_CHARACTER}{FULLY_QUALIFIED_PARAMETER_NAME_VALUE_KEY}[0]",
                        "max_value": f"{PARAMETER_KEY}{_median_range_estimator_parameter_builder_config.name}{FULLY_QUALIFIED_PARAMETER_NAME_SEPARATOR_CHARACTER}{FULLY_QUALIFIED_PARAMETER_NAME_VALUE_KEY}[1]",
                        "strict_min": f"{VARIABLES_KEY}strict_min",
                        "strict_max": f"{VARIABLES_KEY}strict_max",
                        "meta": {
                            "profiler_details": f"{PARAMETER_KEY}{_median_range_estimator_parameter_builder_config.name}{FULLY_QUALIFIED_PARAMETER_NAME_SEPARATOR_CHARACTER}{FULLY_QUALIFIED_PARAMETER_NAME_METADATA_KEY}",
                        },
                    },
                ],
            },
