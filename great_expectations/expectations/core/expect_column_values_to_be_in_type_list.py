...
class ExpectColumnValuesToBeInTypeList(ColumnMapExpectation):
    ...
    def validate_configuration(
        ...
        try:
            ...
            assert isinstance(configuration.kwargs["type_list"], (list, dict)) or (
                configuration.kwargs["type_list"] is None
        ...
        if params["type_list"] is not None:
            ...
            if (params["mostly"] is not None) and (params["mostly"] < 1.0):
                ...
                if include_column_name:
                    template_str = (
                        "$column value types must belong to this set: " + values_string
        ...
        if expected_types_list is None:
            ...
            if (
                ...
                comp_types = {
                    ...
                    if (
                        isinstance(dtype, pd.core.dtypes.base.ExtensionDtype)
    ...
    def _validate(
        ...
        if isinstance(execution_engine, PandasExecutionEngine):
            if (actual_column_type.type.__name__ == "object_") and (
                expected_types_list is not None
            ):
