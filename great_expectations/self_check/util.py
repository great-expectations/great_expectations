...
try:
    ...
    SqlAlchemyDataset = None  # type: ignore[assignment] # could be None
    SqlAlchemyBatchReference = None  # type: ignore[assignment] # could be None
    logger.debug(
...
try:
    ...
    SparkDFDataset = None  # type: ignore[assignment] # could be None
    logger.debug(
