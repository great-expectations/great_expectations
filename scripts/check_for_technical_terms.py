            ...
            for line_number, line_contents in enumerate(active_file, 1):
                ...
                if phrase_in_line(line_working_contents, phrase):
                    ...
                    if in_code_block:
                        ...
                        tagged, present = phrase_is_tagged_outside_generic_tag(line_working_contents, phrase)
                        if tagged:
                            valid_lines.append(f"TAG({line_number})")
                        elif present:
                            valid_lines.append(line_number)
                        else:
                            tagged, present = phrase_is_tagged_in_generic_tag(line_working_contents, phrase)
                            if tagged:
