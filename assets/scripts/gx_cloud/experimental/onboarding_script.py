...
data_connector_name = "default_runtime_data_connector_name"  # Optional: Set your own data_connector_name
...
assert path_to_validator_batch, "Please set path_to_validator_batch. This can be a local filepath or a remote URL."
...
try:
    expectation_suite: ExpectationSuite = context.get_expectation_suite(expectation_suite_name=expectation_suite_name)
...
batch_request = RuntimeBatchRequest(
    ...
    batch_identifiers={
        "batch_id": path_to_validator_batch
    },
