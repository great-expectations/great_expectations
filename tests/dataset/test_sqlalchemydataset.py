...
def test_column_fallback(sa):
    ...
    df1 = dataset.expect_column_to_exist("age")
    df1.meta = {"validation_duration": AssertRegex("\d+")}
    assert df1 == fallback_dataset.expect_column_to_exist("age")

    df2 = dataset.expect_column_mean_to_be_between("age", min_value=10)
    df2.meta = {}
    ...
    df4 = dataset.expect_table_row_count_to_equal(value=3)
    df4.meta = {}
