...
def test_run_data_assistant_and_checkpoint(empty_data_context):
    ...
    data_assistant_result, checkpoint_result = configure_and_run_data_assistant_checkpoint(
    ...
    assert len(checkpoint_result["run_results"][list(checkpoint_result["run_results"].keys())[0]]["validation_result"].results) == expectation_num
