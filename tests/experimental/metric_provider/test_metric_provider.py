...
def test_snowflake_connection_metric_provider_is_supported_batch_definition(fluent_snowflake_datasource):
    datasource = build_MetricProviderSnowflakeDatasource_from_SnowflakeDatasource(fluent_snowflake_datasource)
    ...
    with mock.patch('contrib.experimental.metrics.snowflake_provider_data_source.SnowflakeUsernamePasswordConnector.get_connection') as mock_snowflake_conn:
        provider = datasource.get_metric_provider()
    assert provider.is_supported_batch_definition(batch_definition)
...
def test_snowflake_connection_metric_provider_get_supported_metrics():
    ...
    assert ColumnMeanMetric in mp.get_supported_metrics()
