...
local_tests = [
    ...
    IntegrationTestFixture(
        ...
        user_flow_script="docs/docusaurus/docs/reference/learn/terms/pandas_yaml_example.py",
        data_context_dir="tests/integration/fixtures/no_datasources/great_expectations",
        data_dir="tests/test_sets/taxi_yellow_tripdata_samples/first_3_files",
        backend_dependencies=[BackendDependencies.PANDAS],
    ),
    ...
    IntegrationTestFixture(
        ...
        user_flow_script="docs/docusaurus/docs/reference/learn/expectations/result_format.py",
        backend_dependencies=[],
    ),
    IntegrationTestFixture(
...
fluent_datasources = [
    IntegrationTestFixture(
        ...
        data_context_dir=None,
        data_dir="tests/test_sets/taxi_yellow_tripdata_samples",
        user_flow_script="docs/docusaurus/docs/reference/learn/terms/connect_to_your_data_overview.py",
        backend_dependencies=[],
    ),
    IntegrationTestFixture(
    ...
    IntegrationTestFixture(
        ...
        data_context_dir=None,
        data_dir="tests/test_sets/taxi_yellow_tripdata_samples",
        user_flow_script="docs/docusaurus/docs/reference/learn/terms/batch_request.py",
        backend_dependencies=[],
    ),
    IntegrationTestFixture(
        name="checkpoints_and_actions_core_concepts",
        user_flow_script="docs/docusaurus/docs/reference/learn/terms/checkpoints_and_actions.py",
        data_context_dir="tests/integration/fixtures/no_datasources/great_expectations",
        data_dir="tests/test_sets/taxi_yellow_tripdata_samples/first_3_files",
        backend_dependencies=[],
    ),
    ...
    IntegrationTestFixture(
        ...
        user_flow_script="docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/batch_requests/how_to_connect_to_a_sql_table.py",
        data_context_dir="tests/integration/fixtures/no_datasources/great_expectations",
        backend_dependencies=[],
    ),
    IntegrationTestFixture(
