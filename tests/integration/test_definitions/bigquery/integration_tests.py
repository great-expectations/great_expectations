...
partition_data = [
    ...
    IntegrationTestFixture(
        name="partition_data_on_column_value_bigquery",
    ...
    IntegrationTestFixture(
        name="partition_data_on_divided_integer_bigquery",
    ...
    IntegrationTestFixture(
        name="partition_data_on_mod_integer_bigquery",
    ...
    # ),
    IntegrationTestFixture(
        name="partition_data_on_multi_column_values_bigquery",
