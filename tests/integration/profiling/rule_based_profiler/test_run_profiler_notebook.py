...
@pytest.mark.e2e
def test_run_data_assistants_notebook_spark(tmp_path, spark_session):
    """
    What does this test and why?
    ...
    notebook_path: str = os.path.join(
        base_dir,
        "DataAssistants_Instantiation_And_Running-OnboardingAssistant-Spark.ipynb",
    )
    # temporary output notebook for traceback and debugging
    output_notebook_path: str = os.path.join(
...
@pytest.mark.slow  # 8.92s
@pytest.mark.e2e
def test_run_data_assistants_notebook_pandas(tmp_path):
    """
    What does this test and why?
    ...
    notebook_path: str = os.path.join(
        base_dir,
        "DataAssistants_Instantiation_And_Running-OnboardingAssistant-Pandas.ipynb",
    )
    # temporary output notebook for traceback and debugging
    output_notebook_path: str = os.path.join(
        tmp_path, "DataAssistants_Instantiation_and_running_executed.ipynb"
