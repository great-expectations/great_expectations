...
# <snippet name="tests/integration/docusaurus/tutorials/quickstart/v1_pandas_quickstart.py import_gx">  # noqa: E501
...
# Set up
# <snippet name="tests/integration/docusaurus/tutorials/quickstart/v1_pandas_quickstart.py get_context">  # noqa: E501
context = gx.get_context()
# </snippet>

# <snippet name="tests/integration/docusaurus/tutorials/quickstart/v1_pandas_quickstart.py connect_to_data">  # noqa: E501
...
# <snippet name="tests/integration/docusaurus/tutorials/quickstart/v1_pandas_quickstart.py create_expectation">  # noqa: E501
...
# <snippet name="tests/integration/docusaurus/tutorials/quickstart/v1_pandas_quickstart.py update_expectation">  # noqa: E501
