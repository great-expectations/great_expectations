...
"""
# <snippet name="tests/integration/docusaurus/core/expectation_suite/edit_a_single_expectation.py full example code">
# The following sections set up an Expectation Suite with Expectations
# that can later be retrieved and edited as an example.
# <snippet name="tests/integration/docusaurus/core/expectation_suite/edit_a_single_expectation.py imports">
...
# <snippet name="tests/integration/docusaurus/core/expectation_suite/edit_a_single_expectation.py get data context">
...
# <snippet name="tests/integration/docusaurus/core/expectation_suite/edit_a_single_expectation.py get expectation to edit">
existing_suite_name = (
...
# <snippet name="tests/integration/docusaurus/core/expectation_suite/edit_a_single_expectation.py edit attribute">
expectation.column = "pickup_location_id"
# </snippet>

# 3. Save the Expectation.
# <snippet name="tests/integration/docusaurus/core/expectation_suite/edit_a_single_expectation.py save the Expectation">
expectation.save()
# </snippet>
# </snippet>
