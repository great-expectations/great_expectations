...
"""
# <snippet name="tests/integration/docusaurus/core/expectation_suite/edit_an_expectation_suite.py full example code">
# The following sections set up an Expectation Suite that can later be modified
# as an example.

# <snippet name="tests/integration/docusaurus/core/expectation_suite/edit_an_expectation_suite.py create expectation suite">
...
# <snippet name="tests/integration/docusaurus/core/expectation_suite/edit_an_expectation_suite.py edit attribute">
suite.name = "renamed_expectation_suite"
# </snippet>

# 3. Save the Expectation Suite.
# <snippet name="tests/integration/docusaurus/core/expectation_suite/edit_an_expectation_suite.py save the Expectation">
suite.save()
# </snippet>
# </snippet>
