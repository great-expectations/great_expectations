...
batch_request = RuntimeBatchRequest(
    ...
    runtime_parameters={"query": f"SELECT * from {sfSchema}.taxi_data LIMIT 10"},
...
batch_request = BatchRequest(
    ...
    data_asset_name=f"{sfSchema}.taxi_data",  # this is the name of the table you want to retrieve
)
context.create_expectation_suite(
    expectation_suite_name="test_suite", overwrite_existing=True
)
...
assert f"{sfSchema}.taxi_data" in set(
