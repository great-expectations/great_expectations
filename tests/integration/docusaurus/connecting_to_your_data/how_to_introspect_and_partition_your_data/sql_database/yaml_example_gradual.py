...
# <snippet name="imports">
import great_expectations as gx

# </snippet>

# <snippet name="get_context">
...
# <snippet name="test_yaml_config">
context.test_yaml_config(datasource_yaml)
# </snippet>

# <snippet name="buggy_datasource_yaml">
...
# <snippet name="datasource_yaml_introspection">
datasource_yaml = f"""
name: taxi_datasource
class_name: SimpleSqlalchemyDatasource
connection_string: <CONNECTION_STRING>
...
# <snippet name="add_datasource">
context.add_datasource(**yaml.load(datasource_yaml))
# </snippet>

# <snippet name="get_available_data_asset_names">
...
# <snippet name="datasource_yaml_tables">
datasource_yaml = f"""
name: taxi_datasource
class_name: SimpleSqlalchemyDatasource
connection_string: <CONNECTION_STRING>
...
# <snippet name="test_yaml_config_2">
context.test_yaml_config(datasource_yaml)
# </snippet>

# <snippet name="datasource_yaml_tables_partitioners">
datasource_yaml = f"""
name: taxi_datasource
class_name: SimpleSqlalchemyDatasource
connection_string: <CONNECTION_STRING>
...
# <snippet name="test_yaml_config_3">
context.test_yaml_config(datasource_yaml)
# </snippet>

# <snippet name="add_datasource_2">
context.add_datasource(**yaml.load(datasource_yaml))
# </snippet>
