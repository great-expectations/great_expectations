...
# in test_files_dta_connector_scratch.py
...
# TODO: <Alex>DataContext.get_available_partitions() has been deprecated.  Either develop a test for an equivalent functionality, or delete this test.</Alex>
# IS NOW : test_partition_request_sorted_filtered_by_custom_filter() in test_files_data_connector_scratch.py
...
# TODO: <Alex>DataContext.get_available_partitions() has been deprecated.  Either develop a test for an equivalent functionality, or delete this test.</Alex>
# NOW LIVES IN : test_partition_request_sorted_filtered_by_custom_filter_with_limit() in test_files_data_connector_scratch
...
# TODO: <Alex>DataContext.get_available_partitions() has been deprecated.  Either develop a test for an equivalent functionality, or delete this test.</Alex>
# Now lives as : test_partition_request_sorted_filtered_by_custom_filter_with_index_at_int() in test_files_data_connector_scratch.py
...
# TODO: <Alex>DataContext.get_available_partitions() has been deprecated.  Either develop a test for an equivalent functionality, or delete this test.</Alex>
# Has found a new home : test_partition_request_sorted_filtered_by_custom_filter_with_index_as_string()
...
# TODO: <Alex>DataContext.get_available_partitions() has been deprecated.  Either develop a test for an equivalent functionality, or delete this test.</Alex>
# test_partition_request_sorted_filtered_by_custom_filter_with_slice_as_list() in test_files_data_Connector_scratch
...
# TODO: <Alex>DataContext.get_available_partitions() has been deprecated.  Either develop a test for an equivalent functionality, or delete this test.</Alex>
# now is test_partition_request_sorted_filtered_by_custom_filter_with_slice_as_tuple()
#
...
# TODO: <Alex>DataContext.get_available_partitions() has been deprecated.  Either develop a test for an equivalent functionality, or delete this test.</Alex>
# test_partition_request_sorted_filtered_by_custom_filter_with_slice_as_str() is
...
# TODO: <Alex>DataContext.get_available_partitions() has been deprecated.  Either develop a test for an equivalent functionality, or delete this test.</Alex>
# DEPRECATED : partition name is no longer used
...
# TODO: <Alex>DataContext.get_available_partitions() has been deprecated.  Either develop a test for an equivalent functionality, or delete this test.</Alex>
# is now test_partition_request_partition_request_partition_definition_query_1_key()
#
...
# TODO: <Alex>DataContext.get_available_partitions() has been deprecated.  Either develop a test for an equivalent functionality, or delete this test.</Alex>
# found a new home :) test_partition_request_partition_request_partition_definition_query_2_key()
