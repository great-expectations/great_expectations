    ...
    assert [e.to_json_dict() for e in obs.expectations] == [
        ...
        },
        {
            ...
            "kwargs": {
                ...
                "type_list": [
                    "INTEGER", "integer", "int", "int_", "int8", "int16", "int32", "int64", "uint8", "uint16",
                    "uint32", "uint64", "Int8Dtype", "Int16Dtype", "Int32Dtype", "Int64Dtype", "UInt8Dtype", "UInt16Dtype", "UInt32Dtype", "UInt64Dtype",
                    "INT", "INTEGER", "INT64", "TINYINT", "BYTEINT", "SMALLINT", "BIGINT", "IntegerType", "LongType",
                ],
            },
            "meta": {},
        },
    ...
    assert [e.to_json_dict() for e in obs.expectations] == [
        ...
        },
        {
            ...
            "kwargs": {
                "column": "favorite-number",
                "type_list": [
                    "FLOAT", "FLOAT4", "FLOAT8", "FLOAT64", "DOUBLE", "DOUBLE_PRECISION", "NUMERIC", "FloatType",
                    "DoubleType", "float", "float_", "float16", "float32", "float64", "number", "DECIMAL", "REAL",
                ],
            },
            "meta": {},
        },
        ...
        },
        {
            ...
            "kwargs": {
                ...
                "type_list": [
                    ...
                    "STRING", "StringType", "string", "str", "object", "dtype('O')",
                ],
            },
            "meta": {},
        },
