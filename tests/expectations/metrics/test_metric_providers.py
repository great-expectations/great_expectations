...
def test__base_metric_provider__registration(mock_registry):
    ...
    assert "custom_metric" in mock_registry._registered_metrics.keys()  # noqa: SIM118
...
def test__table_metric_provider__registration(mock_registry):
    ...
    assert len(mock_registry._registered_metrics.keys()) == prev_registered_metric_key_count + 1
    assert "table.custom_metric" in mock_registry._registered_metrics.keys()  # noqa: SIM118
...
def test__column_map_metric__registration(mock_registry):
    ...
    for key in new_keys:
        assert key in mock_registry._registered_metrics.keys()  # noqa: SIM118
...
def test__column_pair_map_metric__registration(mock_registry):
    ...
    for key in mock_registry._registered_metrics.keys():  # noqa: SIM118
...
def test__query_metric_provider__registration(mock_registry):
    ...
    assert len(mock_registry._registered_metrics.keys()) == prev_registered_metric_key_count + 1
    assert "query.custom_metric" in mock_registry._registered_metrics.keys()  # noqa: SIM118
