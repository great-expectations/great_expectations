...
def test_expect_queried_column_value_frequency_to_meet_threshold_row_condition(
    titanic_v013_multi_datasource_multi_execution_engine_data_context_with_checkpoints_v1_with_empty_store_stats_enabled,
):
    context: DataContext = titanic_v013_multi_datasource_multi_execution_engine_data_context_with_checkpoints_v1_with_empty_store_stats_enabled
    batch_request = BatchRequest(
    ...
    assert (
        ...
        and result["result"]["observed_value"] == 0.4791666666666667
    )


def test_expect_queried_column_value_frequency_to_meet_threshold_runtime_row_condition(
    titanic_v013_multi_datasource_multi_execution_engine_data_context_with_checkpoints_v1_with_empty_store_stats_enabled,
):
    context: DataContext = titanic_v013_multi_datasource_multi_execution_engine_data_context_with_checkpoints_v1_with_empty_store_stats_enabled
    batch_request = RuntimeBatchRequest(
    ...
    assert result["success"] is True and result["result"]["observed_value"] == 0.5
