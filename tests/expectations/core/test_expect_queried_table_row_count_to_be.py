...
def test_expect_queried_column_value_frequency_to_meet_threshold_active_sqlite(
    success,
    value,
    observed,
    row_condition,
...
@pytest.mark.parametrize(
    ...
    [
        (True, 100, 100, None),
        (True, 70, 70, 'col("Age")>17'),
    ],
)
def test_expect_queried_column_value_frequency_to_meet_threshold_runtime_sqlite(
    success,
    value,
    observed,
    row_condition,
    ...
    validator: Validator = context.get_validator(
        batch_request=sqlite_runtime_batch_request
    )
...
def test_expect_queried_column_value_frequency_to_meet_threshold_active_override_query_sqlite(
    success,
    query,
    value,
    observed,
...
def test_expect_queried_column_value_frequency_to_meet_threshold_runtime_override_query_sqlite(
    success,
    query,
    value,
    observed,
