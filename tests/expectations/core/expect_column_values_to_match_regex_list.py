...
from great_expectations.expectations.core.expect_column_values_to_match_regex_list import (
    ExpectColumnValuesToMatchRegexList,
)


def test_expect_column_values_to_match_regex_list_impl():
    ...
    expectation = ExpectColumnValuesToMatchRegexList(expectationConfiguration)
    batch = Batch(data=df)
