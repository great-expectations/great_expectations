from great_expectations.expectations.column_map_regex_expectation import RegexBasedColumnMapExpectation
...
class ExpectColumnValuesToOnlyContainVowels(RegexBasedColumnMapExpectation):
    ...
    map_metric = RegexBasedColumnMapExpectation._register_metric(
