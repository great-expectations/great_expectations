...
def test_validation_operator_evaluation_parameters(validation_operators_data_context, parameterized_expectation_suite):
    ...
    validation_operators_data_context.add_expectation_suite(expectation_suite=parameterized_expectation_suite)
...
def test_action_list_operator(validation_operators_data_context):
    ...
    batch = data_context._get_batch_v2(expectation_suite_name="f1.failure", batch_kwargs=validator_batch_kwargs)
    ...
    assert (
        operator_result.list_validation_results(group_by="expectation_suite_name")["f1.failure"][0]["statistics"][
            "success_percent"
        ]
        == 1.0e2
    )
    ...
    assert any(
        ...
        for e in operator_result.list_validation_results(group_by="data_asset_name")["f1"][0]
    )
    assert any(
...
def test_warning_and_failure_validation_operator(validation_operators_data_context):
    ...
    batch = data_context._get_batch_v2(expectation_suite_name="f1.warning", batch_kwargs=validator_batch_kwargs)
