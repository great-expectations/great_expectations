...
def test_validation_operator__run_slack(basic_data_context_config_for_validation_operator, tmp_path_factory, filesystem_csv_4):
    project_path = str(tmp_path_factory.mktemp('great_expectations'))
    ...
    vo = DefaultDataContextAwareValidationOperator(
        ...
        action_list = [{
            ...
            "action" : {
                "module_name" : "great_expectations.actions",
                "class_name" : "SummarizeAndNotifySlackAction",
                "webhook": "https://hooks.slack.com/services/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",
                "notify_on": "success",
                "summarizer":{
