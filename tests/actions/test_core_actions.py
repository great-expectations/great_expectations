...
def test_cloud_notification_action(
    ...
    validation_result_suite_with_id,
    ...
    expected_ge_cloud_url = urljoin(
        ...
        f"{cloud_action.checkpoint_id}/suite-validation-results/{validation_result_suite_identifier.id}/notification-actions",
    )
    expected_headers = {
    ...
    assert cloud_action.run(
        validation_result_suite=validation_result_suite_with_id,
