...
def test_cli_init(capsys):
    ...
    def monkeypatched_prompt_yn(arg):
        return input_args.pop()

    def monkeypatched_prompt_options(arg1, arg2):
        return input_args.pop()

    great_expectations.cli.prompt.yn = monkeypatched_prompt_yn
    great_expectations.cli.prompt.options = monkeypatched_prompt_options
    great_expectations.cli.prompt.query = monkeypatched_prompt_yn

    temp_dir = tempfile.mkdtemp()
    great_expectations.cli.dispatch(["init", "-d", temp_dir])

    print(temp_dir+"/great_expectations/great_expectations.yml")
    assert os.path.isdir(temp_dir+"/great_expectations")
    assert os.path.isfile(
        temp_dir+"/great_expectations/great_expectations.yml")
