...
class TestUtilMethods(unittest.TestCase):
    D = ge.dataset.PandasDataSet(pd.DataFrame({
        ...
        #categorical_fixed = np.random.choice(list("AAABBC"), size=100, replace=True)
        #'categorical_fixed': ['A', 'B', 'B', 'C', 'B', 'B', 'A', 'C', 'B', 'B', 'B', 'A', 'B', 'B', 'C', 'B', 'B', 'A', 'A', 'B', 'A', 'B', 'A', 'B', 'B', 'C', 'B', 'A', 'C', 'C', 'A', 'A', 'A', 'C', 'A', 'B', 'A', 'C', 'B', 'A', 'B', 'A', 'A', 'A', 'A', 'B', 'A', 'A', 'A', 'A', 'B', 'A', 'A', 'A', 'C', 'C', 'C', 'B', 'C', 'B', 'A', 'B', 'B', 'B', 'B', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'B', 'B', 'B', 'A', 'A', 'B', 'A', 'A', 'A', 'A', 'A', 'A', 'B', 'B', 'C', 'B', 'A', 'B', 'A', 'C', 'A', 'A', 'A', 'B', 'B', 'B', 'A', 'B', 'B', 'B', 'A', 'A', 'A', 'B', 'C', 'B', 'B', 'A', 'C', 'B', 'C', 'B', 'B', 'A', 'A', 'A', 'B', 'C', 'A', 'C', 'B', 'A', 'A', 'A', 'C', 'B', 'B', 'A', 'A', 'B', 'B', 'A', 'B', 'C', 'A', 'B', 'B', 'A', 'A', 'A', 'A', 'A', 'A', 'B', 'C', 'B', 'B', 'B', 'B', 'A', 'A', 'A', 'A', 'A', 'A', 'B', 'B', 'B', 'A', 'B', 'C', 'A', 'A', 'A', 'C', 'B', 'B', 'A', 'C', 'A', 'A', 'A', 'B', 'B', 'C', 'A', 'A', 'B', 'B', 'A', 'A', 'C', 'A', 'C', 'A', 'B', 'C', 'C', 'A', 'B', 'B', 'C', 'B', 'C', 'A', 'B', 'B', 'B', 'B', 'A', 'A', 'C', 'B', 'B', 'A', 'B', 'A', 'C', 'A', 'A', 'C', 'C', 'A', 'B', 'A', 'C', 'A', 'A', 'C', 'A', 'B', 'C', 'A', 'B', 'A', 'A', 'B', 'B', 'A', 'B', 'B', 'B', 'C', 'B', 'C', 'A', 'B', 'B', 'B', 'A', 'C', 'A', 'A', 'B', 'C', 'A', 'C', 'B', 'B', 'A', 'A', 'B', 'C', 'C', 'A', 'A', 'C', 'B', 'A', 'C', 'A', 'B', 'A', 'C', 'A', 'A', 'A', 'C', 'B', 'A', 'A', 'C', 'A', 'B', 'A', 'A', 'A', 'B', 'A', 'B', 'B', 'C', 'B', 'A', 'A', 'A', 'B', 'B', 'A', 'A', 'B', 'B', 'C', 'A', 'A', 'B', 'C', 'B', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'C', 'C', 'A', 'A', 'A', 'A', 'A', 'B', 'B', 'B', 'A', 'C', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'B', 'B', 'C', 'B', 'A', 'A', 'A', 'A', 'C', 'C', 'C', 'A', 'B', 'B', 'B', 'A', 'B', 'B', 'C', 'A', 'B', 'B', 'A', 'A', 'B', 'A', 'A', 'C', 'B', 'B', 'B', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'B', 'B', 'C', 'B', 'B', 'B', 'A', 'A', 'B', 'A', 'A', 'B', 'A', 'B', 'B', 'A', 'C', 'B', 'C', 'B', 'A', 'A', 'B', 'B', 'B', 'B', 'A', 'A', 'A', 'A', 'A', 'A', 'B', 'A', 'B', 'A', 'B', 'B', 'B', 'A', 'B', 'A', 'C', 'B', 'A', 'C', 'A', 'A', 'C', 'A', 'A', 'B', 'A', 'A', 'A', 'A', 'A', 'B', 'B', 'B', 'C', 'B', 'C', 'C', 'B', 'B', 'B', 'B', 'A', 'B', 'A', 'B', 'A', 'C', 'A', 'C', 'B', 'B', 'A', 'A', 'C', 'A', 'A', 'A', 'C', 'A', 'A', 'C', 'A', 'A', 'B', 'B', 'B', 'A', 'A', 'A', 'C', 'A', 'A', 'C', 'A', 'A', 'A', 'A', 'A', 'C', 'A', 'A', 'B', 'B', 'A', 'C', 'A', 'C', 'C', 'B', 'A', 'A', 'B', 'C', 'A', 'A', 'A', 'A', 'A', 'C', 'A', 'A', 'B', 'C', 'C', 'A', 'A', 'C', 'B', 'A', 'C', 'A', 'B', 'A', 'B', 'A', 'A', 'A', 'B', 'A', 'C', 'B', 'B', 'B', 'C', 'A', 'B', 'C', 'C', 'B', 'B', 'A', 'A', 'A', 'B', 'A', 'B', 'A', 'A', 'A', 'A', 'A', 'A', 'C', 'B', 'C', 'B', 'A', 'B', 'A', 'A', 'B', 'B', 'A', 'B', 'A', 'B', 'A', 'C', 'B', 'A', 'C', 'C', 'A', 'A', 'A', 'A', 'B', 'B', 'C', 'C', 'B', 'B', 'A', 'A', 'A', 'A', 'C', 'A', 'C', 'B', 'B', 'B', 'A', 'C', 'C', 'A', 'A', 'C', 'A', 'B', 'B', 'B', 'C', 'A', 'B', 'A', 'C', 'A', 'B', 'B', 'C', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'C', 'C', 'B', 'B', 'C', 'A', 'B', 'A', 'A', 'A', 'A', 'A', 'A', 'B', 'C', 'C', 'A', 'A', 'A', 'C', 'A', 'A', 'C', 'A', 'A', 'B', 'B', 'A', 'B', 'A', 'B', 'B', 'C', 'B', 'A', 'B', 'A', 'B', 'B', 'A', 'A', 'B', 'A', 'A', 'B', 'B', 'A', 'B', 'A', 'B', 'B', 'A', 'A', 'B', 'B', 'A', 'B', 'B', 'A', 'A', 'A', 'A', 'A', 'B', 'A', 'B', 'C', 'C', 'A', 'B', 'A', 'A', 'A', 'B', 'A', 'C', 'B', 'A', 'A', 'C', 'A', 'B', 'A', 'B', 'B', 'A', 'A', 'B', 'A', 'B', 'A', 'C', 'A', 'B', 'A', 'B', 'C', 'B', 'A', 'B', 'C', 'B', 'A', 'A', 'B', 'A', 'B', 'A', 'B', 'B', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'C', 'A', 'B', 'B', 'A', 'A', 'A', 'A', 'A', 'B', 'C', 'A', 'B', 'A', 'B', 'B', 'C', 'C', 'B', 'B', 'A', 'A', 'A', 'A', 'B', 'B', 'B', 'A', 'C', 'B', 'B', 'B', 'A', 'A', 'C', 'A', 'A', 'B', 'A', 'A', 'A', 'C', 'C', 'A', 'A', 'B', 'C', 'A', 'A', 'A', 'B', 'B', 'A', 'C', 'A', 'A', 'C', 'A', 'A', 'A', 'A', 'C', 'A', 'C', 'C', 'C', 'B', 'C', 'A', 'C', 'C', 'C', 'B', 'C', 'B', 'B', 'A', 'B', 'A', 'B', 'A', 'C', 'B', 'B', 'B', 'B', 'B', 'A', 'B', 'B', 'B', 'A', 'A', 'B', 'A', 'C', 'B', 'B', 'A', 'C', 'A', 'B', 'A', 'A', 'A', 'A', 'B', 'C', 'C', 'A', 'A', 'A', 'A', 'A', 'B', 'A', 'B', 'A', 'A', 'C', 'C', 'B', 'A', 'A', 'C', 'B', 'C', 'B', 'C', 'A', 'B', 'C', 'A', 'B', 'C', 'A', 'A', 'A', 'C', 'B', 'C', 'A', 'A', 'A', 'A', 'A', 'C', 'B', 'B', 'A', 'A', 'A', 'C', 'B', 'A', 'B', 'A', 'B', 'A', 'C', 'A', 'C', 'B', 'C', 'A', 'B', 'B', 'B', 'B', 'A', 'B', 'A', 'C', 'A', 'B', 'B', 'B', 'A', 'B', 'C', 'A', 'B', 'B', 'C', 'C', 'A', 'C', 'C', 'B', 'B', 'A', 'B', 'B', 'A', 'A', 'A', 'A', 'A', 'B', 'C', 'B', 'A', 'A', 'A', 'A', 'B', 'B', 'B', 'C', 'A', 'A', 'B', 'B', 'C', 'A', 'B', 'B', 'A', 'C', 'A', 'C', 'B', 'A', 'A', 'A', 'A', 'A', 'C', 'C', 'A', 'B', 'A', 'C', 'A', 'A', 'B', 'B', 'C', 'B', 'C', 'C', 'C', 'A', 'A', 'B', 'A', 'A', 'A', 'C', 'C', 'C', 'A', 'B', 'A', 'B', 'A', 'C', 'A', 'B', 'A', 'B', 'B', 'A', 'A', 'A', 'A', 'A', 'B', 'A', 'A', 'A', 'A', 'B', 'B', 'A', 'B', 'B', 'B', 'B', 'C']
    ...
    auto_partition_norm_0_1 = {
        'partition': [-np.inf,  -2.25713021e+00,  -1.69213407e+00,  -1.12713794e+00, -5.62141798e-01,   2.85433940e-03,   5.67850477e-01, 1.13284662e+00,   1.69784275e+00,   2.26283889e+00, 2.82783503e+00,   3.39283117e+00, np.inf],
        'weights': [ 0, 0.04,  0.07,  0.25,  0.14,  0.25,  0.1 ,  0.05,  0.05,  0.02,  0.03, 0]
        }
    ...
    def test_categorical_data_fixed(self):
        ...
        test_partition['partition'] = test_partition['partition'].tolist()
        for k in self.categorical_partition['partition']:
            self.assertEqual(
                self.categorical_partition['weights'][self.categorical_partition['partition'].index(k)],
                test_partition['weights'][test_partition['partition'].index(k)])

    def test_is_valid_partition_object_simple(self):
        self.assertTrue(ge.dataset.util.is_valid_partition_object(self.kde_smooth_partition_bimodal))
        self.assertTrue(ge.dataset.util.is_valid_partition_object(self.auto_partition_bimodal))
        self.assertTrue(ge.dataset.util.is_valid_partition_object(self.auto_partition_norm_0_1))
        self.assertTrue(ge.dataset.util.is_valid_partition_object(self.kde_smooth_partition_norm_0_1))

    def test_is_valid_partition_object_fails_length(self):
        self.assertFalse(ge.dataset.util.is_valid_partition_object({'partition': [0,1], 'weights': [0,1,2]}))

    def test_is_valid_partition_object_fails_weights(self):
        self.assertFalse(ge.dataset.util.is_valid_partition_object({'partition': [0,1,2], 'weights': [0.5,0.6]}))
    ...
    def test_is_valid_partition_object_fails_structure(self):
        ...
        self.assertFalse(ge.dataset.util.is_valid_partition_object({'partition': [0,1,2]}))
