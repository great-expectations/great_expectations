...
def test_adding_datasource_and_data_connector(empty_data_context):
    context: DataContext = empty_data_context
    connection_string = "bigquery://ge-oss-ci-cd/demo"

    # three pieces of information that are definitely needed
    datasource_name: str = "test_datasource"
    data_connector_name: str = "test_data_connector"
    data_asset_name: str = "taxi_data"  # Read from generated table name
    ...
    test_datasource = context.get_datasource(datasource_name="test_datasource")
    print(test_datasource.data_connectors)
