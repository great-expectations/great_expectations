...
def test_checkpoint_store(empty_data_context):
    ...
    assert checkpoint_store.get(key=key_0).to_json_dict() == my_checkpoint_config_0.to_json_dict()
...
"""
    ...
    assert checkpoint_store.get(key=key_1).to_json_dict() == my_checkpoint_config_1.to_json_dict()
