...
def test_TupleS3StoreBackend_with_boto3_options(monkeypatch, mocker):
    ...
    sts_expected_params = {'RoleArn': role_arn, 'RoleSessionName': 'GXAssumeRoleSession',
                           'ExternalId': external_id,
                           'DurationSeconds': 3600, 'Tags': tags}
...
def test_TupleS3StoreBackend_with_boto3_options_failure(monkeypatch, mocker):
    ...
    with monkeypatch.context() as m:
        ...
        m.setattr("great_expectations.data_context.store._store_backend.logger.warning", warning_mock)
        my_store = TupleS3StoreBackend(
            bucket="leakybucket",
            boto3_options={
                "assume_role_arn": role_arn,
