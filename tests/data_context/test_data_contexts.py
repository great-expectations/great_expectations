...
def test_validate_saves_result_inserts_run_id(empty_data_context, filesystem_csv):
    ...
    # Adding one expectation is deceptively important since otherwise the resulting
    # validations will compare differently because of nan
    ...
    with open(os.path.join(not_so_empty_data_context.get_context_root_directory(), 
              "great_expectations/uncommitted/validations/__autogenerated_uuid_v1__/f1.json")) as infile:
