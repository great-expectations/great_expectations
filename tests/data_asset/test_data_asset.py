...
def test_custom_expectation_default_arg_values_set(data_context_simple_expectation_suite_with_custom_pandas_dataset):
    ...
    result = batch.expect_column_sum_equals_3(
        column_list=["a", "b", "c"]
    )
