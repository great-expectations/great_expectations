...
def test_expect_file_line_regex_match_count_to_be_between():
    ...
    complete_file_path = file_relative_path(__file__, '../test_sets/toy_data_complete.csv')
...
def test_expect_file_to_exist():
    ...
    real_file = ge.data_asset.FileDataAsset(file_relative_path(__file__, '../test_sets/Titanic.csv'))
...
def test_expect_file_to_have_valid_table_header():
    ...
    invalid_header_dat = ge.data_asset.FileDataAsset(file_relative_path(__file__, '../test_sets/same_column_names.csv'))
    ...
    valid_header_dat = ge.data_asset.FileDataAsset(file_relative_path(__file__, '../test_sets/Titanic.csv'))
...
def test_expect_file_to_be_valid_json():
    ...
    invalid_JSON_file = ge.data_asset.FileDataAsset(file_relative_path(__file__, '../test_sets/invalid_json_file.json'))
    invalid_JSON_expectation = invalid_JSON_file.expect_file_to_be_valid_json()
    assert not invalid_JSON_expectation.success

    # Test valid JSON file
    valid_JSON_file = ge.data_asset.FileDataAsset(file_relative_path(__file__, '../test_sets/titanic_expectations.json'))
    ...
    test_file = ge.data_asset.FileDataAsset(file_relative_path(__file__, '../test_sets/json_test1_against_schema.json'))
    ...
    test_file = ge.data_asset.FileDataAsset(file_relative_path(__file__, '../test_sets/json_test2_against_schema.json'))
    schema_file = file_relative_path(__file__, '../test_sets/sample_schema.json')
    test_file_expectation = test_file.expect_file_to_be_valid_json(schema=schema_file)
