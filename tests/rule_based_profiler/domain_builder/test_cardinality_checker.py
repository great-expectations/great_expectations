...
def test_cardinality_checker_instantiation_valid_cardinality_limit_mode_parameter_relative():
    cardinality_checker: CardinalityChecker = CardinalityChecker(
...
def test_cardinality_checker_instantiation_valid_cardinality_max_rows_parameter():
    cardinality_checker: CardinalityChecker = CardinalityChecker(
        cardinality_max_rows=12345
    )
    assert isinstance(
        cardinality_checker.cardinality_limit_mode, AbsoluteCardinalityLimit
    )
...
def test_cardinality_checker_instantiation_valid_cardinality_max_proportion_unique_parameter_float():
    cardinality_checker: CardinalityChecker = CardinalityChecker(
        cardinality_max_proportion_unique=0.42
    )
    assert isinstance(
        cardinality_checker.cardinality_limit_mode, RelativeCardinalityLimit
    )
...
def test_cardinality_checker_instantiation_valid_cardinality_max_proportion_unique_parameter_int():
    cardinality_checker: CardinalityChecker = CardinalityChecker(
        cardinality_max_proportion_unique=1
    )
    assert isinstance(
        cardinality_checker.cardinality_limit_mode, RelativeCardinalityLimit
    )
...
def test_cardinality_checker_instantiation_invalid_cardinality_max_rows_parameter():
    with pytest.raises(ProfilerConfigurationError) as excinfo:
        _: CardinalityChecker = CardinalityChecker(
            cardinality_max_rows="invalid_input_type_string"
        )
    assert "specify an int" in str(excinfo.value)
    assert "str" in str(excinfo.value)


def test_cardinality_checker_instantiation_invalid_cardinality_max_proportion_unique_parameter():
    with pytest.raises(ProfilerConfigurationError) as excinfo:
        _: CardinalityChecker = CardinalityChecker(
            cardinality_max_proportion_unique="invalid_input_type_string"
        )
...
def test_cardinality_checker_instantiation_invalid_multiple_parameters():
    with pytest.raises(ProfilerConfigurationError) as excinfo:
        _: CardinalityChecker = CardinalityChecker(
            cardinality_limit_mode="REL_0_1", cardinality_max_proportion_unique=0.42
        )
...
def test_exhaustively_cardinality_within_limit_for_all_supported_cardinality_limits(
    ...
    cardinality_checker: CardinalityChecker = CardinalityChecker(
        cardinality_limit_mode=input_cardinality_limit_mode
    )
    ...
    if isinstance(cardinality_limit_mode, AbsoluteCardinalityLimit):
        ...
        cardinality_limit = cardinality_limit_mode.max_proportion_unique
...
def test_cardinality_checker_cardinality_within_limit_cardinality_max_rows_parameter():
    input_cardinality_max_rows: int = 12345
    cardinality_checker: CardinalityChecker = CardinalityChecker(
        cardinality_max_rows=input_cardinality_max_rows
    )
    passing_cardinality: int = input_cardinality_max_rows - 1
    failing_cardinality: int = input_cardinality_max_rows + 1
    assert cardinality_checker.cardinality_within_limit(passing_cardinality)
    assert not cardinality_checker.cardinality_within_limit(failing_cardinality)


def test_cardinality_checker_cardinality_within_limit_cardinality_max_proportion_unique_parameter_float():
    input_cardinality_max_proportion_unique: float = 0.42
    cardinality_checker: CardinalityChecker = CardinalityChecker(
        cardinality_max_proportion_unique=input_cardinality_max_proportion_unique
    )
    passing_cardinality: float = input_cardinality_max_proportion_unique - 0.01
    failing_cardinality: float = input_cardinality_max_proportion_unique + 0.01
    assert cardinality_checker.cardinality_within_limit(passing_cardinality)
    assert not cardinality_checker.cardinality_within_limit(failing_cardinality)


def test_cardinality_checker_cardinality_within_limit_cardinality_max_proportion_unique_parameter_int():
    input_cardinality_max_proportion_unique: int = 1
    cardinality_checker: CardinalityChecker = CardinalityChecker(
        cardinality_max_proportion_unique=input_cardinality_max_proportion_unique
    )
    passing_cardinality: float = input_cardinality_max_proportion_unique - 0.01
