...
from great_expectations.compatibility.google import storage as cloud_storage
...
@mock.patch(
    "great_expectations.datasource.data_connector.configured_asset_gcs_data_connector.cloud_storage.Client"
)
