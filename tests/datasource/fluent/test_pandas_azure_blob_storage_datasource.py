...
def bad_regex_config(csv_asset: CSVAsset) -> tuple[re.Pattern, str]:
    ...
    data_connector: AzureBlobStorageDataConnector = cast(AzureBlobStorageDataConnector, csv_asset._data_connector)
...
def test_construct_pandas_abs_datasource_with_account_url_and_config_credential(
    ...
    assert credential.get_config_value(config_provider=empty_file_context.config_provider) == "my_secret_credential"
