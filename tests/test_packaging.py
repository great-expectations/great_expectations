...
def test_polish_and_ratchet_pins_and_upper_bounds():
    ...
    assert sorted_packages_with_pins_or_upper_bounds == [
        ...
        ("requirements-dev-contrib.txt", "ruff", (("==", "0.0.282"),)),
        ...
        ("requirements-dev.txt", "mypy", (("==", "1.4.1"),)),
        ...
        ("requirements-dev.txt", "ruff", (("==", "0.0.282"),)),
        ...
        ("requirements-types.txt", "mypy", (("==", "1.4.1"),)),
        ...
        ("requirements-types.txt", "ruff", (("==", "0.0.282"),)),
