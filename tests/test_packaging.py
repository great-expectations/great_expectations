...
def test_polish_and_ratchet_pins_and_upper_bounds():
    ...
    assert set(sorted_packages_with_pins_or_upper_bounds) == {
        ...
        ("requirements-dev-contrib.txt", "mypy", (("==", "1.10.1"),)),
        ("requirements-dev-contrib.txt", "ruff", (("==", "0.5.7"),)),
        ...
        ("requirements-dev-test.txt", "mypy", (("==", "1.10.1"),)),
        ("requirements-dev-test.txt", "ruff", (("==", "0.5.7"),)),
        ...
        ("requirements-dev.txt", "mypy", (("==", "1.10.1"),)),
        ...
        ("requirements-dev.txt", "ruff", (("==", "0.5.7"),)),
        ...
        ("requirements-types.txt", "mypy", (("==", "1.10.1"),)),
        ...
        ("requirements-types.txt", "ruff", (("==", "0.5.7"),)),
