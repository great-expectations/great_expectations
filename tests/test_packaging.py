...
def test_polish_and_ratchet_pins_and_upper_bounds():
    ...
    assert len(sorted_packages_with_pins_or_upper_bounds) == 86
    assert set(sorted_packages_with_pins_or_upper_bounds) == {
        ...
        ("requirements-dev-contrib.txt", "ruff", (("==", "0.1.14"),)),
        ...
        ("requirements-dev-test.txt", "ruff", (("==", "0.1.14"),)),
        ...
        ("requirements-dev.txt", "ruff", (("==", "0.1.14"),)),
        ...
        ("requirements-types.txt", "ruff", (("==", "0.1.14"),)),
