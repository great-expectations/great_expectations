...
class TestCustomClass(unittest.TestCase):
    ...
    def test_custom_class(self):
        ...
        self.assertEqual(
            ...
            {'unexpected_list': [], 'unexpected_index_list': [], 'success': True}
        )
