...
def test_add_expectation_configurations(
    ...
    result = single_expectation_suite._legacy_add_expectation_configurations(
...
def test_add_expectation(
    ...
    single_expectation_suite._legacy_add_expectation(
    ...
    with pytest.raises(ValueError):
        domain_success_runtime_suite._legacy_add_expectation(
    ...
    with pytest.raises(InvalidExpectationConfigurationError):
        single_expectation_suite._legacy_add_expectation(config)
...
def test_add_expectation_with_ge_cloud_id(
    ...
    single_expectation_suite_with_expectation_ge_cloud_id._legacy_add_expectation(
