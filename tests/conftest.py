...
def alice_columnar_table_single_batch():
                ...
                ExpectationConfiguration(
                    ...
                    meta={
                        "notes": {
                            ...
                            "content": [
                                "### This expectation confirms no events occur before tracking started **2004-10-19 10:23:54**"  # noqa: E501
                            ],
                        }
                    },
                ),
                ExpectationConfiguration(
                    ...
                    meta={
                        "notes": {
                            "format": MetaNotesFormat.MARKDOWN,
                            "content": [
                                "### This expectation confirms that the event_ts contains the latest timestamp of all domains"  # noqa: E501
                            ],
                        }
                    },
                ),
                ExpectationConfiguration(
                    ...
                    meta={
                        ...
                        "notes": {
                            "format": MetaNotesFormat.MARKDOWN,
                            "content": [
                                "### This expectation confirms that fields ending in _ts are of the format detected by parameter builder SimpleDateFormatStringParameterBuilder"  # noqa: E501
                            ],
                        },
                    },
                ),
    ...
    for expectation_configuration in expectation_configurations:
        # NOTE Will 20211208 add_expectation() method, although being called by an ExpectationSuite instance, is being  # noqa: E501
        # called within a fixture, and we will prevent it from sending a usage_event by calling the private method  # noqa: E501
        # _add_expectation().
        ...
        "rules": {
            "my_rule_for_user_ids": {
                ...
                "domain_builder": {
                    ...
                    "module_name": "tests.test_fixtures.rule_based_profiler.plugins.my_custom_semantic_type_column_domain_builder",  # noqa: E501
    ...
    # NOTE that this expectation suite should fail when validated on the data in "sample_data_relative_path"  # noqa: E501
...
def bobby_columnar_table_multi_batch(empty_data_context):
            ...
            **{
                ...
                "meta": {
                    ...
                    "notes": {
                        "format": MetaNotesFormat.MARKDOWN,
                        "content": [
                            "### This expectation confirms that fields ending in _datetime are of the format detected by parameter builder SimpleDateFormatStringParameterBuilder"  # noqa: E501
                        ],
                    },
                },
            }
            ...
            **{
                ...
                "meta": {
                    ...
                    "notes": {
                        "format": MetaNotesFormat.MARKDOWN,
                        "content": [
                            "### This expectation confirms that fields ending in ID are of the format detected by parameter builder RegexPatternStringParameterBuilder"  # noqa: E501
                        ],
                    },
                },
            }
    ...
    expected_parameter_values_for_fully_qualified_parameter_names_by_domain_quantiles_estimator: Dict[  # noqa: E501
    ...
    return {
        ...
        "test_configuration_quantiles_estimator": {
            ...
            "expected_fixture_fully_qualified_parameter_names_by_domain": expected_fixture_fully_qualified_parameter_names_by_domain_quantiles_estimator,  # noqa: E501
            "expected_parameter_values_for_fully_qualified_parameter_names_by_domain": expected_parameter_values_for_fully_qualified_parameter_names_by_domain_quantiles_estimator,  # noqa: E501
        },
    }
...
def bobster_columnar_table_multi_batch_normal_mean_5000_stdev_1000():
    ...
    my_row_count_range_rule_expect_table_row_count_to_be_between_expectation_min_value_mean_value: int = round(  # noqa: E501
    ...
    my_row_count_range_rule_expect_table_row_count_to_be_between_expectation_max_value_mean_value: int = round(  # noqa: E501
        float(my_row_count_range_rule_expect_table_row_count_to_be_between_expectation_mean_value)
        + (
            my_row_count_range_rule_expect_table_row_count_to_be_between_expectation_num_stds
            * my_row_count_range_rule_expect_table_row_count_to_be_between_expectation_std_value
    ...
    return {
        ...
        "test_configuration_bootstrap_estimator": {
            ...
            "expect_table_row_count_to_be_between_mean_value": my_row_count_range_rule_expect_table_row_count_to_be_between_expectation_mean_value,  # noqa: E501
            "expect_table_row_count_to_be_between_min_value_mean_value": my_row_count_range_rule_expect_table_row_count_to_be_between_expectation_min_value_mean_value,  # noqa: E501
            "expect_table_row_count_to_be_between_max_value_mean_value": my_row_count_range_rule_expect_table_row_count_to_be_between_expectation_max_value_mean_value,  # noqa: E501
        },
    }
...
def bobster_columnar_table_multi_batch_normal_mean_5000_stdev_1000_data_context(
    ...
    output_file_lenths: List[int] = [
        ...
        for rnd_num_sample in random_state.normal(loc=5.0e3, scale=1.0e3, size=num_files)
    ]
...
def set_consistent_seed_within_numeric_metric_range_multi_batch_parameter_builder(
    ...
    logger.info(
        "Set the random_seed attr of the NumericMetricRangeMultiBatchParameterBuilder to a consistent value"  # noqa: E501
    )
