...
def titanic_data_context_with_fluent_pandas_and_spark_datasources_with_checkpoints_v1_with_empty_store_stats_enabled(
    ...
    # noinspection PyUnusedLocal
    dataframe_asset = datasource.add_dataframe_asset(
        name=dataframe_asset_name, dataframe=spark_df
    )
...
# TODO: <Alex>ALEX</Alex>
# @pytest.fixture
# def titanic_data_context_with_fluent_pandas_and_sqlalchemy_datasources_with_checkpoints_v1_with_empty_store_stats_enabled(
#     titanic_data_context_with_fluent_pandas_datasources_with_checkpoints_v1_with_empty_store_stats_enabled,
#     sa,
#     db_file,
# ):
