...
test_configuration_files = discover_json_test_configurations(test_config_dir)
...
@pytest.fixture(scope="module",
                params=test_configuration_files)
def test_configuration_file(request):
    return request.param


def test_runner(test_configuration_file, dataset_type):
