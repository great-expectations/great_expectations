...
def expectation_suite(
    ...
    suite.legacy_add_expectation_by_configuration(failing_expectation.configuration)
    suite.legacy_add_expectation_by_configuration(passing_expectation.configuration)
    return suite
