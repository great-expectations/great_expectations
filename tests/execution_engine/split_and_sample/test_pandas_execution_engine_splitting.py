...
def test_fixture(simple_multi_year_pandas_df):
    pass
...
def test_get_batch_with_split_on_year(
    ...
    # engine.load_batch_data(batch_data=simple_multi_year_pandas_df, batch_id="1234")
...
#     simple_multi_year_pandas_df: DataFrame,
# ):
#
#     split_df: pd.DataFrame = basic_spark_df_execution_engine.get_batch_data(
#         RuntimeDataBatchSpec(
#             batch_data=simple_multi_year_pandas_df,
...
#
# @mock.patch(
#     "great_expectations.execution_engine.split_and_sample.sparkdf_data_splitter.PandasDataSplitter.split_on_date_parts"
# )
# @pytest.mark.parametrize(
