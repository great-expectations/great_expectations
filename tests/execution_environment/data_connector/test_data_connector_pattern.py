...
def test_name_date_price_list(tmp_path_factory):
    ...
    my_batch_definition = my_data_connector.get_batch_definition_list_from_batch_request(
        my_batch_request
    )
...
def test_alpha(tmp_path_factory):
    ...
    my_batch_request = BatchRequest(
        ...
        data_connector_name="general_filesystem_data_connector",
        data_asset_name="DEFAULT_ASSET_NAME",
        partition_request=PartitionRequest(**{"part_1": "B"}),
    )
...
def test_foxtrot(tmp_path_factory):
    ...
    assert self_check_report == {
        ...
        "assets": {
            "A": {"batch_definition_count": 0, "example_data_references": []},
            "B": {"batch_definition_count": 0, "example_data_references": []},
            "C": {"batch_definition_count": 0, "example_data_references": []},
        },
