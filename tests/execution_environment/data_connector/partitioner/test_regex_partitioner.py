...
# <WILL> 20201102 deprecated. This test wont need to be migrated
...
# TODO: <Alex>Partitioner.find_or_create_partitions() has been deprecated.  We must develop a test for an equivalent functionality (e.g., "get_batch_list_from_batch_request()").</Alex>
# <WILL> Migrated to test_instantiation_from_a_config_regex_does_not_match_paths() in test_files_data_Connector.py
...
# TODO: <Alex>Partitioner.find_or_create_partitions() has been deprecated.  We must develop a test for an equivalent functionality (e.g., "get_batch_list_from_batch_request()").</Alex>
# <WILL> Similar to def test_example_with_implicit_data_asset_names() in test_single_partition_data_connector.py
...
# TODO: <Alex>Partitioner.find_or_create_partitions() has been deprecated.  We must develop a test for an equivalent functionality (e.g., "get_batch_list_from_batch_request()").</Alex>
# <WILL> test_files_data_connector has a test : test_return_all_batch_definitions_unsorted_only_one_group_named() but the behavior has changed?
# The function requires at least one named group.. which is different than the behavior tested here. Double-check if this is correct
...
# TODO: <Alex>Partitioner.find_or_create_partitions() has been deprecated.  We must develop a test for an equivalent functionality (e.g., "get_batch_list_from_batch_request()").</Alex>
# handled by def test_return_all_batch_definitions_unsorted(tmp_path_factory) in test_files_data_connector.py
...
# TODO: <Alex>Partitioner.find_or_create_partitions() has been deprecated.  We must develop a test for an equivalent functionality (e.g., "get_batch_list_from_batch_request()").</Alex>
# handled by single_partition_data_connector()
...
# TODO: <Alex>Partitioner.find_or_create_partitions() has been deprecated.  We must develop a test for an equivalent functionality (e.g., "get_batch_list_from_batch_request()").</Alex>
# test_fils_data_connector has test_return_all_batch_definitions_sorted() test
...
# conflict between default regex and group names
# TODO: <Alex>Partitioner.find_or_create_partitions() has been deprecated.  We must develop a test for an equivalent functionality (e.g., "get_batch_list_from_batch_request()").</Alex>
# test_return_all_batch_definitions_sorted_sorter_named_that_does_not_match_group() now handles this in Files
...
# TODO: <Alex>Partitioner.find_or_create_partitions() has been deprecated.  We must develop a test for an equivalent functionality (e.g., "get_batch_list_from_batch_request()").</Alex>
# turned into test_return_all_batch_definitions_too_many_sorters() in FilesDataConnectr
...
# # util method : moved to test_data_connector_utils.py
...
#
#
# # <WILL> equivalent test moved to test_data_connector_utils.py
# # util method : moved to test_data_connector_utils.py
