...
#
# # <WILL> move to test_utils.py
# def base_partitioner_with_sorter():
#     # test sorter config
#     price_sorter_config = [
...
#
# # <WILL> move to test_utils.py
# def base_partitioner_with_bad_sorter_config():
#     # 1. class_name is bad
...
#     # <WILL> : this is deprecated. Cannot over-ride module_name
