...
def test_partition():
    test_partition = Partition(name="test", data_asset_name="fake", definition={"name": "hello"}, data_reference="nowhere")
    # properties
    ...
    test_partition2 = Partition(name="test", data_asset_name="fake", definition={"name": "hello"}, data_reference="nowhere")
