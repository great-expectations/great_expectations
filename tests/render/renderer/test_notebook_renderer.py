...
def test_render_without_batch_kwargs_uses_batch_kwargs_in_citations(
    ...
    expected = {
        ...
        'cells': [
            ...
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
             'source': "batch.expect_column_values_to_not_be_null(\n    'provider_type', include_config=False)",
             'outputs': []}, {'cell_type': 'markdown',
...
def test_render_with_no_batch_kwargs_multiple_batch_kwarg_citations(
    ...
    expected = {
        ...
        'cells': [
            ...
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
             'source': "batch.expect_column_values_to_not_be_null('npi', include_config=False)",
             'outputs': []}, {'cell_type': 'markdown',
                              'source': '#### `provider_type`',
                              'metadata': {}},
            {'cell_type': 'code', 'metadata': {},
...
def test_complex_suite(warning_suite):
    ...
    expected = {
        ...
        'cells': [
            ...
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
             'source': 'batch.expect_table_row_count_to_be_between(\n    min_value=800000, max_value=1200000, include_config=False)',
             'outputs': []},
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
             'source': 'batch.expect_table_column_count_to_equal(value=71, include_config=False)',
             'outputs': []}, {'cell_type': 'markdown',
                              'source': '### Column Expectation(s)',
                              'metadata': {}},
            {'cell_type': 'markdown',
            ...
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
             'source': "batch.expect_column_values_to_be_in_set(\n    'nppes_provider_gender', value_set=[\n        'M', 'F', ''], include_config=False)",
             'outputs': []}, {'cell_type': 'markdown',
                              'source': '#### `nppes_entity_code`',
                              'metadata': {}},
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
             'source': "batch.expect_column_values_to_not_be_null(\n    'nppes_entity_code', include_config=False)",
             'outputs': []},
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
             'source': "batch.expect_column_values_to_be_in_set(\n    'nppes_entity_code', value_set=[\n        'I', 'O'], include_config=False)",
             'outputs': []},
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
            ...
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
             'source': "batch.expect_column_values_to_be_in_set(\n    'medicare_participation_indicator', value_set=[\n        'Y', 'N'], include_config=False)",
             'outputs': []}, {'cell_type': 'markdown',
                              'source': '#### `number_of_hcpcs`',
                              'metadata': {}},
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
             'source': "batch.expect_column_values_to_not_be_null(\n    'number_of_hcpcs', include_config=False)",
             'outputs': []},
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
            ...
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
             'source': "batch.expect_column_values_to_not_be_null(\n    'total_unique_benes', include_config=False)",
             'outputs': []},
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
             'source': "batch.expect_column_values_to_be_between(\n    'total_unique_benes',\n    min_value=0,\n    max_value=2000,\n    mostly=0.95,\n    include_config=False)",
            ...
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
             'source': "batch.expect_column_values_to_be_null(\n    'med_suppress_indicator',\n    mostly=0.85,\n    include_config=False)",
             'outputs': []},
            {'cell_type': 'code', 'metadata': {},
             'execution_count': None,
