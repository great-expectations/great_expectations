...
def test_configuration_driven_site_builder(titanic_data_context, filesystem_csv_2):
    ...
    # assert index_links_dict['mydatasource']['mygenerator']['Titanic']['expectations_links'][0]['filepath'] == 'expectations/mydatasource/mygenerator/Titanic/BasicDatasetProfiler.html'

    # assert len(index_links_dict['mydatasource']['mygenerator']['Titanic']['validation_links']) == 1

    # assert index_links_dict['mydatasource']['mygenerator']['Titanic']['validation_links'][0]['filepath'] == 'validation/test_run_id_12345/mydatasource/mygenerator/Titanic/BasicDatasetProfiler.html'
