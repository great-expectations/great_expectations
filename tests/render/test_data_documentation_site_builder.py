...
def test_site_builder_with_custom_site_section_builders_config(tmp_path_factory):
    ...
    shutil.copy(
        file_relative_path(__file__, "../test_fixtures/great_expectations_custom_local_site_config.yml"),
    ...
    assert validations_site_section_builder.run_name_filter == {"not_equals": "custom_validations_filter"}
