...
IGNORED_VIOLATIONS = [
    ...
    "tests/integration/docusaurus/connecting_to_your_data/fluent_datasources/how_to_quickly_connect_to_a_single_file_with_pandas.py",
    ...
    "tests/integration/docusaurus/expectations/how_to_edit_an_expectation_suite.py",
