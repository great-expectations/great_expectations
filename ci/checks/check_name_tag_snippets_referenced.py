...
IGNORED_VIOLATIONS = [
    ...
    "docs/docusaurus/docs/oss/guides/connecting_to_your_data/cloud/s3/components_spark/inferred_and_runtime_python_example.py datasource config",
    "docs/docusaurus/docs/oss/guides/connecting_to_your_data/cloud/s3/components_spark/inferred_and_runtime_python_example.py test datasource config",
    "docs/docusaurus/docs/snippets/inferred_and_runtime_yaml_example.py datasource config",
    "docs/docusaurus/docs/snippets/inferred_and_runtime_yaml_example.py test datasource config",
    ...
    "docs/docusaurus/docs/snippets/get_existing_data_asset_from_existing_datasource_pandas_filesystem_example.py my_datasource",
    ...
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_python_configs.py choose context_root_dir",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_python_configs.py imports",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_python_configs.py run checkpoint",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_python_configs.py set up context",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_yaml_configs.py add datasource config",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_yaml_configs.py add expectations",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_yaml_configs.py create batch request",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_yaml_configs.py datasource config",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_yaml_configs.py get validator",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_yaml_configs.py imports",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_yaml_configs.py root directory",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_yaml_configs.py run checkpoint",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_yaml_configs.py save suite",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_yaml_configs.py set up context",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_dataframe_yaml_configs.py test datasource config",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_file_python_configs.py add expectations",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_file_python_configs.py get validator",
    "docs/docusaurus/docs/snippets/databricks_deployment_patterns_file_python_configs.py save suite",
    "docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_bigquery.py existing_expectations_store",
    "docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_bigquery.py get_context",
    "docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py batch_request",
    ...
    "docs/docusaurus/docs/reference/learn/terms/checkpoints_and_actions.py assert_suite",
    "docs/docusaurus/docs/reference/learn/terms/checkpoints_and_actions.py checkpoint_example",
    "docs/docusaurus/docs/reference/learn/terms/checkpoints_and_actions.py keys_passed_at_runtime",
    "docs/docusaurus/docs/reference/learn/terms/checkpoints_and_actions.py nesting_with_defaults",
    "docs/docusaurus/docs/reference/learn/terms/checkpoints_and_actions.py no_nesting",
    "docs/docusaurus/docs/reference/learn/terms/checkpoints_and_actions.py run_checkpoint_5",
    "docs/docusaurus/docs/reference/learn/terms/checkpoints_and_actions.py using_simple_checkpoint",
    "docs/docusaurus/docs/reference/learn/terms/checkpoints_and_actions.py using_template",
    ...
    "docs/docusaurus/docs/oss/guides/setup/configuring_data_contexts/how_to_configure_credentials.py add_credential_from_yml",
    "docs/docusaurus/docs/oss/guides/setup/configuring_data_contexts/how_to_configure_credentials.py add_credentials_as_connection_string",
    "docs/docusaurus/docs/oss/guides/setup/configuring_data_contexts/how_to_configure_credentials.py export_env_vars",
    "docs/docusaurus/docs/oss/guides/setup/configuring_data_docs/how_to_host_and_share_data_docs_on_gcs.py build data docs command",
    "docs/docusaurus/docs/oss/guides/setup/configuring_data_docs/how_to_host_and_share_data_docs_on_gcs.py build data docs output",
    "docs/docusaurus/docs/oss/guides/setup/configuring_data_docs/how_to_host_and_share_data_docs_on_gcs.py create bucket command",
    "docs/docusaurus/docs/oss/guides/setup/configuring_data_docs/how_to_host_and_share_data_docs_on_gcs.py create bucket output",
    "docs/docusaurus/docs/oss/guides/setup/configuring_data_docs/how_to_host_and_share_data_docs_on_gcs.py gcloud app deploy",
    "docs/docusaurus/docs/oss/guides/setup/configuring_data_docs/how_to_host_and_share_data_docs_on_gcs.py gcloud login and set project",
    "docs/docusaurus/docs/oss/guides/setup/configuring_metadata_stores/how_to_configure_a_validation_result_store_in_gcs.py copy_validation_command",
    "docs/docusaurus/docs/oss/guides/setup/configuring_metadata_stores/how_to_configure_a_validation_result_store_in_gcs.py copy_validation_output",
    "docs/docusaurus/docs/oss/guides/setup/configuring_metadata_stores/how_to_configure_a_validation_result_store_in_gcs.py list_validation_stores_command",
    "docs/docusaurus/docs/oss/guides/setup/configuring_metadata_stores/how_to_configure_a_validation_result_store_in_gcs.py list_validation_stores_output",
    "docs/docusaurus/docs/oss/guides/setup/configuring_metadata_stores/how_to_configure_an_expectation_store_in_gcs.py copy_expectation_command",
    "docs/docusaurus/docs/oss/guides/setup/configuring_metadata_stores/how_to_configure_an_expectation_store_in_gcs.py copy_expectation_output",
    "docs/docusaurus/docs/oss/guides/setup/configuring_metadata_stores/how_to_configure_an_expectation_store_in_gcs.py list_expectation_stores_command",
    "docs/docusaurus/docs/oss/guides/setup/configuring_metadata_stores/how_to_configure_an_expectation_store_in_gcs.py list_expectation_stores_output",
    "docs/docusaurus/docs/oss/guides/setup/configuring_metadata_stores/how_to_configure_an_expectation_store_in_gcs.py list_expectation_suites_command",
