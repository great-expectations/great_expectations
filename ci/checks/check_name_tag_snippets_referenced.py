...
IGNORED_VIOLATIONS = [
    ...
    "docs/docusaurus/docs/snippets/inferred_and_runtime_yaml_example_spark_s3.py test datasource config",
    ...
    "docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py existing_validation_results_store",
    ...
    "docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py new_validation_results_store",
    ...
    "docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py set_new_validation_results_store",
    ...
    "tests/integration/fixtures/gcp_deployment/great_expectations/great_expectations.yml validation_results_store_name",
]
