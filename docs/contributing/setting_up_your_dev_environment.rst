...
**6. Install dependencies from requirements-dev.txt**
    ...
    *  Macbook users will be able to pip / pip3 install ``requirements-dev.txt`` from within conda, yet Windows users utilizing a conda environment will need to individually install all files within ``requirements-dev.txt``
