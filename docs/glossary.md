...
[**Data Assistant:**](./terms/data_assistant.md) A utility that asks questions about your data, gathers Metrics to describe what is observed in the dataset, and then proposes Expectations based on the answers.
