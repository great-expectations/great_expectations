...
- Completed [Step 2: Connect to Data](../tutorial_connect_to_data) of this tutorial.
...
For the purposes of this tutorial, the Expectations created by the Profiler are all we need.  On to [Step 4: Validate your data](../tutorial_validate_your_data)!