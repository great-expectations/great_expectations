...
3. Cell 3 is where you run a Data Assistant.  In this case, the assistant being used is the Onboarding Assistant, which which will profile the data provided by your batch request and create the relevant Expectations to add to your `taxi.demo` suite.
