...
7. Create and publish a Discuss Article using the title of your How-to as the title of our article. If your guide is a stub copy and paste the body from this  .. _discuss article: https://discuss.greatexpectations.io/t/how-to-configure-an-actionlistvalidationoperator/219 and replace the link with your guide's link. If it is not a stub remove *Please comment +1 if this How to is important to you.* from the body.
