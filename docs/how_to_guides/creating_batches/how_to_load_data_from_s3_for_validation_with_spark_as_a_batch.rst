.. _how_to_guides__creating_batches__how_to_load_data_from_s3_for_validation_with_spark_as_a_batch:

How to load data from S3 for validation with Spark as a batch
=============================================================
