.. _how_to_guides__creating_batches__how_to_load_a_file_from_filesystem_for_validation_with_pandas_as_a_batch:

How to load a file from filesystem for validation with Pandas as a batch
========================================================================
