...
- If you are creating Expectations that don't rely on per-Batch statistical analysis, or you want to quickly create some Expectations as part of an early Expectation Suite or exploratory data analysis, a single Batch is likely to be all that you need.  
