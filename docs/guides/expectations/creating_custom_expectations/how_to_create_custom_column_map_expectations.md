...
```python name="map_template_expectation_class"
```
...
```python name="map_template_docstring"
```
...
```python name="map_template_metric_name"
```
...
```python name="map_template_map_metric"
```
...
```python name="map_template_metric_class"
```
