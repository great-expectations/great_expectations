...
```python name="multicolumn_template_expectation"
```

with your real Expectation class name, in upper camel case:
```python name="custom_multicolumn_expectation"
```

You can also go ahead and write a new one-line docstring, replacing
```python name="multicolumn_template_docstring"
```

with something like:
```python name="custom_multicolumn_docstring"
```

You'll also need to change the class name at the bottom of the file, by replacing this line:

```python name="multicolumn_template_diagnostics"
```

with this one:
```python name="custom_multicolumn_diagnostics"
```
...
```python name="custom_multicolumn_examples"
```
...
```python name="custom_multicolumn_pandas"
```
...
```python name="multicolumn_template_metric_name"
```

with

```python name="custom_multicolumn_metric_name"
```

Second, in the Expectation class, replace

```python name="multicolumn_template_map_metric"
```

with

```python name="custom_multicolumn_map_metric"
```
...
```python name="multicolumn_template_metric"
```

with 

```python name="custom_multicolumn_metric"
```
...
```python name="multicolumn_template_library_metadata"
```

would become

```python name="custom_multicolumn_library_metadata"
```
