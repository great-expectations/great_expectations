Great Expectations makes use of the `boto3` library in the background when working with AWS.  Therefore, although you will not need to use `boto3` directly, you will need to have it installed into your virtual environment.
