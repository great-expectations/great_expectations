...
- Installed a supported version of Python.  (As of this writing, Great Expectations supports versions 3.7 through 3.10 of Python.  For details on how to download and install Python on your platform, please see [Python's documentation](https://www.python.org/doc/) and [download site](https://www.python.org/downloads/)s.)
