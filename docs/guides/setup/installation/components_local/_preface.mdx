...
- Installed a supported version of Python: 3.7 to 3.10  (For details on how to download and install Python on your platform, please see [Python's documentation](https://www.python.org/doc/) and [download sites](https://www.python.org/downloads/).)
