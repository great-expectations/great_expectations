...
.. content-tabs::
    ...
    .. tab-container:: tab1
        ...
        3. Construct a BatchRequest
            ...
            NOTE: When passing in Pandas dataframe as a batch, ``data_asset_name`` can optionally be passed in as part of ``BatchRequest``.  If you choose to not set your own ``data_asset_name``,  it will be set to  ``“IN_MEMORY_DATA_ASSET”` by default.
