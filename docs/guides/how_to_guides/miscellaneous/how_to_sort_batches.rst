...
.. content-tabs::
    ...
    .. tab-container:: tab3
        ...
        2. **Configure a Datasource**
          ...
          .. code-block:: python
            ...
            # custom list that we are passing in
    ...
    .. tab-container:: tab4
        ...
        They will be sequence according to their configuration. So in the following example, we will first have the ``DateTimeSorter`` applied, then ``LexicographicSorter`` then ``NumericSorter``.
    ...
    .. tab-container:: tab5
        ...
        6. **Construct a custom filter by year**.
