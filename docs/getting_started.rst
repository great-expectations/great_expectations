...
.. container:: custom-indented-paragraph
   ...
   To see how this works, follow :ref:`these instructions <getting_started__set_up_data_docs>` to set up a local static website for your data documentation. Later, you'll be able to host the site remotely, or integrate content generated by Great Expectations into an metadata store.
