...
Expectations are grouped into <TechnicalTag relative="../" tag="expectation_suite" text="Expectation Suites" />, which are in turn stored and retrieved through an <TechnicalTag relative="../" tag="expectation_store" text="Expectation Store" />. <TechnicalTag relative="../" tag="checkpoint" text="Checkpoints" /> rely on Expectation Suites (and the Expectations contained therein) to <TechnicalTag relative="../" tag="validation" text="Validate" /> data.
...
- Automated inspection of datasets. Currently, our Data Assistants mechanism in Great Expectations produces Expectation Suites that can be used for validation. The goal is automated inspection which can produce Expectations that will be used in validating future batches of data.
