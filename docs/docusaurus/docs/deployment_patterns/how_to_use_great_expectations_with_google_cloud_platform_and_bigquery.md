...
:::note Note on Expectations for BigQuery

  A small number of GX version 0.13.x Expectations have not been migrated to BigQuery, and will be very soon. These include:
