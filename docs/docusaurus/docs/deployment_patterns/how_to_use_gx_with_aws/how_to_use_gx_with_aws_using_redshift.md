...
Datasources can be configured in many customized ways.  For additional information on how to configure a SQL datasource such as the one used to connect to your Redshift data, please see our guide on [how to configure a SQL Datasource](/docs/guides/connecting_to_your_data/fluent/database/how_to_connect_to_sql_data)
