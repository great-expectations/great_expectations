...
To configure a SQL Datasource such as the one used to connect to your Redshift data, see [How to configure a SQL Datasource](/docs/0.15.50/guides/connecting_to_your_data/datasource_configuration/how_to_configure_a_sql_datasource)
