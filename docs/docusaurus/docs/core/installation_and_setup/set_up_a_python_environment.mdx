...
<p>Great Expectations (GX) is a library for Python versions {GxData.min_python} to {GxData.max_python}.  To utilize GX 1.0, you will first need to install Python.  It is also advised that you set up a virtual environment for your GX Python projects.</p>
...
<p>1. Reference the official Python documentation to install an appropriate version of Python.  GX is compatible with Python versions {GxData.min_python} to {GxData.max_python}.</p>
