...
```python title="Python" name="docs/docusaurus/docs/core/installation_and_setup/data_docs.py data_docs_site"
```
...
```bash title="Terminal input" name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py create bucket command"
```
...
```bash title="Terminal output" name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py create bucket output"
```
...
1. Create and then open ``app.yaml`` and then add the following entry:
    ...
    ```yaml title="app.yaml" name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py app yaml"
    ```

2. Create and then open `requirements.txt` and then add the following entry:

    ```yaml title="requirements.txt" name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py requirements.txt"
    ```

3. Create and then open `main.py` and then dd the following entry:

    ```python title="Python" name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py imports"
    ```
...
```bash title="Terminal input" name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py gcloud login and set project"
```
...
```bash title="Terminal input" name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py gcloud app deploy"
```
...
```python title="Python" name="docs/docusaurus/docs/core/installation_and_setup/data_docs.py data_docs"
```
