...
# <snippet name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py create bucket command">
...
# <snippet name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py create bucket output">
...
app_yaml = """
# <snippet name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py app yaml">
runtime: python37
env_variables:
...
requirements_txt = """
# <snippet name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py requirements.txt">
flask>=1.1.0
...
main_py = """
# <snippet name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py imports">
import logging
import os
...
# <snippet name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py gcloud login and set project">
...
# <snippet name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py gcloud app deploy">
gcloud app deploy
# </snippet>
"""
# Overwrite the version with the snippet tags
...
data_docs_site_yaml = """
# <snippet name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py data docs sites yaml">
data_docs_sites:
  local_site:
...
# <snippet name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py build data docs command">
...
# <snippet name="docs/docusaurus/docs/core/installation_and_setup/how_to_host_and_share_data_docs_on_gcs.py build data docs output">
