...
To add a S3 Store backend to your Data Docs configuration, update `bucket`, `prefix`, and `boto3_options` in the following code and execute it:

```python title="Python" name="docs/docusaurus/docs/core/configure_project_settings/configure_data_docs/_examples/data_docs_s3.py - add store backend"
```
