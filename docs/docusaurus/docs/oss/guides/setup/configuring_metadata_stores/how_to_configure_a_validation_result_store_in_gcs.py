...
try:
    ...
    delete_validation_store_files = (
        f"gsutil -m rm gs://{configured_validation_results_store['stores']['validations_GCS_store']['store_backend']['bucket']}"
        + f"/{configured_validation_results_store['stores']['validations_GCS_store']['store_backend']['prefix']}/**"
    )
...
copy_validation_command = copy_validation_command.replace(
    ...
    configured_validation_results_store["stores"]["validations_GCS_store"][
        "store_backend"
    ]["bucket"],
)
copy_validation_command = copy_validation_command.replace(
...
delete_validation_store_files = (
    f"gsutil -m rm gs://{configured_validation_results_store['stores']['validations_GCS_store']['store_backend']['bucket']}"
    + f"/{configured_validation_results_store['stores']['validations_GCS_store']['store_backend']['prefix']}/*.json"
)
result = subprocess.run(
    delete_validation_store_files, check=True, stderr=subprocess.PIPE, shell=True
)
...
list_validation_store_files = (
    f"gsutil ls gs://{configured_validation_results_store['stores']['validations_GCS_store']['store_backend']['bucket']}"
    + f"/{configured_validation_results_store['stores']['validations_GCS_store']['store_backend']['prefix']}"
)
result = subprocess.run(
