...
```python title="Python" name="inferred data connector define class_name as InferredAssetFilesystemDataConnector"
```
...
```python title="Python" name="inferred spark datasource_config up to adding empty default_regex and batch_spec_passthrough dictionaries"
```
