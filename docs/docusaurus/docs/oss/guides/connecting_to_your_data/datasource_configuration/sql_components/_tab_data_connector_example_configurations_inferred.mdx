...
There are also optional keys that you can define to alter how Data Assets are inferred, how they are partitioned into Batches, and how data is sampled from Batches.  This guide will go over those in the next section.