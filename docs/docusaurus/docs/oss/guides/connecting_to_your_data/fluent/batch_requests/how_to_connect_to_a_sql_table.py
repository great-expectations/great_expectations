...
# Python
# <snippet name="docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/batch_requests/how_to_connect_to_a_sql_table.py datasource">
datasource = context.get_datasource("my_datasource")
# </snippet>

# Python
# <snippet name="docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/batch_requests/how_to_connect_to_a_sql_table.py create_datasource">
...
# <snippet name="docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/batch_requests/how_to_connect_to_a_sql_table.py add_vendor_id_splitter">
table_asset.add_splitter_column_value("vendor_id")
# </snippet>

# <snippet name="docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/batch_requests/how_to_connect_to_a_sql_table.py build_vendor_id_batch_request">
