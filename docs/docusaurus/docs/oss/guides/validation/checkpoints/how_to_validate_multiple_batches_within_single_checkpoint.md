...
- [A Data Asset with multiple Batches](/docs/oss/guides/connecting_to_your_data/connect_to_data_lp).
- [An Expectation Suite](/docs/oss/guides/expectations/expectations_lp). 
...
For more information on partitioning a Data Asset into Batches, see [Manage Data Assets](/docs/oss/guides/connecting_to_your_data/manage_data_assets_lp).
:::
