...
| Application                             |
|-----------------------------------------|
| <i class="fas fa-circle" style={{color: "#dc3545"}}></i> Acryl Datahub<br/><i class="fas fa-circle" style={{color: "#dc3545"}}></i> Atlan<br/><i class="fas fa-circle" style={{color: "#dc3545"}}></i> Amundsen<br/><i class="fas fa-circle" style={{color: "#dc3545"}}></i> Azure Databricks<br/><i class="fas fa-circle" style={{color: "#dc3545"}}></i> Meltano<br/><i class="fas fa-circle" style={{color: "#dc3545"}}></i> dbt<br/><i class="fas fa-circle" style={{color: "#dc3545"}}></i> Capital One Data Profiler<br/><i class="fas fa-circle" style={{color: "#ffc107"}}></i> AWS Databricks  |
