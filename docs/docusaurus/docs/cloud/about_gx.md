...
| Task                                     | Description                                                        |
|------------------------------------------|--------------------------------------------------------------------|
|[Connect GX Cloud](/docs/cloud/quickstarts/quickstart_lp) | Set up your production environment to get the most out of GX Cloud. Do it once, and you don't need to do it again. If you're not ready to use GX Cloud in your production environment, see [Try GX Cloud](/docs/cloudquickstarts/snowflake_quickstart).                                   | 
