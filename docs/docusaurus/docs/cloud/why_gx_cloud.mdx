...
<img align ='left' width='50%' padding='12px' style='padding-right:20px' src={require('/docs/cloud/why_gx_cloud_images/expectations_plain_language.png').default}/>
...
<img align ='left' width='50%' style='padding-right:20px' src={require('/docs/cloud/why_gx_cloud_images/trend_visualizations.png').default}/>
...
<img align ='left' width='35%' style='padding-right:20px' src={require('/docs/cloud/why_gx_cloud_images/edit_expectations.png').default}/>
