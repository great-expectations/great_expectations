...
For more information, see [Configure Data Contexts](/docs/oss/guides/setup/configure_data_contexts_lp).
...
For more information, see [Configure your GX environment](/docs/oss/guides/setup/setup_overview_lp).
...
For more information, see [Connect to data](/docs/oss/guides/connecting_to_your_data/connect_to_data_lp).
...
For more information, see [Manage Data Assets](/docs/oss/guides/connecting_to_your_data/manage_data_assets_lp).
...
For more information, see [Request data from a Data Asset](/docs/oss/guides/connecting_to_your_data/fluent/batch_requests/how_to_request_data_from_a_data_asset).
...
For more information, see [Create Expectations](/docs/oss/guides/expectations/expectations_lp).
...
For more information, see [Create and manage Expectations and Expectation Suites](/docs/oss/guides/expectations/create_manage_expectations_lp).
...
For more information, see [Data Assistants](/docs/oss/guides/expectations/data_assistants_lp).
...
- [Create Custom Expectations](/docs/oss/guides/expectations/custom_expectations_lp)
- [Use a Custom Expectation](/docs/oss/guides/expectations/creating_custom_expectations/how_to_use_custom_expectations)
...
For more information, see [Validate Data](/docs/oss/guides/validation/checkpoints/checkpoint_lp).
...
For more information, see [Validation Result](/docs/reference/learn/terms/validation_result).
...
For more information, see [Configure Actions](/docs/oss/guides/validation/validation_actions/actions_lp).