...
```python title="Python output" name="docs/docusaurus/docs/snippets/result_format result_format_summary_example_agg_output"
```
...
```python title="Python output" name="docs/docusaurus/docs/snippets/result_format result_format_complete_example_set_output
```
...
```python title="Python output" name="docs/docusaurus/docs/snippets/result_format result_format_complete_example_agg_output"
```