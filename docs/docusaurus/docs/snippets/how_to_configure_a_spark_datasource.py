...
```
yarn snippet-check ./docs/docusaurus/docs/snippets/how_to_configure_a_spark_datasource.py
```
"""
...
def section_12_add_your_new_datasource_to_your_datacontext():
    for datasource_config, datasource_name in (
        ...
        assert (
            datasource_name in data_context.list_datasources()[0]["data_connectors"]
