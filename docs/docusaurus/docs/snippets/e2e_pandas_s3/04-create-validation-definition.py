...
batch_definition = context.datasources["nextflow"].get_asset("my_project").get_batch_definition("monthly")
...
result = context.validation_definitions.get("my_project").run(batch_parameters={"year": "2020", "month": "04"})
