...
You can manually add an <TechnicalTag tag="expectation_store" text="Expectations Store" /> by using the `add_store()` method, which will add a Store to your configuration.
