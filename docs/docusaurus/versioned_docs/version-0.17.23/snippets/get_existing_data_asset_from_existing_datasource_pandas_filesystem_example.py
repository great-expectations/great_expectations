...
# Python
# <snippet name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/snippets/get_existing_data_asset_from_existing_datasource_pandas_filesystem_example.py my_datasource">
...
# Python
# <snippet name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/snippets/get_existing_data_asset_from_existing_datasource_pandas_filesystem_example.py build_batch_request_with_dataframe">
my_batch_request = my_asset.build_batch_request(dataframe=dataframe)
# </snippet>

# Python
# <snippet name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/snippets/get_existing_data_asset_from_existing_datasource_pandas_filesystem_example.py my_asset">
...
# Python
# <snippet name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/snippets/get_existing_data_asset_from_existing_datasource_pandas_filesystem_example.py my_batch_list">
...
# Python
# <snippet name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/snippets/get_existing_data_asset_from_existing_datasource_pandas_filesystem_example.py print_batch_spec">
for batch in batches:
