...
To add a Data Source and an Expectation Suite, see [How to connect to a PostgreSQL database](/docs/guides/connecting_to_your_data/database/postgres#5-configure-your-datasource).
