...
```python name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/snippets/aws_redshift_deployment_patterns.py table_asset"
```
...
```python name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/snippets/aws_redshift_deployment_patterns.py query_asset"
```
