...
```python name="version-0.17.23 inferred spark datasource_config post batch_spec_passthrough definition"
```

  </TabItem>
  <TabItem value="configured">

```python name="version-0.17.23 configured spark datasource_config post batch_spec_passthrough definition"
```
...
```python name="version-0.17.23 runtime spark datasource_config post batch_spec_passthrough definition"
```
