...
To configure the BigQuery Data Source, see [How to connect to a BigQuery database](/guides/connecting_to_your_data/fluent/database/connect_sql_source_data.md).
