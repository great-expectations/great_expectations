...
```
yarn snippet-check ./version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/snippets/how_to_configure_a_sql_datasource.py
```
"""
...
def section_5_add_the_sqlalchemy_execution_engine_to_your_datasource_configuration():
    datasource_config: dict = {
        # <snippet name="version-0.17.23 sql datasource define execution_engine class_name and module_name">
        "execution_engine": {
    ...
    # <snippet name="version-0.17.23 sql datasource configuration post execution engine defined">
    datasource_config: dict = {
        ...
        "execution_engine": {
            "class_name": "SqlAlchemyExecutionEngine",
            "module_name": "great_expectations.execution_engine",
            # <snippet name="version-0.17.23 sql datasource define CONNECTION_STRING">
...
def section_6_add_a_dictionary_as_the_value_of_the_data_connectors_key():
    # <snippet name="version-0.17.23 sql datasource configuration post execution engine defined with empty data_connectors">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def section_7_configure_your_individual_data_connectors__inferred():
    # <snippet name="version-0.17.23 sql datasource configuration with empty inferred sql data_connector">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    # <snippet name="version-0.17.23 inferred sql datasource configuration with data_connector class_name defined">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        ...
        "data_connectors": {
            "name_of_my_inferred_data_connector": {
                # <snippet name="version-0.17.23 define data_connector class_name for inferred sql datasource">
...
def section_7_configure_your_individual_data_connectors__configured():
    # <snippet name="version-0.17.23 sql datasource configuration with empty configured sql data_connector">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    # <snippet name="version-0.17.23 configured sql datasource configuration with data_connector class_name defined">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        ...
        "data_connectors": {
            "name_of_my_configured_data_connector": {
                # <snippet name="version-0.17.23 define data_connector class_name for configured sql datasource">
...
def section_7_configure_your_individual_data_connectors__runtime():
    # <snippet name="version-0.17.23 sql datasource configuration with empty runtime sql data_connector">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    # <snippet name="version-0.17.23 runtime sql datasource configuration with data_connector class_name defined">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        ...
        "data_connectors": {
            "name_of_my_runtime_data_connector": {
                # <snippet name="version-0.17.23 define data_connector class_name for runtime sql datasource">
...
def section_8_configure_your_data_connectors_data_assets__inferred():
    # <snippet name="version-0.17.23 full configuration for sql inferred Datasource">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        ...
        "data_connectors": {
            # <snippet name="version-0.17.23 inferred sql data asset single batch">
            "inferred_data_connector_single_batch_asset": {
                "class_name": "InferredAssetSqlDataConnector",
            },
            # </snippet>
            # <snippet name="version-0.17.23 inferred sql data asset multi batch">
...
def section_8_configure_your_data_connectors_data_assets__configured():
    # <snippet name="version-0.17.23 full configuration for sql configured Datasource">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        ...
        "data_connectors": {
            "name_of_my_configured_data_connector": {
                "class_name": "ConfiguredAssetSqlDataConnector",
                "assets": {
                    # <snippet name="version-0.17.23 configured sql data asset single batch">
                    "yellow_tripdata_sample_2020_full": {
                        "table_name": "yellow_tripdata_sample_2020",
                        "schema_name": "main",
                    },
                    # </snippet>
                    # <snippet name="version-0.17.23 configured sql data asset multi batch">
...
def section_8_configure_your_data_connectors_data_assets__runtime():
    # <snippet name="version-0.17.23 full configuration for sql runtime Datasource">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        ...
        "data_connectors": {
            "name_of_my_runtime_data_connector": {
                "class_name": "RuntimeDataConnector",
                # <snippet name="version-0.17.23 runtime sql data asset define batch_identifiers">
...
def configure_your_data_connectors_data_assets__runtime__yaml():
    # <snippet name="version-0.17.23 full configuration for sql runtime Datasource YAML">
    datasource_config = f"""
    name: my_datasource_name
    class_name: Datasource
    execution_engine:
...
def section_9_test_your_configuration__runtime():
    ...
    test_result = (
        # <snippet name="version-0.17.23 test your sql datasource_config with test_yaml_config">
