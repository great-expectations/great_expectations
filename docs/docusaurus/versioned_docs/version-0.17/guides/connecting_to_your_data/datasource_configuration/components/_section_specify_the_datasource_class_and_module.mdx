...
```python name="version-0.17.23 datasource_configuration_class_and_module_keys"
```

Your full configuration should now look like:

```python name="version-0.17.23 datasource_configuration_post_class_and_module_keys"
```