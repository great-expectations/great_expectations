...
```python name="version-0.17.23 empty batch_spec_passthrough"
```
...
```python name="version-0.17.23 set reader_method to csv"
```
...
```python name="version-0.17.23 empty keys for reader_options"
```
...
```python name="version-0.17.23 populate header for reader_options as True"
```
...
```python name="version-0.17.23 populate inferSchema for reader_options as True"
```
...
```python name="version-0.17.23 fully populated batch_spec_passthrough configuration"
```