...
```python title="Python" name="version-0.17.23 empty batch_spec_passthrough"
```
...
```python title="Python" name="version-0.17.23 set reader_method to csv"
```
...
```python title="Python" name="version-0.17.23 empty keys for reader_options"
```
...
```python title="Python" name="version-0.17.23 populate header for reader_options as True"
```
...
```python title="Python" name="version-0.17.23 populate inferSchema for reader_options as True"
```
...
```python title="Python" name="version-0.17.23 fully populated batch_spec_passthrough configuration"
```