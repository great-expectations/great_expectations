...
```python title="Python" name="version-0.17.23 datasource_configuration_inferred_single_batch_regex_pattern"
```
...
```python title="Python" name="version-0.17.23 datasource_configuration_inferred_single_batch_group_names"
```
...
```python title="Python" name="version-0.17.23 data_connector_configuration_post_single_batch_regex"
```