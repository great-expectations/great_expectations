...
```python title="Python" name="version-0.17.23 sql datasource configuration with empty configured sql data_connector"
```
...
```python title="Python" name="version-0.17.23 define data_connector class_name for configured sql datasource"
```
...
```python title="Python" name="version-0.17.23 configured sql datasource configuration with data_connector class_name defined"
```
