...
```python name="version-0.17.23 inferred datasource_config up to batch_spec_passthrough"
```

  </TabItem>
  <TabItem value="configured">

```python name="version-0.17.23 configured datasource_config up to batch_spec_passthrough"
```
...
```python name="version-0.17.23 runtime datasource_config up to batch_spec_passthrough"
```
