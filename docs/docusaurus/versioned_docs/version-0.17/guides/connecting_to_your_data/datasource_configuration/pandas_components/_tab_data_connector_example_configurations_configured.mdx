...
```python name="version-0.17.23 datasource_configuration_add_empty_configured_data_connector"
```
...
```python name="version-0.17.23 data_connector_configuration_configured_class_name"
```
...
```python name="version-0.17.23 datasource_config_configured_data_connector_empty_data_asset"
```