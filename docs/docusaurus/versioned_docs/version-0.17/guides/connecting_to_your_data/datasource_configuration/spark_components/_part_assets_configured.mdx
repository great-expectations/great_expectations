...
```python title="Python" name="version-0.17.23 full datasource_config for configured spark single batch datasource"
```
...
```python title="Python" name="version-0.17.23 full datasource_config for configured spark multi batch datasource"
```
