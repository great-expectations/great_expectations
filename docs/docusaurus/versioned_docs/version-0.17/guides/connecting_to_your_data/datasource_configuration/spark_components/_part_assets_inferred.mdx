...
```python name="version-0.17.23 full datasource_config for inferred spark single batch datasource"
```
...
```python name="version-0.17.23 full datasource_config for inferred spark multi batch datasource"
```
