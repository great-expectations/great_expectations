...
In the final code cell, it will save any edits you have made to your Expectation Suite and then test the Expectation Suite by running a Checkpoint.  The results of that Checkpoint will then be displayed in Data Docs.
