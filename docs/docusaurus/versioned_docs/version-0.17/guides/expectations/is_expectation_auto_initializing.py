...
"""
# <snippet name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/guides/expectations/is_expectation_auto_initializing.py is_expectation_auto_initializing False">
from great_expectations.expectations.expectation import Expectation

Expectation.is_expectation_auto_initializing(name="expect_column_to_exist")
# </snippet>

# <snippet name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/guides/expectations/is_expectation_auto_initializing.py is_expectation_auto_initializing True">
