# <snippet name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/guides/expectations/advanced/data_assistant_cross_table_comparison.py imports">
...
# <snippet name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/guides/expectations/advanced/data_assistant_cross_table_comparison.py mysql_batch_request">
mysql_batch_request = mysql_datasource.get_asset(
    "mysql_taxi_data"
).build_batch_request()
# </snippet>
# <snippet name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/guides/expectations/advanced/data_assistant_cross_table_comparison.py pg_batch_request">
pg_batch_request = pg_datasource.get_asset("postgres_taxi_data").build_batch_request()
# </snippet>
# <snippet name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/guides/expectations/advanced/data_assistant_cross_table_comparison.py run_assistant">
...
# </snippet>
# <snippet name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/guides/expectations/advanced/data_assistant_cross_table_comparison.py build_suite">
...
# </snippet>
# <snippet name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/guides/expectations/advanced/data_assistant_cross_table_comparison.py checkpoint_config">
...
# </snippet>
# <snippet name="version-0.17.23 docs/docusaurus/versioned_docs/version-0.17.23/guides/expectations/advanced/data_assistant_cross_table_comparison.py run_checkpoint">
