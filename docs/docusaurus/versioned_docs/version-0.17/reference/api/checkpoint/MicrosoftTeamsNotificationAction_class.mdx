...
<dd>
<p>Sends a Microsoft Teams notification to a given webhook.</p>
...
<p>When a ValidationAction is configured in a Checkpoint, this method gets called after the Checkpoint produces an ExpectationSuiteValidationResult.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters</dt>
