...
<dl class="simple">
<dt>Expectation classes <em>must</em> have the following attributes set:
</dt>
...
<dl class="simple">
<dt>Expectation classes <em>must</em> implement the following:
</dt>
<dd><ol class="arabic simple">
...
<dl class="simple">
<dt>Additionally, they <em>may</em> provide implementations of:
</dt>
<dd><ol class="arabic simple">
