...
```python title="Import GX" name="version-0.18.8 docs/docusaurus/docs/snippets/pandas_yaml_example.py import gx"
```

```python name="version-0.18.8 docs/docusaurus/docs/snippets/pandas_yaml_example.py get_context"
```
...
```python name="version-0.18.8 docs/docusaurus/docs/snippets/pandas_yaml_example.py import BatchRequest"
```

```python name="version-0.18.8 docs/docusaurus/docs/snippets/pandas_yaml_example.py context.get_batch with batch request"
```

If you prefer untyped inputs, you run code similar to the following examples:

```python name="version-0.18.8 docs/docusaurus/docs/snippets/pandas_yaml_example.py context.get_batch with parameters data_asset_name"
```

```python name="version-0.18.8 docs/docusaurus/docs/snippets/pandas_yaml_example.py context.get_batch with parameters"
```
