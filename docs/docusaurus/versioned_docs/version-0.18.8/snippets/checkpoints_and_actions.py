...
context.add_or_update_checkpoint(
    name="version-0.18.8 test_checkpoint",
...
results = context.run_checkpoint(checkpoint_name="version-0.18.8 test_checkpoint")
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py results">
results = {
...
batch_request = FluentBatchRequest(
    datasource_name="version-0.18.8 taxi_datasource",
    data_asset_name="version-0.18.8 taxi_asset",
    options={"year": "2019", "month": "01"},
)
validator = context.get_validator(
    batch_request=batch_request,
    expectation_suite_name="version-0.18.8 my_expectation_suite",
)
...
validator = context.get_validator(
    batch_request=batch_request,
    expectation_suite_name="version-0.18.8 my_other_expectation_suite",
)
validator.expect_table_row_count_to_be_between(
    min_value={"$PARAMETER": "GT_PARAM", "$PARAMETER.GT_PARAM": 0},
    max_value={"$PARAMETER": "LT_PARAM", "$PARAMETER.LT_PARAM": 1000000},
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py no_nesting">
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py no_nesting just the yaml">
context.add_or_update_checkpoint(
    name="version-0.18.8 my_checkpoint",
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py run_checkpoint">
results = context.run_checkpoint(checkpoint_name="version-0.18.8 my_checkpoint")
# </snippet>
assert results.success is True
assert (
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py nesting_with_defaults">
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py nesting_with_defaults just the yaml">
context.add_or_update_checkpoint(
    name="version-0.18.8 my_checkpoint",
    run_name_template="%Y-%M-foo-bar-template-$VAR",
    validations=[
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py run_checkpoint_2">
results = context.run_checkpoint(checkpoint_name="version-0.18.8 my_checkpoint")
# </snippet>
assert results.success is True

# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py validation_results_suites_data_assets">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py keys_passed_at_runtime">
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py keys_passed_at_runtime just the yaml">
context.add_or_update_checkpoint(
    name="version-0.18.8 my_base_checkpoint",
    run_name_template="%Y-%M-foo-bar-template-$VAR",
    action_list=[
        {
            "name": "<ACTION NAME FOR STORING VALIDATION RESULTS>",
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py run_checkpoint_3">
results = context.run_checkpoint(
    checkpoint_name="version-0.18.8 my_base_checkpoint",
    validations=[
        {
            "batch_request": {
                "datasource_name": "taxi_datasource",
...
# </snippet>
assert results.success is True
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py validation_results_suites_data_assets_2">
first_validation_result = list(results.run_results.items())[0][1]["validation_result"]
second_validation_result = list(results.run_results.items())[1][1]["validation_result"]
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py using_template">
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py using_template just the yaml">
context.add_or_update_checkpoint(
    name="version-0.18.8 my_checkpoint",
    template_name="version-0.18.8 my_base_checkpoint",
    validations=[
        {
            "batch_request": {
                "datasource_name": "taxi_datasource",
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py run_checkpoint_4">
results = context.run_checkpoint(checkpoint_name="version-0.18.8 my_checkpoint")
# </snippet>
assert results.success is True
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py validation_results_suites_data_assets_3">
first_validation_result = list(results.run_results.items())[0][1]["validation_result"]
second_validation_result = list(results.run_results.items())[1][1]["validation_result"]
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/checkpoints_and_actions.py checkpoint_example">
name: my_checkpoint
config_version: 1
