...
def section_5_add_the_spark_execution_engine_to_your_datasource_configuration():
    ...
    # <snippet name="version-0.18.8 spark datasource_config up to definition of Spark execution engine">
    ...
    execution_engine_snippet: dict = {
        ...
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        # <snippet name="version-0.18.8 define spark execution engine">
        "execution_engine": {
            "class_name": "SparkDFExecutionEngine",
            "module_name": "great_expectations.execution_engine",
        }
...
def section_6_add_a_dictionary_as_the_value_of_the_data_connectors_key():
    ...
    # <snippet name="version-0.18.8 spark datasource_config up to adding an empty data_connectors dictionary">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def section_7_configure_your_individual_data_connectors__inferred():
    ...
    """
    # <snippet name="version-0.18.8 spark Datasource configuration up to adding an empty inferred data connector">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    # <snippet name="version-0.18.8 inferred spark datasource_config up to adding empty default_regex and batch_spec_passthrough dictionaries">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        ...
        "data_connectors": {
            "name_of_my_inferred_data_connector": {
                # <snippet name="version-0.18.8 inferred data connector define class_name as InferredAssetFilesystemDataConnector">
    ...
    glob_directive: dict = {
        ...
        "data_connectors": {
            "name_of_my_inferred_data_connector": {
                "class_name": "InferredAssetFilesystemDataConnector",
                "base_directory": "../data",
                # <snippet name="version-0.18.8 define glob_directive">
                "glob_directive": "*/*",
                # </snippet>
                "default_regex": {},
                "batch_spec_passthrough": {},
    ...
    # <snippet name="version-0.18.8 spark inferred datasource_config post glob_directive definition">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def section_7_configure_your_individual_data_connectors__configured():
    ...
    """
    # <snippet name="version-0.18.8 spark Datasource configuration up to adding an empty configured data connector">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    # <snippet name="version-0.18.8 configured spark datasource_config up to adding empty assets and batch_spec_passthrough dictionaries">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        ...
        "data_connectors": {
            "name_of_my_configured_data_connector": {
                # <snippet name="version-0.18.8 configured data connector define class_name as ConfiguredAssetFilesystemDataConnector">
...
def section_7_configure_your_individual_data_connectors__runtime():
    ...
    """
    # <snippet name="version-0.18.8 spark Datasource configuration up to adding an empty runtime data connector">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    # <snippet name="version-0.18.8 runtime spark datasource_config up to adding empty batch_identifiers and batch_spec_passthrough dictionaries">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        ...
        "data_connectors": {
            "name_of_my_runtime_data_connector": {
                # <snippet name="version-0.18.8 runtime data connector define class_name as RuntimeDataConnector">
...
def section_8_configure_the_values_for_batch_spec_passthrough__universal():
    ...
    empty_batch_spec_passthrough: dict = {
        # <snippet name="version-0.18.8 populate batch_spec_passthrough with empty reader_method and reader_options">
        "batch_spec_passthrough": {"reader_method": "", "reader_options": {}}
        # </snippet>
    }
    smaller_snippets: dict = {
        "batch_spec_passthrough": {
            # <snippet name="version-0.18.8 populate reader_method with csv">
            "reader_method": "csv",
            # </snippet>
            # <snippet name = "version-0.18.8 populate reader_options with empty header and inferSchema keys">
    ...
    even_smaller_snippets: dict = {
        "batch_spec_passthrough": {
            "reader_method": "csv",
            "reader_options": {
                # <snippet name="version-0.18.8 define header as True for reader_options">
                "header": True,
                # </snippet>
                # <snippet name="version-0.18.8 define inferSchema as True for reader_options">
                "inferSchema": True
                # </snippet>
            },
        }
...
def section_8_configure_the_values_for_batch_spec_passthrough__inferred():
    # <snippet name="version-0.18.8 inferred spark datasource_config post batch_spec_passthrough definition">
    datasource_config: dict = {
...
def section_8_configure_the_values_for_batch_spec_passthrough__configured():
    # <snippet name="version-0.18.8 configured spark datasource_config post batch_spec_passthrough definition">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def section_8_configure_the_values_for_batch_spec_passthrough__runtime():
    # <snippet name="version-0.18.8 runtime spark datasource_config post batch_spec_passthrough definition">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def section_9_configure_your_data_connectors_data_assets__inferred__single_batch():
    single_line_snippets: dict = {
        "data_connectors": {
            "name_of_my_inferred_data_connector": {
                "default_regex": {
                    # <snippet name="version-0.18.8 inferred spark single batch pattern">
                    "pattern": "(.*)\\.csv",
                    # </snippet>
                    # <snippet name="version-0.18.8 inferred spark single batch group_names">
    ...
    data_connector_snippet: dict = {
        "data_connectors": {
            # <snippet name="version-0.18.8 inferred spark single batch data connector config">
            "name_of_my_inferred_data_connector": {
                "class_name": "InferredAssetFilesystemDataConnector",
                "base_directory": "../data",
                "default_regex": {
    ...
    # <snippet name="version-0.18.8 full datasource_config for inferred spark single batch datasource">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def section_9_configure_your_data_connectors_data_assets__inferred__multi_batch():
    # <snippet name="version-0.18.8 full datasource_config for inferred spark multi batch datasource">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        ...
        "data_connectors": {
            # <snippet name="version-0.18.8 inferred spark multi batch data connector config">
            "name_of_my_inferred_data_connector": {
                "class_name": "InferredAssetFilesystemDataConnector",
                "base_directory": "../data",
                "default_regex": {
...
def section_9_configure_your_data_connectors_data_assets__configured__single_batch():
    datasource_config: dict = {
        "data_connectors": {
            "name_of_my_configured_data_connector": {
                "assets": {
                    # <snippet name="version-0.18.8 empty asset for configured spark single batch datasource">
                    "yellow_tripdata_jan": {}
                    # </snippet>
                }
            }
    ...
    # <snippet name="version-0.18.8 full datasource_config for configured spark single batch datasource">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        ...
        "data_connectors": {
            # <snippet name="version-0.18.8 configured spark single batch data connector config">
            "name_of_my_configured_data_connector": {
                "class_name": "ConfiguredAssetFilesystemDataConnector",
                "base_directory": "../data",
                "assets": {
                    # <snippet name="version-0.18.8 configured spark single batch asset">
                    "yellow_tripdata_jan": {
                        # <snippet name="version-0.18.8 configured spark single batch pattern">
                        "pattern": "yellow_tripdata_sample_2020-(01)\\.csv",
                        # </snippet>
                        # <snippet name="version-0.18.8 configured spark single batch group_names">
                        "group_names": ["month"],
                        # </snippet>
                    },
                    # </snippet>
...
def section_9_configure_your_data_connectors_data_assets__configured__multi_batch():
    datasource_config: dict = {
        "data_connectors": {
            "name_of_my_configured_data_connector": {
                "assets": {
                    # <snippet name="version-0.18.8 empty asset for configured spark multi batch datasource">
    ...
    # <snippet name="version-0.18.8 full datasource_config for configured spark multi batch datasource">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        ...
        "data_connectors": {
            # <snippet name="version-0.18.8 configured spark multi batch data connector config">
            "name_of_my_configured_data_connector": {
                "class_name": "ConfiguredAssetFilesystemDataConnector",
                "base_directory": "../data",
                "assets": {
                    # <snippet name="version-0.18.8 configured spark multi batch asset">
                    "yellow_tripdata_2020": {
                        # <snippet name="version-0.18.8 configured spark multi batch pattern">
                        "pattern": "yellow_tripdata_sample_2020-(.*)\\.csv",
                        # </snippet>
                        # <snippet name="version-0.18.8 configured spark multi batch group_names">
                        "group_names": ["month"],
                        # </snippet>
                    },
                    # </snippet>
...
def section_9_configure_your_data_connectors_data_assets__runtime():
    # <snippet name="version-0.18.8 full datasource_config for runtime spark datasource">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        ...
        "data_connectors": {
            "name_of_my_runtime_data_connector": {
                ...
                # <snippet name="version-0.18.8 runtime spark batch_identifiers">
...
def section_12_add_your_new_datasource_to_your_datacontext():
    for datasource_config, datasource_name in (
        ...
        # <snippet name="version-0.18.8 test your spark datasource config with test_yaml_config">
        data_context.test_yaml_config(yaml.dump(datasource_config))
        # </snippet>

        # <snippet name="version-0.18.8 add your spark datasource to your data_context">
        data_context.add_datasource(**datasource_config)
        # </snippet>

        # <snippet name="version-0.18.8 add your spark datasource to your data_context only if it does not already exit">
        ...
        data_context.delete_datasource(
            datasource_name="version-0.18.8 my_datasource_name"
        )
