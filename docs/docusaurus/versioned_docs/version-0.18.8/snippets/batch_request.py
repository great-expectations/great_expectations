...
# <snippet name="version-0.18.8 tests/integration/docusaurus/reference/glossary/batch_request batch_request">
import great_expectations as gx
...
datasource = context.sources.add_pandas_filesystem(
    name="version-0.18.8 my_pandas_datasource", base_directory=data_directory
)

# The batching_regex should max file names in the data_directory
asset = datasource.add_csv_asset(
    name="version-0.18.8 csv_asset",
...
# <snippet name="version-0.18.8 tests/integration/docusaurus/reference/glossary/batch_request options">
