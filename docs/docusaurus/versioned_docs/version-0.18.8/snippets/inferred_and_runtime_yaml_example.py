...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/inferred_and_runtime_yaml_example.py datasource_yaml">
datasource_yaml = r"""
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/inferred_and_runtime_yaml_example.py test_yaml_config">
context.test_yaml_config(datasource_yaml)
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/inferred_and_runtime_yaml_example.py add_datasource">
context.add_datasource(**yaml.load(datasource_yaml))
# </snippet>

# Here is a RuntimeBatchRequest using a path to a single CSV file
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/inferred_and_runtime_yaml_example.py path batch_request">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/inferred_and_runtime_yaml_example.py get_validator 1">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/inferred_and_runtime_yaml_example.py batch_request">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/inferred_and_runtime_yaml_example.py get_validator">
context.add_or_update_expectation_suite(
    expectation_suite_name="version-0.18.8 test_suite"
)
validator = context.get_validator(
