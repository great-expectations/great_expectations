...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py imports">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py existing_expectations_store">
stores:
  expectations_store:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py new_expectations_store">
stores:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py existing_validations_store">
stores:
  validations_store:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py new_validations_store">
stores:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py set_new_validations_store">
...
data_docs_site_yaml = """
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py add_data_docs_store">
data_docs_sites:
  local_site:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py vars">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py datasource">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py table_asset">
table_asset = datasource.add_table_asset(
    name="my_table_asset", table_name="version-0.18.8 taxi_data"
)
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py query_asset">
query_asset = datasource.add_query_asset(
    name="version-0.18.8 my_query_asset", query="SELECT * from taxi_data"
)
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py add_suite_and_get_validator">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py validator_calls">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py save_expectations">
validator.save_expectation_suite(discard_failed_expectations=False)
# </snippet>

# build Checkpoint
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py create_checkpoint">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py run checkpoint">
