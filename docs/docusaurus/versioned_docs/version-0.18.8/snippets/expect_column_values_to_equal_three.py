...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py ColumnValuesEqualThree class_def">
class ColumnValuesEqualThree(ColumnMapMetricProvider):
    # </snippet>

    # This is the id string that will be used to reference your metric.
    # <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py metric_name">
    condition_metric_name = "version-0.18.8 column_values.equal_three"
    # </snippet>

    # This method implements the core logic for the PandasExecutionEngine
    # <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py pandas">
    @column_condition_partial(engine=PandasExecutionEngine)
    def _pandas(cls, column, **kwargs):
        return column == 3
        # </snippet>

    # <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py spark_definition">
    @metric_partial(
    ...
    def _spark(
        ...
        # </snippet>
        # <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py spark_selectable">
        (
            selectable,
        ...
        # </snippet>
        # <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py spark_query">
        query = F.when(column == 3, F.lit(False)).otherwise(F.lit(True))

        return (query, compute_domain_kwargs, accessor_domain_kwargs)
        # </snippet>

    # <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py sqlalchemy">
    ...
    def _get_evaluation_dependencies(
        ...
        dependencies["table.column_types"] = MetricConfiguration(
            metric_name="version-0.18.8 table.column_types",
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py ExpectColumnValuesToEqualThree class_def">
class ExpectColumnValuesToEqualThree(ColumnMapExpectation):
    # </snippet>
    # <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py docstring">
    """Expect values in this column to equal 3."""

    # </snippet>
    # These examples will be shown in the public gallery.
    # They will also be executed as unit tests for your Expectation.
    # <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py examples">
    examples = [
        {
            "data": {
    ...
    # <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py map_metric">
    ...
    # <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py library_metadata">
    library_metadata = {
...
if __name__ == "__main__":
    # <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py diagnostics">
