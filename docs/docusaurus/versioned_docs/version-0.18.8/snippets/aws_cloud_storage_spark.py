...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py imports">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py existing_expectations_store">
stores:
  expectations_store:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py new_expectations_store">
stores:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py existing_validations_store">
stores:
  validations_store:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py new_validations_store">
stores:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py set_new_validations_store">
...
data_docs_site_yaml = """
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py add_data_docs_store">
data_docs_sites:
  local_site:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py add_s3_datasource">
datasource = context.sources.add_or_update_spark_s3(
    name="version-0.18.8 s3_datasource",
    bucket="taxi-data-sample-test",
    boto3_options=awscreds,
)
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py get_spark_s3_asset">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py get_batch_request">
request = asset.build_batch_request({"year": "2021"})
# </snippet>


# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py get_batch_list">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py get_validator">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py add_expectations">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py save_expectations">
validator.save_expectation_suite(discard_failed_expectations=False)
# </snippet>

# build Checkpoint
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py create_checkpoint">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py run checkpoint">
...
# build datadocs
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_spark.py build_docs">
