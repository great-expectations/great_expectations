...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py imports">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py existing_expectations_store">
stores:
  expectations_store:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py new_expectations_store">
stores:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py existing_validations_store">
stores:
  validations_store:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py new_validations_store">
stores:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py set_new_validations_store">
...
data_docs_site_yaml = """
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py add_data_docs_store">
data_docs_sites:
  local_site:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py add_s3_datasource">
datasource = context.sources.add_or_update_pandas_s3(
    name="version-0.18.8 s3_datasource", bucket="taxi-data-sample-test"
)
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py get_pandas_s3_asset">
asset = datasource.add_csv_asset(
    name="version-0.18.8 csv_taxi_s3_asset",
    batching_regex=r".*_(?P<year>\d{4})\.csv",
)
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py get_batch_request">
request = asset.build_batch_request({"year": "2021"})
# </snippet>


# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py get_batch_list">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py get_validator">
context.add_or_update_expectation_suite(
    expectation_suite_name="version-0.18.8 test_suite"
)
validator = context.get_validator(
    batch_request=request, expectation_suite_name="version-0.18.8 test_suite"
)
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py add_expectations">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py save_expectations">
validator.save_expectation_suite(discard_failed_expectations=False)
# </snippet>

# build Checkpoint
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py create_checkpoint">
...
# build datadocs
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py build_docs">
