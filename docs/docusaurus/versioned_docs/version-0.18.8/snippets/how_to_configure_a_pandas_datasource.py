...
def get_full_pandas_inferred_datasource_single_batch():
    # <snippet name="version-0.18.8 pandas_inferred_datasource_single_batch_full_snippet">
...
def get_full_pandas_inferred_datasource_multi_batch():
    # <snippet name="version-0.18.8 pandas_inferred_datasource_multi_batch_full_snippet">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def get_full_pandas_configured_datasource_single_batch():
    # <snippet name="version-0.18.8 pandas_configured_datasource_single_batch_full_snippet">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def get_full_pandas_configured_datasource_multi_batch():
    # <snippet name="version-0.18.8 pandas_configured_datasource_multi_batch_full_snippet">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def get_full_pandas_runtime_datasource():
    # <snippet name="version-0.18.8 pandas_runtime_datasource_full_snippet">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def validate_pandas_datasource_configuration_snippets():
    ...
    # <snippet name="version-0.18.8 datasource_configuration_empty_dictionary">
    datasource_config: dict = {}
    # </snippet>

    # Snippet: adding a name to your datasource
    datasource_config: dict = {
        # <snippet name="version-0.18.8 datasource_configuration_name_key">
        "name": "my_datasource_name",  # Preferably name it something relevant
        # </snippet>
    }
    ...
    # <snippet name="version-0.18.8 datasource_configuration_post_name_key">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
    }
    # </snippet>
    ...
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        # <snippet name="version-0.18.8 datasource_configuration_class_and_module_keys">
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource"
        # </snippet>
    }
    ...
    # <snippet name="version-0.18.8 datasource_configuration_post_class_and_module_keys">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    datasource_config: dict = {
        ...
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
        # <snippet name="version-0.18.8 datasource_configuration_add_execution_engine">
        "execution_engine": {
            "class_name": "PandasExecutionEngine",
            "module_name": "great_expectations.execution_engine",
        },
    ...
    # <snippet name="version-0.18.8 datasource_configuration_post_execution_engine">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    # <snippet name="version-0.18.8 datasource_configuration_add_empty_data_connectors_key">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def validate_pandas_datasource_configuration_inferred_snippets():
    ...
    # <snippet name="version-0.18.8 datasource_config add empty inferred_data_connector">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    datasource_config: dict = {
        "data_connectors": {
            "name_of_my_inferred_data_connector": {
                # <snippet name="version-0.18.8 inferred data connector populate class_name">
                "class_name": "InferredAssetFilesystemDataConnector",
                # </snippet>
            }
        }
    ...
    datasource_config: dict = {
        "data_connectors": {
            "name_of_my_inferred_data_connector": {
                # <snippet name="version-0.18.8 inferred data connector add base_directory">
                "base_directory": "../data",
                # </snippet>
            }
        }
    ...
    # <snippet name="version-0.18.8 datasource_configuration_pandas_inferred_empty_regex">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    datasource_config = {
        "data_connectors": {
            "name_of_my_inferred_data_connector": {
                # <snippet name="version-0.18.8 datasource_configuration_glob_directive">
                "glob_directive": "*.*"
                # </snippet>
            }
        }
    ...
    # <snippet name="version-0.18.8 datasource_configuration_post_glob_directive">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def validate_pandas_datasource_configuration_inferred_single_batch_snippets():
    ...
    datasource_config = {
        "data_connectors": {
            "name_of_my_inferred_data_connector": {
                "default_regex": {
                    # <snippet name="version-0.18.8 datasource_configuration_inferred_single_batch_regex_pattern">
                    "pattern": "(.*)\\.csv",
                    # </snippet>
                    # <snippet name="version-0.18.8 datasource_configuration_inferred_single_batch_group_names">
                    "group_names": ["data_asset_name"],
                    # </snippet>
                }
            }
    ...
    datasource_config = {
        "data_connectors": {
            # <snippet name="version-0.18.8 data_connector_configuration_post_single_batch_regex">
            "name_of_my_inferred_data_connector": {
                "class_name": "InferredAssetFilesystemDataConnector",
                "base_directory": "../data",
                "default_regex": {
    ...
    # <snippet name="version-0.18.8 datasource_configuration_post_inferred_data_connector">
    datasource_config = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def validate_pandas_datasource_configuration_inferred_multi_batch_snippets():
    ...
    datasource_config = {
        "data_connectors": {
            "name_of_my_inferred_data_connector": {
                "default_regex": {
                    # <snippet name="version-0.18.8 datasource_configuration_inferred_multi_batch_regex_pattern">
                    "pattern": "(yellow_tripdata_sample_2020)-(\\d.*)\\.csv",
                    # </snippet>
                    # <snippet name="version-0.18.8 group_names for inferred multi batch default_regex key">
                    "group_names": ["data_asset_name", "month"],
                    # </snippet>
                }
            }
    ...
    datasource_config = {
        "data_connectors": {
            # <snippet name="version-0.18.8 data connector config for inferred filesystem data connector multi batch">
            "name_of_my_inferred_data_connector": {
                "class_name": "InferredAssetFilesystemDataConnector",
                "base_directory": "../data",
                "default_regex": {
    ...
    # <snippet name="version-0.18.8 datasource_configuration_post_multi_batch_inferred_data_connector">
    datasource_config = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def validate_pandas_datasource_configuration_configured_snippets():
    ...
    # <snippet name="version-0.18.8 datasource_configuration_add_empty_configured_data_connector">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    datasource_config: dict = {
        "data_connectors": {
            "name_of_my_configured_data_connector": {
                # <snippet name="version-0.18.8 data_connector_configuration_configured_class_name">
                "class_name": "ConfiguredAssetFilesystemDataConnector",
                # </snippet>
                # <snippet name="version-0.18.8 data_connector_configuration_configured_base_directory">
                "base_directory": "../data",
                # </snippet>
            }
        }
    ...
    # <snippet name="version-0.18.8 datasource_config_configured_data_connector_empty_data_asset">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def validate_pandas_datasource_configuration_configured_single_batch_snippets():
    ...
    datasource_config = {
        "data_connectors": {
            "name_of_my_configured_data_connector": {
                "assets": {
                    # <snippet name="version-0.18.8 empty_data_asset_configuration_configured_single_batch">
                    "yellow_tripdata_jan": {}
                    # </snippet>
                }
            }
    ...
    datasource_config = {
        "data_connectors": {
            "name_of_my_configured_data_connector": {
                "assets": {
                    "yellow_tripdata_jan": {
                        # <snippet name="version-0.18.8 pattern_for_single_batch_configured_data_asset_configuration">
                        "pattern": "yellow_tripdata_sample_2020-(01)\\.csv",
                        # </snippet>
                        # <snippet name="version-0.18.8 group_names for single batch configured assets configuration">
                        "group_names": ["month"],
                        # </snippet>
                    }
                }
    ...
    datasource_config = {
        "data_connectors": {
            "name_of_my_configured_data_connector": {
                "assets": {
                    # <snippet name="version-0.18.8 full_data_asset_for_single_batch_configured_data_connector">
                    "yellow_tripdata_jan": {
                        "pattern": "yellow_tripdata_sample_2020-(01)\\.csv",
                        "group_names": ["month"],
                    }
    ...
    datasource_config = {
        "data_connectors": {
            # <snippet name="version-0.18.8 full_single_batch_configured_data_connector_configuration">
            "name_of_my_configured_data_connector": {
                "class_name": "ConfiguredAssetFilesystemDataConnector",
                "base_directory": "../data",
                "assets": {
    ...
    # <snippet name="version-0.18.8 full datasource_config for pandas execution engine, configured data connector; single batch asset">
    datasource_config = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def validate_pandas_datasource_configuration_configured_multi_batch_snippets():
    ...
    datasource_config = {
        "data_connectors": {
            "name_of_my_configured_data_connector": {
                "assets": {
                    # <snippet name="version-0.18.8 empty data asset for configured, multi batch datasource">
                    "yellow_tripdata_2020": {}
                    # </snippet>
                }
            }
    ...
    datasource_config = {
        "data_connectors": {
            "name_of_my_configured_data_connector": {
                "assets": {
                    "yellow_tripdata_2020": {
                        # <snippet name="version-0.18.8 pattern for asset in configured, multi-batch datasource">
                        "pattern": "yellow_tripdata_sample_2020-(.*)\\.csv",
                        # </snippet>
                        # <snippet name="version-0.18.8 group_names for asset in configured, multi-batch datasource">
                        "group_names": ["month"],
                        # </snippet>
                    }
                }
    ...
    datasource_config = {
        "data_connectors": {
            "name_of_my_configured_data_connector": {
                "assets": {
                    # <snippet name="version-0.18.8 multi batch data asset for configured pandas datasource">
                    "yellow_tripdata_2020": {
                        "pattern": "yellow_tripdata_sample_2020-(.*)\\.csv",
                        "group_names": ["month"],
                    }
    ...
    datasource_config = {
        "data_connectors": {
            # <snippet name="version-0.18.8 data connector for configured, multi-batch, Pandas datasource">
            "name_of_my_configured_data_connector": {
                "class_name": "ConfiguredAssetFilesystemDataConnector",
                "base_directory": "../data",
                "assets": {
    ...
    # Snippet: Full configuration for a Datasource using a Configured Data Connector and single-batch Data Asset.
    # <snippet name="version-0.18.8 full config for Pandas, configured, multi-batch Datasource">
    datasource_config = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def validate_pandas_datsource_configuration_runtime_snippets():
    ...
    # <snippet name="version-0.18.8 add empty dictionary for runtime data connector">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    datasource_config: dict = {
        "data_connectors": {
            "name_of_my_runtime_data_connector": {
                # <snippet name="version-0.18.8 class_name for pandas runtime data connector">
                "class_name": "RuntimeDataConnector",
                # </snippet>
            }
        }
    ...
    # <snippet name="version-0.18.8 full config for pandas runtime Datasource with blank data asset identifiers">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    datasource_config: dict = {
        "data_connectors": {
            "name_of_my_runtime_data_connector": {
                # <snippet name="version-0.18.8 batch_identifiers for filesystem runtime data connector">
                "batch_identifiers": ["batch_timestamp"]
                # </snippet>
            }
        }
    ...
    # <snippet name="version-0.18.8 full pandas runtime Datasource configuration">
    datasource_config: dict = {
        "name": "my_datasource_name",
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def validate_pandas_batch_spec_passthrough_config_for_inferred():
    ...
    datasource_config: dict = {
        "data_connectors": {
            "name_of_my_inferred_data_connector": {
                # <snippet name="version-0.18.8 empty batch_spec_passthrough">
                "batch_spec_passthrough": {
                    "reader_method": "",
                    "reader_options": {},
                    # </snippet>
    ...
    datasource_config: dict = {
        "data_connectors": {
            "name_of_my_inferred_data_connector": {
                "batch_spec_passthrough": {
                    # <snippet name="version-0.18.8 set reader_method to csv">
                    "reader_method": "csv",
                    # </snippet>
                    # <snippet name="version-0.18.8 empty keys for reader_options">
                    "reader_options": {
                        "header": "",
                        "inferSchema": "",
                    },
    ...
    datasource_config: dict = {
        "data_connectors": {
            "name_of_my_inferred_data_connector": {
                "batch_spec_passthrough": {
                    "reader_options": {
                        # <snippet name="version-0.18.8 populate header for reader_options as True">
                        "header": True,
                        # </snippet>
                        # <snippet name="version-0.18.8 populate inferSchema for reader_options as True">
                        "inferSchema": True,
                        # </snippet>
                    },
                },
    ...
    datasource_config: dict = {
        "data_connectors": {
            "name_of_my_inferred_data_connector": {
                # <snippet name="version-0.18.8 fully populated batch_spec_passthrough configuration">
                "batch_spec_passthrough": {
                    "reader_method": "csv",
                    "reader_options": {
                        "header": True,
    ...
    # <snippet name="version-0.18.8 inferred datasource_config up to batch_spec_passthrough">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    # <snippet name="version-0.18.8 configured datasource_config up to batch_spec_passthrough">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
    ...
    # <snippet name="version-0.18.8 runtime datasource_config up to batch_spec_passthrough">
    datasource_config: dict = {
        "name": "my_datasource_name",  # Preferably name it something relevant
        "class_name": "Datasource",
        "module_name": "great_expectations.datasource",
...
def test_adding_your_datasource_to_the_datacontext():
    ...
    # <snippet name="version-0.18.8 test your config with test_yaml_config">
    data_context.test_yaml_config(yaml.dump(datasource_config))
    # </snippet>

    # <snippet name="version-0.18.8 add your datasource to your data_context">
    data_context.add_datasource(**datasource_config)
    # </snippet>

    # <snippet name="version-0.18.8 add your datasource to your data_context only if it does not already exit">
