...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/athena_python_example.py imports">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/athena_python_example.py get_context">
context = gx.get_context()
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/athena_python_example.py Connect and Build Batch Request">
...
athena_table = athena_source.add_table_asset(
    "taxitable", table_name="version-0.18.8 taxitable"
)
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/athena_python_example.py Create Expectation Suite">
expectation_suite_name = "version-0.18.8 my_awsathena_expectation_suite"
suite = context.add_or_update_expectation_suite(
    expectation_suite_name=expectation_suite_name
)
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/athena_python_example.py Test Datasource with Validator">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/athena_python_example.py Add Checkpoint">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/snippets/athena_python_example.py Run Checkpoint">
