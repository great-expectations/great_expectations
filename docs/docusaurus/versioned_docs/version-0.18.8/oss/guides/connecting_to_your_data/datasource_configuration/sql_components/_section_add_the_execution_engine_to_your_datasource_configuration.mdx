...
```python name="version-0.18.8 sql datasource define execution_engine class_name and module_name"
```
...
```python name="version-0.18.8 sql datasource define CONNECTION_STRING"
```
...
```python name="version-0.18.8 sql datasource configuration post execution engine defined"
```
