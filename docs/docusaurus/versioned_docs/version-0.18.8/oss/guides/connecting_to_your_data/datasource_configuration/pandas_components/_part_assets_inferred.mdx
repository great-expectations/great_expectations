...
```python name="version-0.18.8 pandas_inferred_datasource_single_batch_full_snippet"
datasource_config = {
...
```python name="version-0.18.8 pandas_inferred_datasource_multi_batch_full_snippet"
```
