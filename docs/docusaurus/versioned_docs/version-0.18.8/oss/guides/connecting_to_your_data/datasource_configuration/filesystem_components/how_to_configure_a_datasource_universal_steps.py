...
def section_1_import_necessary_modules_and_initialize_your_data_context():
    ...
    """
    # <snippet name="version-0.18.8 import necessary modules and initialize your data context">
...
def section_2_create_new_datasource_configuration():
    ...
    # <snippet name="version-0.18.8 create empty datasource_config dictionary">
...
def section_3_name_your_datasource():
    ...
    # <snippet name="version-0.18.8 datasource_config up to name being populated as my_datasource_name">
    datasource_config: dict = {"name": "my_datasource_name"}
    # </snippet>

    name_snippet: dict = {
        # <snippet name="version-0.18.8 populate name as my_datasource_name">
...
def section_4_specify_the_datasource_class_and_module():
    ...
    # <snippet name="version-0.18.8 datasource_config containing top level elements universal to spark pandas and sql Datasources">
    datasource_config: dict = {
