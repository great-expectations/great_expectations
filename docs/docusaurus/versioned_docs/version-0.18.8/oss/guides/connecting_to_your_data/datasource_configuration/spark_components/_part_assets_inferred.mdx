...
```python name="version-0.18.8 full datasource_config for inferred spark single batch datasource"
```
...
```python name="version-0.18.8 full datasource_config for inferred spark multi batch datasource"
```
