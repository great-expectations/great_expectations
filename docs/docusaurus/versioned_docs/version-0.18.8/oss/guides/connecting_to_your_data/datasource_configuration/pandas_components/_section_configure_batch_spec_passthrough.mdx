...
```python name="version-0.18.8 inferred datasource_config up to batch_spec_passthrough"
```

  </TabItem>
  <TabItem value="configured">

```python name="version-0.18.8 configured datasource_config up to batch_spec_passthrough"
```
...
```python name="version-0.18.8 runtime datasource_config up to batch_spec_passthrough"
```
