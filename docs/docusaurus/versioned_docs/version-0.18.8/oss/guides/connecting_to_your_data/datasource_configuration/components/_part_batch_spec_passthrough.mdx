...
```python name="version-0.18.8 empty batch_spec_passthrough"
```
...
```python name="version-0.18.8 set reader_method to csv"
```
...
```python name="version-0.18.8 empty keys for reader_options"
```
...
```python name="version-0.18.8 populate header for reader_options as True"
```
...
```python name="version-0.18.8 populate inferSchema for reader_options as True"
```
...
```python name="version-0.18.8 fully populated batch_spec_passthrough configuration"
```