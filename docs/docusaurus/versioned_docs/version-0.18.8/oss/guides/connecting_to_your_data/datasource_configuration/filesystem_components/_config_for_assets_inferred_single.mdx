...
```python name="version-0.18.8 datasource_configuration_inferred_single_batch_regex_pattern"
```
...
```python name="version-0.18.8 datasource_configuration_inferred_single_batch_group_names"
```
...
```python name="version-0.18.8 data_connector_configuration_post_single_batch_regex"
```