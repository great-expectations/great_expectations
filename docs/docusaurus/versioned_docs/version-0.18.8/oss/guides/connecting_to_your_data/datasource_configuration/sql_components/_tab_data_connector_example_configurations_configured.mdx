...
```python name="version-0.18.8 sql datasource configuration with empty configured sql data_connector"
```

#### Required Data Connector configuration keys

<PartDataConnectorRequiredKeysOverview data_connector_type="ConfiguredAssetSqlDataConnector" data_connector_name="version-0.18.8 name_of_my_configured_data_connector" inferred={false} configured={true} runtime={false} />
...
```python name="version-0.18.8 define data_connector class_name for configured sql datasource"
```
...
```python name="version-0.18.8 configured sql datasource configuration with data_connector class_name defined"
```
