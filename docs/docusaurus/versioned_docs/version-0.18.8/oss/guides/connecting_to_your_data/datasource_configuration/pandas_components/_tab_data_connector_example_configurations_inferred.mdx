...
```python name="version-0.18.8 datasource_config add empty inferred_data_connector"
```
...
```python name="version-0.18.8 inferred data connector populate class_name"
```
...
```python name="version-0.18.8 datasource_configuration_pandas_inferred_empty_regex"
```
