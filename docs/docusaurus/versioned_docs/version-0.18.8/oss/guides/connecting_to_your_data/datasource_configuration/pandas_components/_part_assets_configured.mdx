...
```python name="version-0.18.8 pandas_configured_datasource_single_batch_full_snippet"
```
...
```python name="version-0.18.8 pandas_configured_datasource_multi_batch_full_snippet"
datasource_config = {
