...
```python name="version-0.18.8 empty data asset for configured, multi batch datasource"
```
...
```python name="version-0.18.8 pattern for asset in configured, multi-batch datasource"
```
...
```python name="version-0.18.8 group_names for asset in configured, multi-batch datasource"
```
...
```python name="version-0.18.8 multi batch data asset for configured pandas datasource"
```
...
```python name="version-0.18.8 data connector for configured, multi-batch, Pandas datasource"
```