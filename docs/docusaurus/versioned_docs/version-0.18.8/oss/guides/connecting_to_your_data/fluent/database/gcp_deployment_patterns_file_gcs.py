...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py get_context">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py expected_expectation_store">
stores:
  expectations_store:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py new_expectation_store">
stores:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py expected_validations_store">
stores:
  validations_store:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py new_validations_store">
stores:
...
data_docs_site_yaml = """
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py new_data_docs_store">
data_docs_sites:
  local_site:
...
# adding datasource
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py datasource">
datasource = context.sources.add_pandas_gcs(
    name="gcs_datasource", bucket_or_name="version-0.18.8 test_docs_data"
)
# </snippet>

### Add GCS data to the Datasource as a Data Asset
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py prefix_and_batching_regex">
batching_regex = r"yellow_tripdata_sample_(?P<year>\d{4})-(?P<month>\d{2})\.csv"
prefix = "data/taxi_yellow_tripdata_samples/"
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py asset">
data_asset = datasource.add_csv_asset(
    name="version-0.18.8 csv_taxi_gcs_asset",
    batching_regex=batching_regex,
    gcs_prefix=prefix,
)
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py batch_request">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py add_expectation_suite">
context.add_or_update_expectation_suite(
    expectation_suite_name="version-0.18.8 test_gcs_suite"
)

validator = context.get_validator(
    batch_request=batch_request, expectation_suite_name="version-0.18.8 test_gcs_suite"
)
# </snippet>
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py validator_calls">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py save_expectation_suite">
validator.save_expectation_suite(discard_failed_expectations=False)
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py checkpoint">
checkpoint = context.add_or_update_checkpoint(
    name="version-0.18.8 gcs_checkpoint",
    validations=[
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_gcs.py run_checkpoint">
