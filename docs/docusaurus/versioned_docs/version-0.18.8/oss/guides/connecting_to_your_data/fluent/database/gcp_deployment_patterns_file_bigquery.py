...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_bigquery.py get_context">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_bigquery.py existing_expectations_store">
stores:
  expectations_store:
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_bigquery.py add_bigquery_datasource">
datasource = context.sources.add_or_update_sql(
    name="version-0.18.8 my_bigquery_datasource",
...
datasource = context.sources.add_or_update_sql(
    name="version-0.18.8 my_bigquery_datasource", connection_string=CONNECTION_STRING
)

# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_bigquery.py add_bigquery_table_asset">
table_asset = datasource.add_table_asset(
    name="my_table_asset", table_name="version-0.18.8 taxi_data"
)
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_bigquery.py add_bigquery_query_asset">
query_asset = datasource.add_query_asset(
    name="version-0.18.8 my_query_asset", query="SELECT * from taxi_data"
)
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_bigquery.py batch_request">
request = table_asset.build_batch_request()
# </snippet>


# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_bigquery.py add_or_update_expectation_suite">
context.add_or_update_expectation_suite(
    expectation_suite_name="version-0.18.8 test_bigquery_suite"
)

validator = context.get_validator(
    batch_request=request, expectation_suite_name="version-0.18.8 test_bigquery_suite"
)
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_bigquery.py validator_calls">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_bigquery.py save_expectation_suite">
validator.save_expectation_suite(discard_failed_expectations=False)
# </snippet>

# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_bigquery.py checkpoint">
checkpoint = context.add_or_update_checkpoint(
    name="version-0.18.8 bigquery_checkpoint",
    validations=[
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/gcp_deployment_patterns_file_bigquery.py run_checkpoint">
