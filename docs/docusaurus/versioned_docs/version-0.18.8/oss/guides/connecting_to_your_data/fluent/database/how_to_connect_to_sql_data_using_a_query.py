...
with warnings.catch_warnings():
    ...
    datasource = context.sources.add_sql(
        name="version-0.18.8 my_datasource",
        connection_string=connection_string,
        create_temp_table=True,
    )

# Python
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/how_to_connect_to_sql_data_using_a_query.py datasource">
datasource = context.get_datasource("my_datasource")
# </snippet>

# Python
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/connecting_to_your_data/fluent/database/how_to_connect_to_sql_data_using_a_query.py add_query_asset">
query_asset = datasource.add_query_asset(
    name="version-0.18.8 my_asset",
