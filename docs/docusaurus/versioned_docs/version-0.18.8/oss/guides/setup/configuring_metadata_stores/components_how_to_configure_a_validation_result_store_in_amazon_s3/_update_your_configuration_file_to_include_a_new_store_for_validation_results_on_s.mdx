...
```python name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py new_validations_store"
```
...
```python name="version-0.18.8 docs/docusaurus/docs/snippets/aws_cloud_storage_pandas.py set_new_validations_store"
```
