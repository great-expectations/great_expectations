...
"""
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/setup/configuring_data_contexts/how_to_configure_credentials.py export_env_vars">
...
"""
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/setup/configuring_data_contexts/how_to_configure_credentials.py config_variables_yaml">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/setup/configuring_data_contexts/how_to_configure_credentials.py add_credentials_as_connection_string">
# The password can be added as an environment variable
pg_datasource = context.sources.add_or_update_postgres(
    name="version-0.18.8 my_postgres_db",
    connection_string="postgresql://postgres:${MY_DB_PW}@localhost:5432/postgres",
)
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/setup/configuring_data_contexts/how_to_configure_credentials.py add_credential_from_yml">
