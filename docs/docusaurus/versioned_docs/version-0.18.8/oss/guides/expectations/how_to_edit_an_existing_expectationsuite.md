...
```python name="version-0.18.8 tests/integration/docusaurus/expectations/how_to_edit_an_expectation_suite get_context"
```
...
```python name="version-0.18.8 tests/integration/docusaurus/expectations/how_to_edit_an_expectation_suite create_validator"
```
...
```python name="version-0.18.8 tests/integration/docusaurus/expectations/how_to_edit_an_expectation_suite show_suite"
```
...
```python name="version-0.18.8 tests/integration/docusaurus/expectations/how_to_edit_an_expectation_suite example_dict_1"
```

The following is the same configuration with an `ExpectationConfiguration` object:  

```python name="version-0.18.8 tests/integration/docusaurus/expectations/how_to_edit_an_expectation_suite import_expectation_configuration"
```
```python name="version-0.18.8 tests/integration/docusaurus/expectations/how_to_edit_an_expectation_suite example_configuration_1"
```
...
```python name="version-0.18.8 tests/integration/docusaurus/expectations/how_to_edit_an_expectation_suite updated_configuration"
```

To update the Expectation Suite you use the `add_expectation()` function. For example:

```python name="version-0.18.8 tests/integration/docusaurus/expectations/how_to_edit_an_expectation_suite add_configuration"
```
...
```python name="version-0.18.8 tests/integration/docusaurus/expectations/how_to_edit_an_expectation_suite find_configuration"
```
...
```python name="version-0.18.8 tests/integration/docusaurus/expectations/how_to_edit_an_expectation_suite remove_configuration"
```
...
```python name="version-0.18.8 tests/integration/docusaurus/expectations/how_to_edit_an_expectation_suite save_suite"
```
