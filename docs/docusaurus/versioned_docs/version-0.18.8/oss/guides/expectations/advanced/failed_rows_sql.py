...
# get context
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/expectations/advanced/failed_rows_sql.py get context">
import great_expectations as gx
...
datasource = context.sources.add_sqlite(
    name="version-0.18.8 visits_datasource",
    connection_string=connection_string,
)
asset = datasource.add_table_asset(
    name="version-0.18.8 visits",
    table_name="version-0.18.8 event_names",
)

# get checkpoint
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/expectations/advanced/failed_rows_sql.py get checkpoint">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/expectations/advanced/failed_rows_sql.py set unexpected_index_column_names">
result_format: dict = {
    "result_format": "COMPLETE",
    "unexpected_index_column_names": ["event_id"],
}
# </snippet>
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/expectations/advanced/failed_rows_sql.py run checkpoint">
