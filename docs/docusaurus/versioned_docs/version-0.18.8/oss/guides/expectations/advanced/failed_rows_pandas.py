...
# get context
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/expectations/advanced/failed_rows_pandas.py get context">
import great_expectations as gx
...
).add_csv_asset(name="version-0.18.8 visits", filepath_or_buffer=file_path, sep="\t")

# get checkpoint
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/expectations/advanced/failed_rows_pandas.py get checkpoint">
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/expectations/advanced/failed_rows_pandas.py set unexpected_index_column_names">
result_format: dict = {
...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/expectations/advanced/failed_rows_pandas.py run checkpoint">
