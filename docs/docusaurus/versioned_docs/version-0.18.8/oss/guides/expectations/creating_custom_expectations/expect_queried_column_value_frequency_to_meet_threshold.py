...
# <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/expectations/creating_custom_expectations/expect_queried_column_value_frequency_to_meet_threshold.py ExpectQueriedColumnValueFrequencyToMeetThreshold class_def">
class ExpectQueriedColumnValueFrequencyToMeetThreshold(QueryExpectation):
    # </snippet>
    # <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/expectations/creating_custom_expectations/expect_queried_column_value_frequency_to_meet_threshold.py docstring">
    ...
    # </snippet>
    # <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/expectations/creating_custom_expectations/expect_queried_column_value_frequency_to_meet_threshold.py metric_dependencies">
    metric_dependencies = ("query.column",)
    # </snippet>
    # <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/expectations/creating_custom_expectations/expect_queried_column_value_frequency_to_meet_threshold.py query">
    query: str = """
            SELECT {col},
            ...
            """
    # </snippet>
    # <snippet name="version-0.18.8 docs/docusaurus/docs/oss/guides/expectations/creating_custom_expectations/expect_queried_column_value_frequency_to_meet_threshold.py success_keys">
    success_keys = (
        "column",
        "value",
        "threshold",
    ...
    # <snippet name="version-0.18.8 expect_queried_column_value_frequency_to_meet_threshold.py _validate function">
    # <snippet name="version-0.18.8 expect_queried_column_value_frequency_to_meet_threshold.py _validate function signature">
    def _validate(
        self,
        metrics: dict,
    ...
    # <snippet name="version-0.18.8 expect_queried_column_value_frequency_to_meet_threshold.py examples">
    examples = [
        {
            "data": [
                {
    ...
    # </snippet>
    # <snippet name="version-0.18.8 expect_queried_column_value_frequency_to_meet_threshold.py library_metadata">
...
if __name__ == "__main__":
    # <snippet name="version-0.18.8 expect_queried_column_value_frequency_to_meet_threshold.py print_diagnostic_checklist()">
