...
```python name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_max_to_be_between_custom.py _spark"
```
...
```python name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py spark_definition"
```
...
```python name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py spark_selectable"
```

This allows us to build and return a query to be executed, providing the result of our metric:

```python name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_values_to_equal_three.py spark_query"
```
