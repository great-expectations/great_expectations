...
```python name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_max_to_be_between_custom.py validate_config"
```
...
```python name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_max_to_be_between_custom.py validate_config_params"
```
...
```python name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_max_to_be_between_custom.py validate_config_values"
```

Check that `min_value` and `max_value` are of the correct type:

```python name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_max_to_be_between_custom.py validate_config_types"
```

Verify that, if both `min_value` and `max_value` are set, `min_value` does not exceed `max_value`:

```python name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_max_to_be_between_custom.py validate_config_comparison"
```

And assert that `strict_min` and `strict_max`, if provided, are of the correct type:

```python name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_max_to_be_between_custom.py validate_config_none"
```

If any of these fail, we raise an exception:

```python name="version-0.18.8 docs/docusaurus/docs/snippets/expect_column_max_to_be_between_custom.py validate_config_except"
```
