...
```python name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py table_asset"
```
...
```python name="version-0.18.8 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py query_asset"
```
