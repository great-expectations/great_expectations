...
Plus, [Expectations are reusable](/cloud/checkpoints/manage_checkpoints.md) and [create their own documentation](/cloud/validations/manage_validations.md#view-validation-run-history), making it easy to deploy them across large numbers of datasets and then keep everyone on the same page about what they’re doing.
