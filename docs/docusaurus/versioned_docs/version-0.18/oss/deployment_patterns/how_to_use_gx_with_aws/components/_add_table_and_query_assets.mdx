...
```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py table_asset"
```
...
```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py query_asset"
```
