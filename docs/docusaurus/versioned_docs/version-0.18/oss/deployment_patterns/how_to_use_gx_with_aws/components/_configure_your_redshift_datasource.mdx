...
```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py vars"
```

With these two values, we can create our Data Source:

```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/aws_redshift_deployment_patterns.py datasource"
```
