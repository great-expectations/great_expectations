...
```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/inferred_and_runtime_yaml_example.py path batch_request"
```

Then load data into the `Validator`.

```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/inferred_and_runtime_yaml_example.py get_validator 1"
```
...
```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/inferred_and_runtime_yaml_example.py batch_request"
```

Then load data into the `Validator`.

```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/inferred_and_runtime_yaml_example.py get_validator"
```
