...
```python title="Python" name="version-0.18 datasource_configuration_class_and_module_keys"
```

Your full configuration should now look like:

```python title="Python" name="version-0.18 datasource_configuration_post_class_and_module_keys"
```