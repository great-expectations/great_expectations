...
```python title="Python" name="docs/docusaurus/docs/snippets/how_to_configure_a_pandas_datasource.py pandas_inferred_datasource_single_batch_full_snippet"
datasource_config = {
...
```python title="Python" name="docs/docusaurus/docs/snippets/how_to_configure_a_pandas_datasource.py pandas_inferred_datasource_multi_batch_full_snippet"
```
