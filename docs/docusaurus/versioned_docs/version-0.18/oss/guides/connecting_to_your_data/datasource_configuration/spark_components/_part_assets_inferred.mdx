...
```python title="Python" name="full datasource_config for inferred spark single batch datasource"
```
...
```python title="Python" name="full datasource_config for inferred spark multi batch datasource"
```
