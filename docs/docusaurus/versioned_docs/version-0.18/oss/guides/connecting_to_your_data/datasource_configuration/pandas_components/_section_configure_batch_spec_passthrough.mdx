...
```python title="Python" name="inferred datasource_config up to batch_spec_passthrough"
```

  </TabItem>
  <TabItem value="configured">

```python title="Python" name="configured datasource_config up to batch_spec_passthrough"
```
...
```python title="Python" name="runtime datasource_config up to batch_spec_passthrough"
```
