...
```python title="Python" name="version-0.18 datasource_configuration_add_empty_configured_data_connector"
```
...
```python title="Python" name="version-0.18 data_connector_configuration_configured_class_name"
```
...
```python title="Python" name="version-0.18 datasource_config_configured_data_connector_empty_data_asset"
```