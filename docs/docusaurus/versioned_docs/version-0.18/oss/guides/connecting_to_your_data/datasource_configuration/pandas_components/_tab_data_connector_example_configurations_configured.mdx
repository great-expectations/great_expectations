...
```python title="Python" name="datasource_configuration_add_empty_configured_data_connector"
```
...
```python title="Python" name="data_connector_configuration_configured_class_name"
```
...
```python title="Python" name="datasource_config_configured_data_connector_empty_data_asset"
```