...
```python title="Python" name="version-0.18 sql datasource configuration with empty inferred sql data_connector"
```
...
```python title="Python" name="version-0.18 define data_connector class_name for inferred sql datasource"
```
...
```python title="Python" name="version-0.18 inferred sql datasource configuration with data_connector class_name defined"
```
