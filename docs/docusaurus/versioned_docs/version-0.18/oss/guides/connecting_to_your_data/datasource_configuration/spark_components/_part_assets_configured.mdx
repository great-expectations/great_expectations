...
```python title="Python" name="full datasource_config for configured spark single batch datasource"
```
...
```python title="Python" name="full datasource_config for configured spark multi batch datasource"
```
