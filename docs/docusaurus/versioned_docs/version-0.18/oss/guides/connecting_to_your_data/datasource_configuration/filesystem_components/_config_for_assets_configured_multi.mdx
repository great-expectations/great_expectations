...
```python title="Python" name="version-0.18 empty data asset for configured, multi batch datasource"
```
...
```python title="Python" name="version-0.18 pattern for asset in configured, multi-batch datasource"
```
...
```python title="Python" name="version-0.18 group_names for asset in configured, multi-batch datasource"
```
...
```python title="Python" name="version-0.18 multi batch data asset for configured pandas datasource"
```
...
```python title="Python" name="version-0.18 data connector for configured, multi-batch, Pandas datasource"
```