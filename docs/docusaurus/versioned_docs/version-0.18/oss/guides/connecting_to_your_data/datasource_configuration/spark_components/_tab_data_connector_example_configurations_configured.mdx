...
```python title="Python" name="configured data connector define class_name as ConfiguredAssetFilesystemDataConnector"
```
...
```python title="Python" name="configured spark datasource_config up to adding empty assets and batch_spec_passthrough dictionaries"
```