...
```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/how_to_create_a_new_checkpoint.py run checkpoint batch_request"
```
...
```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/how_to_create_a_new_checkpoint.py build data docs"
```
...
```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/how_to_create_a_new_checkpoint.py get checkpoint"
```
