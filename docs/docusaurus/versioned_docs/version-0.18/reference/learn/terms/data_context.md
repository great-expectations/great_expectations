...
```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/pandas_yaml_example.py get_context"
```
...
```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/pandas_yaml_example.py import BatchRequest"
```

```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/pandas_yaml_example.py context.get_batch with batch request"
```

If you prefer untyped inputs, you run code similar to the following examples:

```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/pandas_yaml_example.py context.get_batch with parameters data_asset_name"
```

```python title="Python" name="version-0.18 docs/docusaurus/docs/snippets/pandas_yaml_example.py context.get_batch with parameters"
```
