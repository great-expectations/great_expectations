...
<dt class="field-odd">Parameters</dt>
<dd class="field-odd">
<p><strong>configuration</strong> – An ExpectationConfiguration</p>
</dd>
<dt class="field-even">Raises</dt>
<dd class="field-even">
<p><strong>InvalidExpectationConfigurationError</strong> – If no <cite>regex</cite> or <cite>column</cite> specified, or if <cite>mostly</cite> parameter
