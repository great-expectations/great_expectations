...
<dd class="field-odd"><p><strong>InvalidExpectationConfigurationError</strong> – If <cite>column_list</cite> is missing from configuration.</p>
</dd>
