...
<dd class="field-odd"><p><strong>InvalidExpectationConfigurationError</strong> – If <cite>column_A</cite> and <cite>column_B</cite> parameters are missing from the configuration.</p>
</dd>
