...
<dd class="field-even"><p>If no stream argument is provided, the str that results from <code class="docutils literal notranslate"><span class="pre">_handler.dump()</span></code>.
...
<dl class="field-list simple">
<dt class="field-odd">Parameters</dt>
<dd class="field-odd"><p><strong>stream</strong> – The input stream to read in. Although this function calls ruamel's load(), we
...
<dt class="field-even">Returns</dt>
<dd class="field-even"><p>The deserialized dictionary form of the input stream.</p>
</dd>
</dl>
</dd></dl>
</dd></dl>
