          ...
          items: [
            {
              type: 'link',
              label: 'Amazon S3',
              href: 'core/installation_and_setup/additional_dependencies/additional_dependencies?dependencies=amazon',
            },
            {
              type: 'link',
              label: 'Microsoft Azure Blob Storage',
              href: 'core/installation_and_setup/additional_dependencies/additional_dependencies?dependencies=azure',
            },
            {
              type: 'link',
              label: 'Google Cloud Storage',
              href: 'core/installation_and_setup/additional_dependencies/additional_dependencies?dependencies=gcs',
            },
            {
              type: 'link',
              label: 'SQL Databases',
              href: 'core/installation_and_setup/additional_dependencies/additional_dependencies?dependencies=sql',
            },
          ]
        },
        {
