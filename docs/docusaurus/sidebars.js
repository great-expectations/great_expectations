module.exports = {
  OSS: [
      ...
      {type: 'doc', id: 'intro', label: 'Introduction to GX'},
      {type: 'doc', id: 'tutorials/quickstart/quickstart', label: 'Try GX'},
      {
        type: 'html',
        value: '<h3>Get started</h3>'
      },
      'oss/proofs/end2end/gx_workflow_local',
