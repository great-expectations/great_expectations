...
---Import---
import ConfirmThatTheNewValidationResultsStoreHasBeenAddedByRunningGreat_ExpectationsStoreList from './_confirm_that_the_new_validation_results_store_has_been_added_by_running_great_expectations_store_list.mdx'
<ConfirmThatTheNewValidationResultsStoreHasBeenAddedByRunningGreat_ExpectationsStoreList />
