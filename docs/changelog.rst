...
Existing projects with evaluation parameter stores that have store backend of type ``DatabaseStoreBackend`` must be
migrated. See :ref:`Upgrading to 0.11.x-beta` for instructions.
